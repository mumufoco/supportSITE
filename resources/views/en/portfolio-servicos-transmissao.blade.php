...
@push('meta')
    <meta name="keywords" content="SUPPORT SOLO SURVEYS, LABORATORY:, GEOLOGY AND ENGINEERING:, PROJECT DEVELOPMENT:">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-3" id="block-9">
      <p class="u-text u-text-1"><span style="font-weight: 700;">Support Soil Drilling</span>&nbsp;is a company specialized in high-precision geotechnical and geological investigations. Founded in 2015 and with a strategic focus on complex projects since 2018, we have the expertise and infrastructure necessary to be a reliable technical partner in the development and expansion of the Brazilian Energy Transmission System.<br>We understand that the reliability of the network starts with the robustness of the foundations. Our mission is to provide accurate subsurface data and detailed technical analyses that guarantee the safety, economy, and viability of transmission line and substation projects, from the planning phase to execution.<br><br><span style="font-weight: 700;">Services Applicable to Energy Transmission:</span><br><br>We offer an integrated portfolio of services designed to meet all stages of geotechnical investigation in the electrical sector.<br><br><span style="font-weight: 700;">Geotechnical Investigation for Foundation Projects:</span><br><br><span style="font-weight: 700;">Percussion Drilling (SPT):</span> Performed according to the ABNT NBR 6484 standard, it is fundamental for defining the stratigraphic profile, water level, and load capacity of soils for shallow and deep foundations of towers and substations.<br><span style="font-weight: 700;">Rotary Drilling:</span> Essential for characterizing rock masses, allowing the obtaining of test specimens for determining the RQD (Rock Quality Designation), rock resistance, and definition of the embedding quota of foundations in piles or tubes.<br><span style="font-weight: 700;">Mixed Drilling (Rotopercussion):</span> Combines efficiency and detail to traverse resistant soils and altered rocks, common in Brazilian terrain.<br><br><span style="font-weight: 700;">Specialized Field Tests and Monitoring:</span><br><br><span style="font-weight: 700;">Cone Penetration Tests (CPT):</span> Provides continuous and more detailed soil parameters (resistance, friction, pore pressure), ideal for projects in homogeneous soils and stability analysis.<br><span style="font-weight: 700;">Permeability Tests:</span> Crucial for drainage, containment, and stability analysis of slopes in substation and access areas.<br><span style="font-weight: 700;">Undeformed Sample Collection:</span> For advanced laboratory tests of resistance and deformability.<br><br><span style="font-weight: 700;">Soil and Rock Laboratory:</span><br><br>Physical characterization tests (granulometry, Atterberg limits).<br>Resistance tests (direct shear, simple compression in rocks).<br>Compaction tests (Proctor Normal and Modified) for control of earthfills and earth structures.<br><br><span style="font-weight: 700;">Logistics and Mobility to Access Any Terrain:</span><br><br><span style="font-weight: 700;">Mobile Drilling Units in Containers:</span> Our exclusive solution allows us to deploy complete investigation yards in remote and hard-to-reach areas, typical of transmission line routes, with agility, safety, and environmental preservation. We guarantee the continuity of operations regardless of weather conditions.</p>
    </section>
        ...
        <div class="u-layout" style="">
          <div class="u-layout-row" style="">
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                <p class="u-text u-text-1"><span style="font-weight: 700;">​​</span><span style="font-weight: 700;">Experience, Technical Capacity, and Reliability:</span><br><br><span style="font-weight: 700;">Certified Technical Competence:</span> Our operations strictly follow the relevant Brazilian Standards (ABNT) and Regulatory Standards (NRs), with emphasis on NR-12 (Machine Safety). We are prepared to meet specific requirements from regulatory agencies and concessionaires.<br><span style="font-weight: 700;">Qualified Team:</span> We have experienced geotechnical engineers and geologists capable of interpreting complex data and offering practical recommendations for optimizing foundation projects.<br><span style="font-weight: 700;">Technology and Innovation:</span> We continuously invest in state-of-the-art equipment and team training, ensuring the quality and reliability of the delivered data.<br><span style="font-weight: 700;">Commitment to Deadlines and Results:</span> Our own logistical structure and detailed planning guarantee agile mobilization and execution within schedules, critical for the advancement of transmission works.<br><br><span style="font-weight: 700;">Strategic Differentiators for the Electrical Sector:</span><br><br><span style="font-weight: 700;">Focus on Foundation Problem Solution:</span> We go beyond data collection. Our reports interpret geotechnics to guide the best project decisions, aiming at safety and economy.<br><span style="font-weight: 700;">Mobility and Operational Resilience:</span> Our mobile drilling yard eliminates logistical barriers, ensuring that investigations proceed in any location, maintaining the project schedule.<br><span style="font-weight: 700;">Compliance and Integral Safety:</span> We adopt a robust Health and Safety Management System, essential for operating in complex construction yards and in coordination with other contractors.<br><span style="font-weight: 700;">Technical Partnership:</span> We act as an extension of our clients' engineering teams, offering technical support from the definition of the drilling mesh to the analysis of results.</p>
              </div>
            </div>
    ...
    <section class="u-clearfix u-section-10" id="sec-a700">
      <p class="u-text u-text-1"><span style="font-weight: 700;">​Conclusion and Recommendations for Implementation:</span><br>Support Soil Drilling has the technical, operational, and safety base fully adequate to act with excellence in the energy transmission sector. The above portfolio proposes a strategic reformulation of communication, translating existing competencies into the language and specific needs of the electrical market.<br><br><span style="font-weight: 700;">To implement this transformation, I recommend:</span><br><br><span style="font-weight: 700;">Review the institutional website:</span> to include a section dedicated to the “Electrical Sector”, incorporating the developed content.<br><span style="font-weight: 700;">Develop technical cases:</span> (even if initial) that demonstrate the application of services in scenarios analogous to those of transmission.<br><span style="font-weight: 700;">Produce technical content:</span> (articles, technical notes) on the importance of geotechnical investigation for tower foundations, aligning the brand with the sector.<br><br>This portfolio positions the company not as a mere executor of drillings, but as a specialized partner in geotechnics for critical infrastructure, capable of contributing decisively to the safety and efficiency of the national electrical system.</p>
    </section>
