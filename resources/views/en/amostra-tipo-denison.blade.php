...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">UNDEFORMED SAMPLE TYPE DENISON - DN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESSITY:</span>&nbsp;The field test with an undeformed sample type Denison is necessary to collect undisturbed soil samples in cohesive and clayey soils. These samples are essential for the precise evaluation of geotechnical characteristics, such as resistance, compressibility, and permeability of the soil, ensuring a detailed understanding of the soil behavior in geotechnical projects.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The main objective of the field test with an undeformed sample type Denison is to collect soil samples that maintain their original structure and have not been disturbed during the sampling process. This allows laboratory tests to be performed, providing detailed information about the mechanical and hydraulic properties of the soil in its unaltered state.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span>&nbsp;The Brazilian standards that deal with the field test with an undeformed sample type Denison are related to sampling and geotechnical investigation tests. Some examples of relevant standards include:<br>ABNT NBR 6484:2001 - Execution of Simple Recognition Drilling with SPT - Test Method.<br>ABNT NBR 7250:1986 - Soil - Cone Penetration Test - Test Method.<br>ABNT NBR 8036:1983 - Soil - Compaction Test - Test Method.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;The target audience for the field test with an undeformed sample type Denison includes geotechnical engineers, civil engineers, geologists, geotechnical technicians, and professionals involved in projects that require a precise evaluation of the mechanical and hydraulic properties of the soil. Geotechnical engineering companies, geotechnical consulting firms, government agencies, and research institutions can use the results of these tests.<br><br><span style="font-weight: 700;">TECHNIQUE:</span>&nbsp;The technique of the field test with an undeformed sample type Denison involves the following stages:<br><span style="font-weight: 700;">1. SITE PREPARATION:</span>&nbsp;The test site is chosen based on relevant geotechnical criteria, taking into account the soil characteristics and the objectives of the test.<br><span style="font-weight: 700;">2. EQUIPMENT INSTALLATION:</span>&nbsp;A sampling equipment is inserted into the soil using drilling equipment. This equipment is specific for collecting undeformed samples in cohesive soils.<br><span style="font-weight: 700;">3. SAMPLE COLLECTION:</span>&nbsp;The equipment is inserted into the soil to the desired depth, according to the test objectives. The sample is then removed from the soil and preserved in a collection tube.<br><span style="font-weight: 700;">4. SAMPLE PRESERVATION:</span>&nbsp;The collected sample is preserved in its undisturbed state and properly conditioned to avoid deformations during transportation.<br><span style="font-weight: 700;">5. DATA RECORDING:</span>&nbsp;All data obtained during the test are recorded, including the test depth, soil characteristics, site conditions, and other relevant aspects.<br><span style="font-weight: 700;">6. INTERPRETATION:</span>&nbsp;The undeformed samples collected in the field test with an undeformed sample type Denison are sent to laboratory tests, where detailed analyses of the mechanical and hydraulic properties of the soil are performed. The results of these tests allow for an understanding of the soil behavior in various loading situations and guide geotechnical projects.<br><br>In summary, the field test with an undeformed sample type Denison is an important technique in geotechnical engineering for collecting undisturbed soil samples in cohesive and clayey soils. It is used by a variety of professionals and organizations involved in geotechnical projects, following established norms and procedures.</p>
      </div>
    </section>
