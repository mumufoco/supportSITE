...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">UNDEFORMED SAMPLE TYPE SHELBY - SH</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span>&nbsp;The field test with an undeformed sample type Shelby is necessary to obtain unperturbed soil samples at significant depths. These samples are crucial for evaluating the geotechnical characteristics, such as resistance, compressibility, and permeability of the soil, ensuring a precise understanding of the soil's behavior in geotechnical projects.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The primary objective of the field test with an undeformed sample type Shelby is to collect unperturbed soil samples, i.e., those that maintain their original structure, to evaluate their mechanical and hydraulic properties. These samples are used to perform laboratory tests that will allow for a more precise analysis of the soil's behavior under different loading conditions.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span>&nbsp;The Brazilian standards that deal with the field test with an undeformed sample type Shelby are related to sampling and geotechnical investigation tests. Some examples of relevant standards include:<br>ABNT NBR 6484:2001 – Execution of Simple Recognition Drilling with SPT – Test Method.<br>ABNT NBR 6502:1995 – Rocks and Soils – Terminology.<br>ABNT NBR 9604:1986 – Design and Execution of Simple Recognition Drilling of Soils for Building Foundations – Procedure.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;The target audience for the field test with an undeformed sample type Shelby includes geotechnical engineers, civil engineers, geologists, geotechnical technicians, and professionals involved in projects that require evaluating the mechanical and hydraulic characteristics of the soil. Geotechnical engineering companies, geotechnical consulting firms, government agencies, and research institutions can use the results of these tests.<br><br><span style="font-weight: 700;">TECHNIQUE:</span>&nbsp;The technique of the field test with an undeformed sample type Shelby involves the following stages:<br><span style="font-weight: 700;">1. SITE PREPARATION:</span>&nbsp;The test site is chosen according to relevant geotechnical criteria, taking into account the soil characteristics and the test objectives.<br><span style="font-weight: 700;">2. INSTALLATION OF THE SAMPLING TUBE:</span>&nbsp;A cylindrical tube, known as a Shelby tube, is driven into the soil using drilling equipment. The tube is inserted into the soil at a determined depth.<br><span style="font-weight: 700;">3. EXTRACTION OF THE TUBE WITH SAMPLE:</span>&nbsp;The Shelby tube is carefully removed from the soil, preserving the sample contained within it.<br><span style="font-weight: 700;">4. SAMPLE HANDLING:</span>&nbsp;The obtained sample is handled with care to preserve its original structure and minimize any disturbance.<br><span style="font-weight: 700;">5. DATA RECORDING:</span>&nbsp;All data obtained during the test are recorded, including the test depth, soil characteristics, site conditions, and other relevant aspects.<br><span style="font-weight: 700;">6. INTERPRETATION:</span>&nbsp;The undeformed samples collected in the field test with an undeformed sample type Shelby are sent to laboratory tests, where detailed analyses of the soil's mechanical and hydraulic properties are performed. The results of these tests allow for understanding the soil's behavior under different loading conditions and guiding geotechnical projects.<br><br>In summary, the field test with an undeformed sample type Shelby is an important technique in geotechnical engineering for collecting unperturbed soil samples at significant depths. It is used by a variety of professionals and organizations involved in geotechnical projects, following established norms and procedures.</p>
      </div>
    </section>
