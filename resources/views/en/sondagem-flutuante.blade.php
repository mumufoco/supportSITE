...
@section('lang', 'en')
@section('title', 'Sondagem Flutuante')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-Flutuante.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​SONDAGEM FLUTUANTE - SF</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">Necessidade:</span>&nbsp;O ensaio de campo de sondagem sobre flutuante é necessário para obter informações sobre as características do solo e do leito marinho em locais onde a água é presente, como corpos d’água, lagos, rios e mares. Essas informações são cruciais para projetos de engenharia geotécnica, construção de estruturas costeiras, avaliação de fundações e outras aplicações que requerem conhecimento do substrato sob a água.<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;O principal objetivo do ensaio de campo de sondagem sobre flutuante é obter dados sobre a natureza do solo e do leito marinho, como a resistência, a composição, a profundidade do substrato e outras características relevantes. Esses dados são essenciais para o projeto e a construção de estruturas em ambientes aquáticos, como pontes, portos, diques e outras infraestruturas.<br><br><span style="font-weight: 700;">Normas Brasileiras:</span>&nbsp;As normas brasileiras que tratam do ensaio de campo de sondagem sobre flutuante estão relacionadas a ensaios geotécnicos em geral e podem incluir:<br>ABNT NBR 9603:1986 – Projeto e Execução de Sondagens de Simples Reconhecimento dos Solos para Fundações de Edifícios.<br>ABNT NBR 8044:1983 – Sondagens de Simples Reconhecimento dos Solos – Coleta de Amostras Indeformadas – Método de Ensaio.<br>Além disso, regulamentações específicas para trabalhos em ambientes aquáticos, como licenças ambientais e regulamentos de segurança, também devem ser seguidas.<br><br><span style="font-weight: 700;">Público-Alvo:</span>&nbsp;O público-alvo do ensaio de campo de sondagem sobre flutuante inclui engenheiros geotécnicos, engenheiros civis, engenheiros costeiros, oceanógrafos, biólogos marinhos e outros profissionais envolvidos em projetos que requerem informações precisas sobre o solo e o leito marinho. Empresas de engenharia, autoridades portuárias, agências ambientais, instituições de pesquisa marinha e outras organizações podem utilizar os resultados desses ensaios.<br><br><span style="font-weight: 700;">Técnica:</span>&nbsp;A técnica do ensaio de campo de sondagem sobre flutuante envolve as seguintes etapas:<br><span style="font-weight: 700;">1. Preparação do Flutuante:</span>&nbsp;Um barco, balsa ou outro tipo de flutuante é preparado para a realização do ensaio. O flutuante é equipado com equipamentos de perfuração e amostragem adequados para trabalhos em ambiente aquático.<br><span style="font-weight: 700;">2. Posicionamento:</span>&nbsp;O flutuante é posicionado sobre o local de sondagem. Isso pode envolver a ancoragem do flutuante ou a fixação de dispositivos para mantê-lo estável durante a perfuração.<br><span style="font-weight: 700;">3. Perfuração e Amostragem:</span>&nbsp;A perfuração é realizada a partir do flutuante, penetrando no solo ou no leito marinho. Amostras de solo ou sedimentos marinhos são coletadas para análise.<br><span style="font-weight: 700;">4. Registro de Dados:</span>&nbsp;Durante a perfuração, os dados são registrados, incluindo a profundidade, as características das amostras e outras informações relevantes.<br><span style="font-weight: 700;">5. Considerações Ambientais:</span>&nbsp;Durante todo o processo, é importante considerar questões ambientais e de segurança para evitar danos ao ecossistema aquático e garantir a segurança dos trabalhadores.<br><br><span style="font-weight: 700;">Interpretação:</span>&nbsp;As amostras coletadas e os dados registrados durante o ensaio de campo de sondagem sobre flutuante fornecem informações detalhadas sobre a composição do solo, a resistência e outras propriedades geotécnicas. Esses dados são cruciais para a elaboração de projetos costeiros, infraestruturas aquáticas e outras aplicações em ambientes aquáticos.<br>Em resumo, o ensaio de campo de sondagem sobre flutuante é uma técnica especializada na engenharia geotécnica que permite a obtenção de informações precisas sobre o solo e o leito marinho em ambientes aquáticos. Ele é utilizado por uma variedade de profissionais e organizações envolvidos em projetos costeiros, portuários e de engenharia em ambientes aquáticos, seguindo as normas e regulamentações estabelecidas.​</p>
      </div>
    </section>
