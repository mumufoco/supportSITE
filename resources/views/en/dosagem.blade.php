...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('en.dosagem') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">STUDY OF DOSAGE - DOSAGE</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory test of dosage study is a procedure used to determine the ideal proportion of materials that make up a mixture, such as concrete, mortar, asphalt or stabilized soils. This test is fundamental in civil engineering to develop mixtures with specific properties that meet the requirements of resistance, durability, workability and other desired characteristics.<br><br>Here is a general description of the dosage study test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the suitable proportion of materials to create a mixture with the desired properties, such as resistance, durability, workability, among others.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. Constituent materials of the mixture (cement, aggregates, water, additives, etc.);<br>2. Mass measurement equipment (scales);<br>3. Volume measurement equipment (buckets, measuring cups);<br>4. Mixer;<br>5. Molds or equipment for molding (depending on the application);<br>6. Equipment for resistance tests, workability, among others (depending on the application);</span><br><br><span style="font-weight: 700;">Procedure:<br>1. Definition of Requirements:</span>&nbsp;Based on the desired characteristics of the mixture (such as resistance, durability, workability), the requirements and criteria to be met are defined.<br><span style="font-weight: 700;">2. Selection of Materials:</span>&nbsp;The materials that will make up the mixture are selected, such as cement, aggregates (sand, gravel), water and possible additives.<br><span style="font-weight: 700;">3. Initial Dosage:</span>&nbsp;Preliminary tests are carried out with different proportions of materials to determine an initial dosage.<br><span style="font-weight: 700;">4. Preparation of Samples:</span>&nbsp;The initial dosage is mixed according to a standardized procedure. In the case of concrete or mortar, for example, the materials are mixed in a mixer until homogeneity is achieved.<br><span style="font-weight: 700;">5. Tests:</span>&nbsp;The prepared samples are subjected to specific tests to evaluate their properties, such as compressive strength, flexural strength, workability, among others, according to the defined requirements.<br><span style="font-weight: 700;">6. Dosage Adjustments:</span>&nbsp;Based on the test results, the dosage is adjusted, increasing or reducing the amount of certain materials, such as cement, water or additives, to meet the desired requirements.<br><span style="font-weight: 700;">7. Confirmation of Dosage:</span>&nbsp;The adjustment and testing process is repeated until the mixture reaches the desired properties and meets the requirements.<br><span style="font-weight: 700;">8. Interpretation:</span>&nbsp;The interpretation of the results involves analyzing the properties of the mixture in relation to the established requirements. For example, in the case of concrete, it is verified whether the compressive strength, workability and other characteristics are within the specifications.<br><br><span style="font-weight: 700;">Utility:</span>&nbsp;The dosage study test is fundamental for the creation of mixtures with specific properties that meet the needs of engineering projects. This is applied in different areas, such as structural concrete, mortars, asphalt and stabilized soils.<br>In summary, the laboratory test of dosage study is an essential tool in civil engineering to develop mixtures with specific characteristics. This allows meeting the requirements of construction and infrastructure projects, ensuring the quality and desired performance of the mixtures used.</p>
      </div>
    </section>
