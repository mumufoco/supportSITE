...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​CISALHAMENTO DIRETO - CD</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">O ensaio laboratorial de cisalhamento direto é um procedimento utilizado para determinar as propriedades de resistência ao cisalhamento de solos e outros materiais geotécnicos. Esse ensaio é fundamental na geotecnia e engenharia civil para compreender o comportamento de materiais quando submetidos a forças de cisalhamento, como as que ocorrem em encostas, fundações e estruturas de contenção.<br><br>Aqui está uma descrição geral do ensaio de cisalhamento direto:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Avaliar a resistência ao cisalhamento de um material, determinando sua resistência ao escorregamento sob ação de forças de cisalhamento.<br><br><span style="font-weight: 700;">Equipamentos e Materiais:<br>1. Dispositivo de cisalhamento direto (geralmente composto por duas metades de caixas que podem ser movidas uma em relação à outra);<br>2. Amostra do material;<br>3. Dispositivo de aplicação de carga (mecânico, hidráulico ou eletrônico);<br>4. Balanças de precisão;<br>5. Régua de medição;<br>6. Instrumentos de medição de deformação (extensômetros);<br>7. Amostra de saturação ou água;</span><br><br><span style="font-weight: 700;">Procedimento:<br>1. Preparação da Amostra:</span>&nbsp;Uma amostra representativa do solo é coletada e preparada de acordo com as dimensões adequadas para o dispositivo de cisalhamento direto.<br><span style="font-weight: 700;">2. Montagem da Amostra:</span>&nbsp;A amostra é colocada entre as metades do dispositivo de cisalhamento direto. Às vezes, é usado um material de saturação ou água nas interfaces para garantir o confinamento lateral.<br><span style="font-weight: 700;">3. Aplicação de Carga:</span>&nbsp;Uma carga normal é aplicada às metades da amostra, simulando as condições de tensão vertical que ocorrem na prática.<br><span style="font-weight: 700;">4. Aplicação de Carga de Cisalhamento:</span>&nbsp;Uma força de cisalhamento é aplicada ao sistema, movendo uma metade da amostra em relação à outra. A força de cisalhamento é gradualmente aumentada até a falha ocorrer.<br><span style="font-weight: 700;">5. Registro de Dados:</span>&nbsp;Durante o ensaio, as cargas normais, as cargas de cisalhamento, os deslocamentos e a deformação são registrados.<br><span style="font-weight: 700;">6. Análise dos Resultados:</span>&nbsp;A partir dos dados coletados, é possível determinar a resistência ao cisalhamento do material, incluindo o ângulo de atrito interno (ângulo de resistência) e a coesão, se aplicável.<br><span style="font-weight: 700;">7. Interpretação:</span>&nbsp;Os resultados do ensaio de cisalhamento direto são geralmente apresentados em um gráfico conhecido como Envelope de Cisalhamento, que mostra a relação entre as tensões normais e as tensões de cisalhamento no material.<br><br><span style="font-weight: 700;">Utilidade:</span>&nbsp;O ensaio de cisalhamento direto é crucial para determinar as propriedades de resistência ao cisalhamento dos materiais geotécnicos. Isso é especialmente importante em projetos de estruturas de contenção, encostas, barragens, fundações e outros casos onde as forças de cisalhamento são relevantes.<br>Em resumo, o ensaio laboratorial de cisalhamento direto é uma ferramenta essencial para avaliar a resistência ao cisalhamento de solos e materiais geotécnicos, fornecendo informações cruciais para o projeto e análise de estruturas e obras geotécnicas.​</p>
      </div>
    </section>
