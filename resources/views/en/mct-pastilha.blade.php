...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​CLASSIFICAÇÃO MCT – PASTILHAS - MCT.P</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​O ensaio laboratorial de classificação MCT (Miniatura de Compactação Triplo) com pastilhas é um procedimento utilizado para classificar solos finos, especialmente argilas, de acordo com a norma brasileira NBR 7182. Esse ensaio avalia a capacidade do solo de ser compactado em diferentes estados de umidade e fornece informações sobre sua consistência e plasticidade.<br><br>Aqui está uma descrição geral do ensaio de classificação MCT com pastilhas:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Classificar solos finos, especialmente argilas, com base na capacidade de compactação em diferentes estados de umidade.<br><br><span style="font-weight: 700;">Equipamentos e Materiais:<br>1.Dispositivo de compactação MCT;<br>2. Moldes para pastilhas (cilíndricos);<br>3. Base de compactação;<br>4. Amostra de solo;<br>5. Balança de precisão;<br>6. Estufa;<br>7. Cronômetro;</span><br><br><span style="font-weight: 700;">Procedimento:</span><br><span style="font-weight: 700;">1. Preparação da Amostra:</span>&nbsp;Uma amostra representativa do solo é coletada e seca ao ar para eliminar o excesso de umidade. A amostra é então triturada e passada pela peneira de abertura 4,75 mm para remover partículas maiores.<br><span style="font-weight: 700;">2. Determinação do Teor de Umidade Inicial:</span>&nbsp;Uma porção da amostra é pesada e colocada em uma estufa a uma temperatura específica (geralmente em torno de 110°C) até atingir peso constante, determinando assim o teor de umidade inicial.<br><span style="font-weight: 700;">3. Compactação das Pastilhas:</span>&nbsp;A amostra é misturada com água destilada para atingir diferentes teores de umidade (geralmente 4, 6, 8, 10 e 12%) em relação ao peso seco. A amostra úmida é então colocada nos moldes cilíndricos e compactada utilizando o dispositivo MCT, aplicando um número fixo de golpes de compactação.<br><span style="font-weight: 700;">4. Determinação da Massa e do Teor de Umidade Final:</span>&nbsp;As pastilhas compactadas são retiradas dos moldes e pesadas. A diferença de peso antes e após a compactação fornece a massa da água deslocada pela compactação. O teor de umidade final é calculado com base na massa da água deslocada e na massa inicial da amostra.<br><span style="font-weight: 700;">5. Interpretação:</span>&nbsp;Com base nos teores de umidade e nas massas compactadas, é possível construir uma curva de compactação MCT. A curva ajuda a classificar o solo de acordo com a norma NBR 7182 em termos de estados de consistência e plasticidade.<br><br><span style="font-weight: 700;">Utilidade:</span>&nbsp;O ensaio MCT com pastilhas é utilizado para classificar solos finos e argilas de acordo com os limites de Atterberg, como o Limite de Liquidez (LL) e o Limite de Plasticidade (LP), auxiliando na compreensão de suas características de consistência e plasticidade.<br>Em resumo, o ensaio laboratorial de classificação MCT com pastilhas é uma ferramenta importante para avaliar a consistência e plasticidade de solos finos e argilas, conforme a norma NBR 7182. Isso auxilia na compreensão das propriedades geotécnicas desses solos e na sua utilização em projetos de engenharia civil.</p>
      </div>
    </section>
