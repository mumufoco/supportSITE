...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PLASTICITY LIMIT - LP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">The laboratory test of plasticity limit is a procedure used to determine the moisture limit between the plastic state and the semi-plastic state of a soil. This test is often performed in geotechnical and civil engineering laboratories to evaluate the plasticity characteristics of clay soils and identify their ability to deform without breaking. The plasticity limit is one of the parameters used in the classification of soils according to their plasticity.<br><br>Here is a general description of the plasticity limit test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the moisture content at which a clay soil transitions from the plastic state to the semi-plastic state, defining the limit between these two states of behavior.<br><br><span style="font-weight: 700;">Equipment and Materials:</span><br>1. Porcelain or glass capsules;<br>2. Spatula;<br>3. Steel roller;<br>4. Precision balance;<br>5. Oven;<br><br><span style="font-weight: 700;">Procedure:</span><br><span style="font-weight: 700;">1. Sample Preparation:</span>&nbsp;A representative sample of the soil is collected and air-dried to eliminate excess moisture. Then, the sample is crushed and passed through a 0.425 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Capsule Preparation:</span>&nbsp;Clean and dry porcelain or glass capsules are weighed and numbered.<br><span style="font-weight: 700;">3. Sample Preparation for Test:</span>&nbsp;A small portion of the sample is removed and mixed with water until a paste-like consistency is reached.<br><span style="font-weight: 700;">4. Shaping the Samples:</span>&nbsp;The paste-like sample is shaped into a sphere or cylinder, depending on the standard used.<br><span style="font-weight: 700;">5. Determination of Plasticity Limit:</span>&nbsp;The shaped sample is divided into smaller portions and steel rollers are used to roll these portions on a glass plate until the diameter of the tracks reaches a value specified by the standard.<br><span style="font-weight: 700;">6. Preparation of Capsules with Samples:</span>&nbsp;Small portions of the shaped samples are placed in the prepared capsules and weighed again.<br><span style="font-weight: 700;">7. Drying in Oven:</span>&nbsp;The capsules with the samples are placed in an oven at a specific temperature (usually 105°C to 110°C) until they reach a constant weight.<br><span style="font-weight: 700;">8. Calculations:</span>&nbsp;Based on the weights before and after drying, the initial moisture and moisture after drying are determined. The plasticity limit is calculated by subtracting the moisture after drying from the initial moisture.<br><span style="font-weight: 700;">9. Interpretation:</span>&nbsp;The result of the test is expressed in terms of moisture (percentage of water) at which the soil passes from the plastic state to the semi-plastic state. This value is known as the "plasticity limit".<br><br>The plasticity limit test is often performed together with the liquidity limit test to determine the plasticity of a soil and classify it according to the Unified Soil Classification System (USCS). In summary, the laboratory test of plasticity limit is fundamental to understanding the plasticity characteristics of clay soils and assisting in the classification of soils and the design of geotechnical engineering works.​</p>
      </div>
    </section>
