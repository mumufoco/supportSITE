...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">RESISTIVITY AT TOWER FOOT</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span>&nbsp;Transmission towers coexist daily with an invisible enemy: atmospheric discharges and leakage currents that seek the path of least resistance to dissipate into the soil. If the grounding of a tower is not working as it should, the structure can experience dangerous overvoltages, equipment damage, and even safety risks for teams and the population.<br>The measurement of the tower foot resistance is, therefore, an indispensable step to evaluate the efficiency of the installed grounding system, verify compliance with standards, and ensure the electromechanical performance of the transmission line. Without this test, the functioning of an electrical network depends on assumptions — and electricity does not usually forgive optimistic assumptions.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The activity aims to determine the electrical resistance of each tower's grounding, checking if the value is within the required parameters for adequate protection against atmospheric discharges and fault currents.<br>The test provides essential data for inspection, preventive maintenance, and correction of systems that may be deteriorated, broken, or with deficient contact with the soil.<br><br><span style="font-weight: 700;">STANDARDS THAT REGULATE AND GUIDE:</span>&nbsp;The measurement of tower foot resistance is governed by widely recognized technical standards, which ensure the standardization of procedures and the reliability of results:<br>NBR 15751 – Grounding Systems – Requirements<br>NBR 5419 – Protection Against Atmospheric Discharges<br>IEEE Std 81 – Guide for Measuring Earth Resistivity, Ground Impedance, and Earth Surface Potentials<br>IEEE Std 80 – Guide for Safety in AC Substation Grounding (referenced for parameters and behavior of fault currents)<br>Manuals and guidelines from transmission concessionaires (ONS, EPE, or specific internal standards)<br>These standards define measurement methods, auxiliary electrode distances, and precautions to avoid interference from the grounding mesh or adjacent towers.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;The test is primarily intended for: Transmission and distribution companies; Electrical engineers and maintenance teams of transmission lines; Consulting engineering companies; High-voltage grounding system designers; Concessionaires and contractors of linear works; Electrical infrastructure inspection, commissioning, and diagnosis sector.<br><br><span style="font-weight: 700;">TECHNICAL DESCRIPTION OF THE ACTIVITY:</span>&nbsp;The measurement of tower foot resistance consists of evaluating the electrical resistance that the structure offers to the flow of current to the soil.<br>The classic procedure is performed with a earth tester, using the Fall of Potential Method (62%), adapted to the particularities of transmission towers.<br><span style="font-weight: 700;">THE PROCESS INVOLVES:</span><br><span style="font-weight: 700;">1. ISOLATION OF THE TOWER GROUNDING (when applicable).</span><br>Installation of a current electrode at a suitable distance, usually between 100 m and 300 m, depending on the soil characteristics and the length of the tower's mesh.<br><span style="font-weight: 700;">2. INSTALLATION OF A POTENTIAL ELECTRODE BETWEEN THE TOWER AND THE CURRENT ELECTRODE.</span><br><span style="font-weight: 700;">3. APPLICATION OF CURRENT:</span> by the earth tester and reading of the potential difference for the calculation of resistance.<br>Repetition of the readings to ensure stability and reliability.<br>In towers close to each other, it may be necessary to perform compensations or use special methods to avoid mutual influence between meshes.<br><br>The final result indicates whether the tower's grounding effectively dissipates current, meeting the established limits and contributing to the safety of the network.<br>ACTIVITY SUMMARY:&nbsp;The measurement of tower foot resistance is a fundamental safety and reliability procedure in transmission systems. Using an earth tester and standardized methodology, it evaluates whether each tower has an effective path for dissipating currents to the soil. The test follows technical standards and international best practices and helps prevent failures, performance drops, and risks associated with atmospheric discharges.<br>It is an activity that ensures the electrical network is protected from the unpredictable — and that each tower is properly connected to the vast and silent conducting mesh that is the soil.​</p>
      </div>
    </section>
