...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ELECTRICAL VERTICAL DRILLING (SEV)</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span>&nbsp;The investigation of the electrical resistivity of the soil is fundamental for engineering projects that depend on the electromagnetic behavior of the subterranean layers. Structures such as grounding systems, deep foundations, buried pipes, transmission lines, solar farms, and cathodic protection systems require precise knowledge of the resistivity variation to ensure safety, performance, and longevity. Without this test, the designer works, metaphorically, in the dark in the subsurface - a place where unexpected events usually come at a high cost.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The electrical drilling test has the objective of determining the apparent resistivity of the different layers of the subsurface, allowing the identification of thicknesses, depths, and stratigraphic contrasts. From these data, it is possible to model the geophysical profile of the terrain, subsidizing engineering projects and environmental analyzes. In simple terms, it reveals how the soil conducts electricity and, from this, how its internal layers behave.<br><br><span style="font-weight: 700;">STANDARDS THAT REGULATE AND GUIDE:</span>&nbsp;In Brazil, this type of test is guided by a set of technical standards that ensure standardization and reliability:<br>NBR 7117 - Determination of Soil Resistivity<br>NBR 15751 - Grounding System - Requirements<br>NBR 5419 - Protection Against Atmospheric Discharges (for applications related to lightning rods and grounding meshes)<br>IEEE Std 81 - Guide for Measuring Earth Resistivity, Ground Impedance, and Earth Surface Potentials<br>ABNT/CE 003:064.001 - Geophysical Tests (with general recommendations)<br>These documents guide the field procedure to data interpretation.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;This test is aimed at: Civil and geotechnical engineers; Designers of grounding systems; Energy transmission companies; Designers of solar and wind farms; Applied geophysics companies; Environmental sector and contamination investigation; Industries that require high electrical reliability.<br><br><span style="font-weight: 700;">TECHNICAL DESCRIPTION OF THE ACTIVITY:</span>&nbsp;The electrical drilling - also called Vertical Electrical Drilling (SEV) - consists of the application of electric current to the soil and measurement of the resulting potential to calculate the apparent resistivity of the layers. The traditional method uses electrode arrays such as:<br>Wenner; Schlumberger; and Dipole-Dipole (most used in horizontal mappings)<br>The equipment injects current between two electrodes and measures the potential difference between the other two. From these values, the apparent resistivity is calculated. Varying the spacing between electrodes progressively, information is obtained at greater depths, allowing the subsurface to be modeled.<br>The result is interpreted through resistivity curves and geophysical inversions, revealing layers, interfaces, humidity, and possible materials (clays, sands, rocks, water circulation, etc.).<br><br><span style="font-weight: 700;">TECHNICAL DIFFERENCE BETWEEN RESISTIVIMETER AND TERRAMETER:</span>&nbsp;Here is the distinction that every engineer should keep in mind:<br><span style="font-weight: 700;">RESISTIVIMETER:</span> Specific instrument for geophysical electrical drillings. Measures the apparent resistivity of soil layers.<br>Operates with greater current amplitude, greater sensitivity, and capacity for long arrays (tens to hundreds of meters).<br>Allows continuous acquisition for stratigraphic interpretation. Used for subsurface modeling and deep investigations. It is, so to speak, the "electrical archaeologist" equipment.<br><span style="font-weight: 700;">TERRAMETER:</span> Instrument used for grounding resistance measurement. Measures the electrical resistance of a point or grounding system, not stratigraphic resistivity. Designed for low depth and lower current amplitude. Uses simplified methods such as the triangle method or auxiliary stake. Not suitable for geophysical drillings.<br>It is the "general practitioner of grounding": excellent at what it does, but not for investigating the subsurface.<br><br><span style="font-weight: 700;">IN SUMMARY:</span><br>The resistivimeter investigates the subsurface;<br>The terrameter evaluates the installed grounding.<br><br><span style="font-weight: 700;">SUMMARY OF THE ACTIVITY:</span> The electrical drilling for determining soil resistivity is an essential geophysical method for understanding the electrical and geotechnical behavior of subterranean layers. It uses a resistivimeter to apply electric current to the soil and measure the response in depth, generating reliable models for engineering projects. The activity follows national and international standards and provides decisive data for the safe and efficient dimensioning of grounding systems, foundations, and environmental studies.​</p>
      </div>
    </section>
