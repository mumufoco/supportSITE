...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">Work Safety Plan</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">​</span><span style="font-weight: 700;">Introduction:</span><br>The objective of this plan is to establish guidelines and practices to ensure the safety and well-being of all collaborators who work in the geotechnical drilling area and in the geotechnical engineering office of Support Solo Sondagens. This plan is in compliance with local work safety regulations.<br><br><span style="font-weight: 700;">Risk Assessment:</span><br>A risk assessment will be carried out in the work environments, identifying potential hazards and implementing appropriate control measures.<br>Personal Protective Equipment (PPE): All collaborators will be provided with suitable PPE for their functions and will be trained in its correct use.<br><br><span style="font-weight: 700;">Training and Qualification:</span><br>All collaborators will undergo periodic training on work safety, including emergency procedures, fire extinguisher use, and safe work practices.<br><br><span style="font-weight: 700;">Signaling and Communication:</span><br>Adequate signaling will be placed in strategic locations to indicate exit routes, safety equipment, and hazardous areas.<br><br><span style="font-weight: 700;">Fire Prevention:</span><br>Fire extinguishers will be maintained in strategic locations and will be inspected regularly.<br><br><span style="font-weight: 700;">Emergency Procedures:</span><br>An action plan will be established for emergencies, including evacuation and first aid.<br><br><span style="font-weight: 700;">Control of Hazardous Materials:</span><br>Hazardous materials will be properly stored, identified, and handled according to local regulations.<br><br><span style="font-weight: 700;">Waste Management:</span><br>A system will be implemented for the collection and proper disposal of waste, following environmental regulations.<br><br><span style="font-weight: 700;">Ergonomics and Proper Posture:</span><br>Awareness will be promoted about the importance of ergonomics and proper posture in the work environment.<br><br><span style="font-weight: 700;">Safety Inspections and Audits:</span><br>Regular inspections will be conducted to ensure that all safety practices are being followed correctly.<br><br><span style="font-weight: 700;">Communication of Incidents and Accidents:</span><br>All incidents and accidents will be promptly communicated to the management and health and safety team.<br><br><span style="font-weight: 700;">Well-being Program:</span><br>A well-being program will be implemented that includes health and safety practices, encouraging care for physical and mental health of collaborators.<br><br><span style="font-weight: 700;">Review and Update:</span><br>This plan will be reviewed annually to ensure that it continues to meet current safety standards.<br><br>Support Solo Sondagens is committed to maintaining a safe and healthy work environment for all collaborators. The responsibility for implementing and complying with this plan is for all levels of collaborators and managers. Failure to comply with safety policies may result in disciplinary measures.</p>
      </div>
    </section>
