...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">THERMAL RESISTIVITY OF THE SOIL - TR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">The in-situ thermal resistivity test of the soil is a technique used to determine the soil's ability to conduct heat. This parameter is essential for the evaluation and design of underground thermal exchange systems, such as underground cables and geothermal heating and cooling systems. The thermal resistivity of the soil influences the dissipation of heat generated by these installations and, therefore, affects the efficiency and safety of the system.<br><br><span style="font-weight: 700;">Standards that Cover the Thermal Resistivity Test of the Soil:</span><br>IEEE 442-2017: "Guide for Thermal Resistivity Measurements of Soils and Backfill Materials" – This standard provides guidance on the methods and procedures for measuring the thermal resistivity of soils and backfill materials in-situ and in the laboratory.<br>ASTM D5334-22: "Standard Test Method for Determination of Thermal Conductivity of Soil and Soft Rock by Thermal Needle Probe Procedure" – This standard describes the "thermal needle probe" method for measuring the thermal conductivity of soils and soft rocks.<br>IEC/TS 62039:2007: "Guidance on the measurement of soil resistivity" – This standard offers guidelines for measuring the thermal resistivity of the soil in the field and includes methods of measurement and interpretation of the data.<br><br><span style="font-weight: 700;">Detail of the Execution of the In-Situ Thermal Resistivity Test of the Soil:</span><br><span style="font-weight: 700;">1. Preparation of the Test Site:</span> Selection of a representative site of the soil where the thermal exchange system will be installed.<br>Removal of any vegetation or debris from the surface.<br>Excavation of a small well or borehole to reach the desired depth for the measurement.<br><span style="font-weight: 700;">2. Installation of the Thermal Probe:</span> Introduction of a thermal probe into the soil at the determined depth. The probe can be a needle-type probe, which consists of a heating element and temperature sensors.<br>Ensuring that the probe is in good thermal contact with the surrounding soil, without air spaces or foreign materials.<br><span style="font-weight: 700;">3. Application of Heat:</span> Application of a constant electric current to the heating element in the thermal probe, generating a constant heat flow.<br>Monitoring the temperature variations in the probe as a function of time, using the integrated temperature sensors.<br><span style="font-weight: 700;">4. Measurement and Recording of Data:</span> Continuous recording of temperature readings during the heating period.<br>After a sufficient period of time (usually between 10 to 20 minutes), the temperature data is stabilized.<br><span style="font-weight: 700;">5. Calculation of Thermal Resistivity:</span> Use of the temperature data and the applied heat flow to calculate the thermal resistivity of the soil.<br>The thermal resistivity (ρ) is calculated based on the formula: ρ = dT/dQ.<br><span style="font-weight: 700;">6. Interpretation of the Results:</span> Comparison of the obtained values with the design criteria and the specifications of the thermal exchange system.<br>Adjustments to the system design, if necessary, based on the measured thermal resistivity.<br><br><span style="font-weight: 700;">Additional Considerations</span><span style="font-weight: 700;">&nbsp;Equipment Calibration:</span> The thermal probes and measurement equipment must be calibrated regularly to ensure the accuracy of the measurements.<br><br><span style="font-weight: 700;">Soil Conditions:</span> The humidity, density, and composition of the soil can significantly affect the results. It is recommended to perform measurements in different seasonal conditions for a more comprehensive analysis.<br><br><span style="font-weight: 700;">Safety:</span> Ensure that all safety standards are followed when handling electrical equipment and during excavation.<br>The in-situ thermal resistivity test of the soil is a crucial tool for ensuring the efficiency and durability of underground thermal exchange systems.​</p>
      </div>
    </section>
