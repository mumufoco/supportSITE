...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">COMPACTION - COMPACTION</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory compaction test is a procedure used to evaluate the deformation and consolidation of soils when subjected to vertical loads. This test is essential to understand how soils respond to loads over time and is fundamental in geotechnics for foundation, embankment, and structure projects that interact with the soil.<br><br>Here is a general description of the compaction test:<br><br><span style="font-weight: 700;">Objective:</span> To evaluate the consolidation and deformation of the soil when subjected to vertical loads, simulating field conditions.<br><br><span style="font-weight: 700;">Equipment and Materials:</span><br>1. Compaction cell;<br>2. Soil sample;<br>3. Porous plate;<br>4. Water or saturating fluid;<br>5. Deformation measurement instruments (extensometers);<br>6. Precision balances;<br>7. Sample saturation devices;<br><br><span style="font-weight: 700;">Procedure:</span><br>1. <span style="font-weight: 700;">Sample Preparation:</span> A representative soil sample is collected and prepared according to the suitable dimensions for the compaction cell.<br><span style="font-weight: 700;">2. Sample Saturation:</span> The sample is saturated with water or a suitable saturating fluid, ensuring that the soil is completely saturated.<br><span style="font-weight: 700;">3. Sample Assembly:</span> The sample is placed inside the compaction cell, between the porous plate and the upper support, which applies the load. The porous plate allows the saturating fluid to be drained, while the upper support applies the load.<br><span style="font-weight: 700;">4. Loading:</span> The load is applied gradually to the upper support, simulating the vertical load conditions that occur in practice. The load application time can be controlled.<br><span style="font-weight: 700;">5. Data Recording:</span> During the test, the loads and deformations are recorded over time, allowing observation of how the soil deforms and consolidates.<br><span style="font-weight: 700;">6. Load Removal:</span> After load application, the load is removed gradually, and the deformations continue to be monitored, allowing observation of the soil recovery.<br><span style="font-weight: 700;">7. Interpretation:</span> The compaction test results are often presented in graphs known as Compaction Curves, which show the relationship between time and soil deformation under load.<br><br><span style="font-weight: 700;">Utility:</span> The compaction test is crucial to understand how soils behave under vertical loads and how the consolidation process occurs. This information is used to predict future soil deformation, settlement rate, and helps design foundations and structures properly.<br>In summary, the laboratory compaction test is an essential tool in geotechnics, allowing the evaluation of consolidation and deformation of soils under vertical loads. This is fundamental for geotechnical engineering projects, especially regarding foundations and structures that interact with the soil.</p>
      </div>
    </section>
