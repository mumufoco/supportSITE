...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('en.spda') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROJECT SPDA - ATMOSPHERIC DISCHARGES</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The development of projects for the System of Protection against Atmospheric Discharges (SPDA), also known as lightning rods, is essential to create protection systems that minimize the risks of damage caused by atmospheric discharges, such as lightning, to buildings, structures, and equipment. These projects encompass the planning and design of systems that safely direct electrical discharges to the ground, protecting people, properties, and electronic systems. The need to develop SPDA projects is evident for several reasons:<br><br><span style="font-weight: 700;">1. Safety of People:</span> The primary function of SPDA systems is to protect people against the risks of lightning, minimizing the chances of injury or death caused by electrical discharges.<br><span style="font-weight: 700;">2. Protection of Structures:</span> SPDA projects aim to protect structures against damage caused by fires, explosions, and impacts associated with atmospheric discharges.<br><span style="font-weight: 700;">3. Electronic Equipment:</span> SPDA systems protect sensitive electronic equipment, such as computers, communication systems, and automation devices, against electrical damage.<br><span style="font-weight: 700;">4. Fire Prevention:</span> The development of projects seeks to prevent fires caused by lightning, which can occur when electrical discharges hit flammable materials.<br><span style="font-weight: 700;">5. Compliance with Regulations:</span> Many regions have regulations that require the implementation of SPDA systems in certain types of buildings and structures.<br><span style="font-weight: 700;">6. Risk Minimization:</span> SPDA projects help minimize the risks of damage caused by lightning, providing peace of mind to occupants.<br><span style="font-weight: 700;">7. Cultural Heritage:</span> In historical and cultural sites, SPDA systems protect valuable structures against irreparable damage.<br><span style="font-weight: 700;">8. Damage Mitigation:</span> Even if it is not possible to completely avoid damage caused by lightning, SPDA systems mitigate the effects and concentrate them in safe areas.<br><span style="font-weight: 700;">9. Safety in Outdoor Environments:</span> SPDA systems can also be installed in outdoor areas, such as parks and sports fields, protecting people during outdoor activities.<br><span style="font-weight: 700;">10. Long-term Investment:</span> The implementation of SPDA projects is a long-term investment, reducing costs for repairs and equipment replacements.<br><span style="font-weight: 700;">11. Creation of Preferred Routes:</span> SPDA projects create preferred routes for electrical discharges, minimizing the risks of accidental damage.<br><span style="font-weight: 700;">12. Safety Engineering:</span> The development of SPDA projects requires specialized knowledge in electrical engineering and lightning protection.<br><br>In summary, the development of SPDA projects is necessary to protect people, structures, and equipment against the risks associated with atmospheric discharges. These projects seek to minimize damage caused by lightning, providing safety and compliance with specific regulations. The implementation of SPDA systems contributes to the safety and integrity of buildings and environments in general.</p>
      </div>
    </section>
