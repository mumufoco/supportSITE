...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​ENSAIO DE CBR E EXPANSÃO - CBR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">O ensaio laboratorial de CBR (California Bearing Ratio) e expansão é um procedimento utilizado para avaliar a capacidade de suporte de um solo subleito, especialmente quando utilizado como material de base ou sub-base em pavimentos rodoviários. O ensaio de CBR mede a relação entre a capacidade de suporte de um solo e a capacidade de suporte de um material de referência, geralmente uma pedra britada. Além disso, o ensaio avalia a expansão do solo sob umedecimento, que pode ser crítico em determinadas condições.<br><br>Aqui está uma descrição geral do ensaio de CBR e expansão:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Avaliar a capacidade de suporte de um solo subleito em relação à capacidade de suporte de um material de referência (pedra britada) e medir a expansão do solo sob umedecimento.<br><br><span style="font-weight: 700;">Equipamentos e Materiais:<br>1. Molde CBR;<br>2. Compactador Proctor (para determinação da densidade seca máxima);<br>3. Amostra de solo;<br>4. Pedra britada (material de referência);<br>5. Penetrômetro CBR;<br>6. Haste de expansão;<br>7. Prato de expansão;<br>8. Câmara de expansão;<br>9. Balança de precisão;<br>10. Estufa;<br>11. Dispositivo de umedecimento (pode ser um recipiente e água)</span><br><br><span style="font-weight: 700;">Procedimento:<br>1. Preparação da Amostra:</span>&nbsp;Uma amostra representativa do solo é coletada e seca ao ar para eliminar o excesso de umidade. A amostra é então triturada e passada pela peneira de abertura 19 mm.<br><span style="font-weight: 700;">2. Determinação da Densidade Seca Máxima:</span>&nbsp;Uma porção da amostra é compactada em camadas no molde CBR usando um compactador Proctor. A densidade seca máxima da amostra é determinada com base no ensaio Proctor.<br><span style="font-weight: 700;">3. Ensaio de CBR:</span>&nbsp;A amostra compactada é saturada com água e, em seguida, é inserido o penetrômetro CBR no solo até uma profundidade padrão. A carga necessária para penetrar no solo é registrada e comparada com a carga necessária para penetrar no material de referência (pedra britada). O resultado é expresso como o índice de CBR.<br><span style="font-weight: 700;">4. Ensaio de Expansão:</span>&nbsp;A amostra de solo é usada para realizar o ensaio de expansão. A amostra é colocada no prato de expansão dentro da câmara de expansão, e água é adicionada gradualmente. A expansão do solo é medida através da variação na altura da amostra.<br><span style="font-weight: 700;">5. Interpretação:</span>&nbsp;O resultado do ensaio de CBR é expresso como uma porcentagem, indicando a capacidade de suporte do solo em relação à pedra britada. Quanto maior o valor de CBR, maior a capacidade de suporte do solo. No ensaio de expansão, a variação na altura da amostra de solo após umedecimento é registrada como uma medida da expansão.<br><br><span style="font-weight: 700;">Utilidade:</span>&nbsp;O ensaio de CBR e expansão é importante para avaliar a adequação do solo subleito para suportar cargas de pavimentos rodoviários e a possibilidade de expansão do solo quando exposto à umidade.<br>Em resumo, o ensaio laboratorial de CBR e expansão é uma ferramenta essencial para avaliar a capacidade de suporte e a expansão de solos utilizados em pavimentos rodoviários e outras aplicações de engenharia geotécnica. Isso auxilia na seleção e projeto de materiais adequados para construção de estradas e pavimentos.​</p>
      </div>
    </section>
