...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">CLASSIFICATION MCT - MCT.C</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory test of MCT classification (Miniature Compaction Triplo) is a procedure used to classify fine soils according to their compaction capacity in different moisture contents. This test is commonly used in geotechnics and civil engineering to evaluate the consistency and plasticity of soils and to classify them according to the Atterberg limits, such as the Liquid Limit (LL) and the Plastic Limit (LP).<br><br>Here is a general description of the MCT classification test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;Classify fine soils based on their compaction capacity in different moisture contents.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. MCT compaction device;<br>2. Soil sample;<br>3. Precision balance;<br>4. Oven;<br>5. Chronometer;</span><br><br><span style="font-weight: 700;">Procedure:<br>Sample Preparation:</span>&nbsp;A representative soil sample is collected and dried in the air to eliminate excess moisture. The sample is then crushed and passed through a 4.75 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Determination of Initial Moisture Content:</span>&nbsp;A portion of the sample is weighed and placed in an oven at a specific temperature (usually around 110°C) until it reaches a constant weight, thus determining the initial moisture content.<br><span style="font-weight: 700;">3. Compaction of Samples:</span>&nbsp;The sample is mixed with distilled water to reach different moisture contents (usually 4, 6, 8, 10, and 12%) in relation to the dry weight. The moist sample is then placed in cylindrical molds of the MCT device and compacted by applying a fixed number of compaction blows.<br><span style="font-weight: 700;">4. Determination of Final Mass and Moisture Content:</span>&nbsp;The compacted samples are removed from the molds and weighed. The final moisture content is calculated based on the mass of the moist sample, the mass of the dry sample, and the mass of the added water.<br><span style="font-weight: 700;">5. Construction of the MCT Curve:</span>&nbsp;With the moisture contents and compacted masses, it is possible to construct an MCT curve that relates the moisture content to the MCT index. The MCT index is calculated by dividing the moisture content by the logarithm of the number of compaction blows.<br><span style="font-weight: 700;">6. Interpretation:</span>&nbsp;The MCT curve helps to classify the soil based on its compaction behavior. This assists in determining the Liquid Limit (LL) and the Plastic Limit (LP), allowing the soil to be classified according to the Brazilian standard NBR 6459.<br><br><span style="font-weight: 700;">Utility:</span>&nbsp;The MCT test is used to classify fine soils and clays, helping to understand their consistency and plasticity characteristics. It is especially useful for the rapid and practical determination of the Atterberg limits and in the classification of soils for geotechnical engineering purposes.<br>In summary, the laboratory test of MCT classification is an important tool for evaluating the consistency and plasticity of fine soils, allowing classification according to the Atterberg limits. This helps in understanding the geotechnical properties of these soils and their use in civil engineering projects.</p>
      </div>
    </section>
