...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​SONDA GAMA NATURAL E DE TEMPERATURA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​Esta sonda fornece uma solução para casos em que apenas um log gama natural de contagens totais básicas é necessário e também fornece uma medição de temperatura de fluido de poço, útil para corrigir outros logs.&nbsp;<br><br>Basado e um detector de cristal de centelho NaI (Tl) de ø 25 x 50 mm acoplado a um tubo fotomultiplicador de alto rendimento, la sonda com uma sensibilidade excelente (± 1,2 cps / unidade API) e proporciona um resultado de alta qualidade.<br><br>Além de sua função principal como um indicador de litologia ou argila, uma medição de gama natural é frequentemente usada como base para estabelecer correlações entre furos e para garantir correspondência precisa de profundidade entre diferentes corridas de perfilagem feitas no mesmo furo.</p>
      </div>
    </section>
