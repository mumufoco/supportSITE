...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PERCUSSION DRILLING - SP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span> The field test of percussion drilling, or SPT (Standard Penetration Test), is necessary to obtain information about the properties of the soil at subsurface depths. This information is essential for geotechnical engineering projects, such as evaluating the load capacity of the soil, sizing foundations, containment projects, among others. The SPT is used to understand how the soil behaves under load and to make informed decisions about the project and construction of structures.<br><br><span style="font-weight: 700;">OBJECTIVE:</span> The main objective of the SPT test is to evaluate the resistance of the soil and its geotechnical characteristics in depth. This helps engineers determine the load capacity of the soil, shear resistance, cohesion, and internal friction angle, crucial information for foundation design, support structures, and other geotechnical works.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span> The Brazilian standards that deal with the SPT test are:<br>NBR 6484:2010 - Soil - Simple recognition drilling with SPT - Test method.<br>NBR 8036:1993 - Programming of simple recognition drilling of soils for building foundations.<br>NBR 9603:1986 - Design and execution of simple recognition drilling of soils for building foundations.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span> The target audience of the SPT test includes geotechnical engineers, civil engineers, geologists, and other professionals involved in geotechnical engineering projects. Construction companies, engineering consultancies, government planning and regulatory agencies, as well as academic and research professionals, also benefit from the information obtained through the SPT test.<br><br><span style="font-weight: 700;">TECHNIQUE:</span> The technique of the SPT test involves the following stages:<br><span style="font-weight: 700;">1. Probe Installation:</span> A percussion probe is installed at the drilling site, usually using extension rods to reach the desired depths.<br><span style="font-weight: 700;">2. Hammering:</span> A free-fall hammer is raised and released, making it fall on the probe. The probe penetrates the soil with each hammer blow.<br><span style="font-weight: 700;">3. Penetration and Sampling:</span> The probe penetrates the soil through successive blows. The test can be interrupted at intervals to collect soil samples using a sampler or sampler.<br><span style="font-weight: 700;">4. Blow Count:</span> The penetration of the probe after each blow is recorded. The number of blows required for the probe to penetrate a certain distance is known as the SPT blow count (N).<br><span style="font-weight: 700;">5. Depth:</span> The penetration depth is measured as the probe advances.<br><br>The information obtained during the SPT test is used to evaluate the characteristics of the soil, estimate its resistance, cohesion, internal friction angle, and other properties. This data is crucial for the design of safe foundations, the choice of suitable structures, and informed engineering decisions.<br>In summary, the field test of percussion drilling (SPT) is a fundamental technique in geotechnical engineering to obtain information about the characteristics of the soil at subsurface depths. It is used by a variety of professionals and organizations involved in engineering and construction projects in Brazil, following established standards.</p>
      </div>
    </section>
