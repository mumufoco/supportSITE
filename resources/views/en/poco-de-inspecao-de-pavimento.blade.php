...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PAVEMENT INSPECTION WELL - PI</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span>&nbsp;The pavement inspection well test is necessary to evaluate the condition of the pavement layers and the subbase in roads, highways, and traffic lanes. This evaluation is fundamental to determine the structural integrity of the pavement, identify defects, perform adequate maintenance, and plan rehabilitation interventions.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The main objective of the pavement inspection well test is to obtain visual, structural, and geotechnical information about the pavement layers and the subbase. This allows evaluating the pavement's bearing capacity, the presence of cracks, deformations, and other defects, as well as identifying the need for repairs or reinforcements.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span>&nbsp;The Brazilian standards that deal with the pavement inspection well test are related to pavement tests, defect investigation, and pavement quality. Some examples of relevant standards include:<br>DNIT 005/2003 – Test Method – Simple Recognition Drilling of Pavement (Inspection Well).<br>DNIT 013/2004 – Procedure for Pavement Data Survey.<br>DNIT 014/2004 – Visual Inspection Manual for Asphalt Pavements.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;The target audience for the pavement inspection well test includes pavement engineers, civil engineers, infrastructure technicians, highway and road managers, traffic and transportation agencies, as well as contractors involved in the construction and maintenance of pavements.<br><br><span style="font-weight: 700;">TECHNIQUE:</span>&nbsp;The pavement inspection well test technique involves the following steps:<br><span style="font-weight: 700;">1. SITE PREPARATION:</span>&nbsp;The inspection site is chosen according to pre-established criteria, considering the highway extension, pavement type, and other relevant factors.<br><span style="font-weight: 700;">2. WELL OPENING:</span>&nbsp;A well is opened in the pavement through cutting or removing part of the asphalt layer. The size and depth of the well depend on the evaluation needs.<br><span style="font-weight: 700;">3. VISUAL INSPECTION:</span>&nbsp;A visual inspection is performed to observe the pavement layers and the subbase. Defects such as cracks, displacements, deformations, and other signs of deterioration are recorded.<br><span style="font-weight: 700;">4. SAMPLE COLLECTION:</span>&nbsp;Pavement layer samples may be collected for laboratory analysis, including grain size analysis, moisture content, and other characteristics.<br><span style="font-weight: 700;">5. GEOTECHNICAL EVALUATION:</span>&nbsp;Depending on the needs, geotechnical tests may be performed on the subbase to evaluate its bearing capacity.<br><span style="font-weight: 700;">6. DATA RECORDING:</span>&nbsp;All data obtained during the inspection are recorded, including photographs, schematic drawings, notes, and relevant observations.<br><span style="font-weight: 700;">7. INTERPRETATION:</span>&nbsp;The analysis of the data obtained from the pavement inspection well test allows determining the pavement condition, identifying defects, and evaluating the need for interventions. This information is essential for planning maintenance, rehabilitation, or reconstruction works on pavements.<br><br>In summary, the pavement inspection well test is an important technique in pavement engineering to evaluate the condition of the pavement layers and the subbase in roads and highways. It is used by a variety of professionals and organizations involved in the construction and maintenance of pavements, following established standards.​</p>
      </div>
    </section>
