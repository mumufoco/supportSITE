...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">GRANULOMETRY BY SIEVING - SIEVE</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">The laboratory test of granulometry by sieving is a procedure used to determine the distribution of the different granulometric fractions present in a soil or aggregate sample. This test is crucial in geotechnics and civil engineering to evaluate the granulometric composition of materials used in construction, such as sand, gravel, and soils. The granulometric distribution influences the properties and behavior of the materials in engineering works.<br><br>Here is a general description of the granulometry test by sieving:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the distribution of the different granulometric fractions present in a soil or aggregate sample.<br><br><span style="font-weight: 700;">Equipment and Materials:</span><br><span style="font-weight: 700;">1. Set of sieves with different openings (meshes);<br>2. Mechanical or manual agitator;<br>3. Precision balances;<br>4. Container for the sample;<br>5. Brush for cleaning the sieves;<br>6. Shovel for excavation;<br>7. Cleaning cloths;</span><br><br><span style="font-weight: 700;">Procedure:</span><br><span style="font-weight: 700;">1. Preparation of the Sample:</span>&nbsp;A representative sample of the soil or aggregate is collected and dried in the air to eliminate excess moisture. The sample is then crushed and passed through the 4.75 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Selection of Sieves:</span>&nbsp;A set of sieves with openings of different sizes is selected. The sieves are numbered and their openings are determined.<br><span style="font-weight: 700;">3. Sieving:</span>&nbsp;The sample is placed in the top sieve and the set of sieves is placed in a mechanical agitator or agitated manually to separate the particles according to size. The test is conducted for a specific period to ensure that all particles that can be retained have had the opportunity to pass through the sieves.<br><span style="font-weight: 700;">4. Weighing:</span>&nbsp;After sieving, each sieve is weighed with the retained particles. The retained particles in each sieve are weighed individually.<br><span style="font-weight: 700;">5. Calculations:</span>&nbsp;Based on the masses of the particles retained in each sieve, the percentage of mass that passes through each opening is calculated, creating the granulometric curve.<br><span style="font-weight: 700;">6. Interpretation:</span>&nbsp;The resulting granulometric curve from the sieving test shows the percentage distribution of mass of the different granulometric fractions in the sample. This helps to identify the proportion of fine, medium, and coarse particles present in the material.<br><br><span style="font-weight: 700;">Utility:</span>&nbsp;Granulometric analysis is fundamental for evaluating the suitability of a soil or aggregate for use in construction. It influences compaction, permeability, drainage capacity, deformation behavior, and resistance of materials. Additionally, granulometry is used to classify soils according to classification systems such as the Unified Soil Classification System (USCS). In summary, the laboratory test of granulometry by sieving is an essential tool for evaluating the granulometric composition of soils and aggregates, providing crucial information for geotechnical engineering and construction projects.​</p>
      </div>
    </section>
