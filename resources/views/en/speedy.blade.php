...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('en.speedy') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SPEEDY METHOD</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory test Speedy Method, also known as Speedy Test, is a procedure used to determine the moisture content in soil samples. This method is particularly useful in situations where it is necessary to obtain results quickly, such as in construction sites or remote locations, where soil moisture is important information for construction and engineering decisions.<br><br>Here is a general description of the Speedy Method test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To quickly determine the moisture content of a soil sample.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. Speedy device (also called Speedy meter);<br>2. Sample capsule (usually made of aluminum);<br>3. Ampoule containing calcium carbide;<br>4. Device for applying pressure to the ampoule;<br>5. Precision balance;<br>6. Pressure measurement instrument (manometer);<br>7. Distilled water;</span><br><br><span style="font-weight: 700;">Procedure:<br>1. Sample Preparation:</span>&nbsp;A soil sample is collected and weighed to determine its initial mass.<br><span style="font-weight: 700;">2. Sample Capsule:</span>&nbsp;The sample is placed in the capsule and the capsule is closed.<br><span style="font-weight: 700;">3. Addition of Calcium Carbide:</span>&nbsp;The ampoule containing calcium carbide is connected to the capsule and a precise amount of distilled water is added to the ampoule.<br><span style="font-weight: 700;">4. Application of Pressure:</span>&nbsp;The ampoule is placed in the Speedy device and pressure is applied to the ampoule, causing the water to interact with the calcium carbide and produce acetylene gas.<br><span style="font-weight: 700;">5. Pressure Measurement:</span>&nbsp;The acetylene gas generated by the reaction is measured using a manometer.<br><span style="font-weight: 700;">6. Calculation of Moisture:</span>&nbsp;Based on the pressure of the acetylene gas generated and the initial mass of the sample, it is possible to calculate the moisture content of the soil.<br><span style="font-weight: 700;">7. Interpretation:</span>&nbsp;The pressure of the acetylene gas generated is used to calculate the moisture content of the soil, based on a pre-established relationship between pressure and moisture.<br><br><span style="font-weight: 700;">Usefulness:</span>&nbsp;The Speedy Method test is used when it is necessary to quickly obtain information about the moisture content of the soil. This is particularly useful in construction sites, remote locations, or situations where soil moisture directly affects construction and engineering decisions.<br>In summary, the Speedy Method laboratory test is a quick and practical procedure for determining the moisture content of a soil sample. It is a useful tool for obtaining immediate information about soil moisture in situations where speed is crucial.</p>
      </div>
    </section>
