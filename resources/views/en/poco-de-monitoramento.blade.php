...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MONITORING WELL - MW</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span>&nbsp;The field test with a monitoring well is necessary to collect groundwater samples and measure water levels at a specific point. This test is fundamental to understanding the characteristics of the aquifer, monitoring groundwater quality, and evaluating changes in the water table over time.<br><br><span style="font-weight: 700;">OBJECTIVE:</span>&nbsp;The main objective of the field test with a monitoring well is to obtain information about the groundwater level and, when applicable, collect samples for water quality analysis. This allows understanding seasonal variations, recharge and discharge trends, the interaction between surface and groundwater, as well as water quality in the aquifer.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span>&nbsp;The Brazilian standards that deal with the field test with a monitoring well are related to groundwater monitoring and water quality procedures. Some relevant standards include:<br>ABNT NBR 15495-1:2018 – Groundwater monitoring wells – Part 1: Test method for installation.<br>ABNT NBR 15495-2:2018 – Groundwater monitoring wells – Part 2: Test method for development.<br>ABNT NBR 15495-3:2018 – Groundwater monitoring wells – Part 3: Test method for purging and sampling.<br>ABNT NBR 15495-4:2018 – Groundwater monitoring wells – Part 4: Test method for groundwater sampling.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span>&nbsp;The target audience for the field test with a monitoring well includes geotechnical engineers, hydrogeologists, civil engineers, geologists, geotechnical technicians, and professionals involved in groundwater management and water quality projects. Consulting companies in hydrogeology, government agencies, research institutions, and companies involved in water resources can use the results of these tests.<br><br><span style="font-weight: 700;">TECHNIQUE:</span>&nbsp;The technique of the field test with a monitoring well involves the following steps:Well Installation:&nbsp;A monitoring well is drilled into the ground until it reaches the aquifer of interest. The well is cased to prevent collapse and ensure sample quality.<br><span style="font-weight: 700;">1. Installation of Tubes and Filters:</span>&nbsp;Perforated or slotted tubes are inserted into the well, allowing groundwater to flow into the well. Filters are installed to prevent solid particles from entering the well.<br><span style="font-weight: 700;">2. Measurements and Sampling:</span>&nbsp;Water level measurements are made periodically using specific instruments, such as piezometers. Groundwater samples can be collected for laboratory analysis.<br><span style="font-weight: 700;">3. Purging and Sampling:</span>&nbsp;The purging process involves removing a certain amount of water from the well before collecting samples to ensure that the water is representative of the aquifer.<br><span style="font-weight: 700;">4. Data Recording:</span>&nbsp;All measurements and samples collected are recorded, including depths, water levels, water quality parameters, and other relevant aspects.<br><span style="font-weight: 700;">5. RESULTS AND APPLICATIONS:</span>&nbsp;The results of the field test with a monitoring well provide information about groundwater behavior, changes in the water table, and water quality in the aquifer. This information is crucial for sustainable management of groundwater resources, environmental impact assessment, and decision-making related to projects involving groundwater.<br><br>In summary, the field test with a monitoring well is an essential technique in hydrogeology for collecting information about groundwater and water quality, as well as monitoring changes in the water table over time. It is used by a variety of professionals and organizations involved in groundwater management and water resources projects, following established standards and procedures.​</p>
      </div>
    </section>
