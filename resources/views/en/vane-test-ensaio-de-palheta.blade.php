...
@section('lang', 'en')
@section('title', 'Vane Test - Ensaio de Palheta')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Vane-Test---Ensaio-de-Palheta.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​VANE TEST - ENSAIO DE PALHETA - VT</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">Necessidade:</span>&nbsp;O ensaio de campo Vane Test, também conhecido como ensaio de cisalhamento por vane, é necessário para determinar a resistência ao cisalhamento do solo, especialmente em solos coesivos, como argilas. Esse ensaio é fundamental para avaliar a estabilidade de fundações, taludes, escavações e outras estruturas que estão em contato com o solo, fornecendo informações cruciais para o projeto e a execução de obras geotécnicas.<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;O objetivo principal do ensaio de campo Vane Test é medir a resistência ao cisalhamento não drenado de um solo coesivo. Isso é importante para determinar a capacidade do solo de suportar cargas e forças que causam movimentos de deslizamento, deformações e outros comportamentos geotécnicos relevantes.<br><br><span style="font-weight: 700;">Normas Brasileiras:</span>&nbsp;As normas brasileiras que tratam do ensaio de campo Vane Test estão relacionadas a ensaios de resistência ao cisalhamento de solos coesivos. Alguns exemplos de normas que podem ser relevantes incluem:<br>ABNT NBR 12007:1991 – Solo – Determinação do Limite de Liquidez.<br>ABNT NBR 12008:1991 – Solo – Determinação do Limite de Plasticidade.<br>ABNT NBR 6457:1986 – Amostras de Solo – Preparação para Ensaio de Compactação e Ensaios de Caracterização.<br><br><span style="font-weight: 700;">Público-Alvo:</span>&nbsp;O público-alvo do ensaio de campo Vane Test inclui engenheiros geotécnicos, engenheiros civis, geólogos, técnicos em geotecnia e profissionais envolvidos em projetos que requerem a avaliação da resistência ao cisalhamento de solos coesivos. Empresas de engenharia geotécnica, consultorias geotécnicas, órgãos governamentais e instituições de pesquisa podem utilizar os resultados desses ensaios.<br><br><span style="font-weight: 700;">Técnica:</span>&nbsp;A técnica do ensaio de campo Vane Test envolve as seguintes etapas:<br><span style="font-weight: 700;">1. Preparação do Local</span>:&nbsp;O local de ensaio é escolhido de acordo com critérios geotécnicos relevantes, levando em consideração as características do solo e os objetivos do ensaio.<br><span style="font-weight: 700;">2. Instalação do Aparelho:</span>&nbsp;Um aparelho de ensaio de cisalhamento por vane é inserido no solo. Esse aparelho é composto por uma lâmina de forma específica que será girada para induzir o cisalhamento do solo.<br><span style="font-weight: 700;">3. Aplicação do Torque:</span>&nbsp;O aparelho é girado para aplicar um torque à lâmina e induzir o cisalhamento do solo. A resistência ao cisalhamento é registrada em termos de torque necessário para que ocorra o cisalhamento.<br><span style="font-weight: 700;">4. Medição da Resistência:</span>&nbsp;A resistência ao cisalhamento é registrada em unidades de torque, geralmente em Newton-metro (Nm) ou quilograma-força metro (kgf m).<br><span style="font-weight: 700;">5. Registro de Dados:</span>&nbsp;Todos os dados obtidos durante o ensaio são registrados, incluindo a resistência ao cisalhamento, profundidade do ensaio, características do solo e outros aspectos relevantes.<br><span style="font-weight: 700;">6. Interpretação:</span>&nbsp;A resistência ao cisalhamento obtida no ensaio de campo Vane Test fornece informações sobre a capacidade do solo coesivo de resistir a forças de cisalhamento. Essas informações são cruciais para a avaliação da estabilidade de estruturas geotécnicas, como fundações, taludes, cortinas de contenção e outros elementos que interagem com o solo.<br><br>Em resumo, o ensaio de campo Vane Test é uma técnica importante na engenharia geotécnica para avaliar a resistência ao cisalhamento de solos coesivos. Ele é utilizado por uma variedade de profissionais e organizações envolvidos em projetos geotécnicos, seguindo as normas e procedimentos estabelecidos.​</p>
      </div>
    </section>
