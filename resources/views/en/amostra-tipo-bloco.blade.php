...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">UNDEFORMED BLOCK SAMPLE TYPE - BL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span> The field test with an undeformed block sample is necessary to collect unperturbed soil samples in cohesive and clayey soils, allowing the analysis of the soil's geotechnical characteristics in its unaltered state. These samples are fundamental for evaluating the soil's resistance, compressibility, and permeability, assisting in the design and execution of geotechnical works.<br><br><span style="font-weight: 700;">OBJECTIVE:</span> The main objective of the field test with an undeformed block sample is to collect soil samples that preserve their original structure, unaffected by the sampling process. This enables the realization of laboratory tests that will provide accurate information about the soil's mechanical and hydraulic properties.<br><br><span style="font-weight: 700;">BRAZILIAN STANDARDS:</span> The Brazilian standards that address the field test with an undeformed block sample are related to sampling and geotechnical investigation tests. Some relevant standards include:<br>ABNT NBR 6484:2001 - Execution of Simple Recognition Drilling with SPT - Test Method.<br>ABNT NBR 8036:1983 - Soil - Compaction Test - Test Method.<br>ABNT NBR 7250:1986 - Soil - Cone Penetration Test - Test Method.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span> The target audience for the field test with an undeformed block sample includes geotechnical engineers, civil engineers, geologists, geotechnical technicians, and professionals involved in projects that require a precise evaluation of the soil's mechanical and hydraulic properties. Geotechnical engineering companies, geotechnical consulting firms, government agencies, and research institutions can use the results of these tests.<br><br><span style="font-weight: 700;">TECHNIQUE:</span> The technique of the field test with an undeformed block sample involves the following stages:<br><span style="font-weight: 700;">1. SITE PREPARATION:</span> The test site is chosen based on relevant geotechnical criteria, considering the soil characteristics and the test objectives.<br><span style="font-weight: 700;">2. EQUIPMENT INSTALLATION:</span> A sampling device is used to create a hole in the soil, forming a block that preserves the soil's original structure. This equipment is specific for collecting undeformed samples.<br><span style="font-weight: 700;">3. SAMPLE COLLECTION:</span> The equipment creates a soil block that is carefully removed and preserved in its original form.<br><span style="font-weight: 700;">4. SAMPLE CONDITIONING:</span> The collected sample is conditioned to avoid disturbances during transportation to the laboratory.<br><span style="font-weight: 700;">5. DATA RECORDING:</span> All data obtained during the test are recorded, including the test depth, soil characteristics, site conditions, and other relevant aspects.<br><span style="font-weight: 700;">6. INTERPRETATION:</span> The undeformed samples collected in the field test with an undeformed block sample are sent to laboratory tests, where detailed analyses of the soil's mechanical and hydraulic properties are performed. The results of these tests allow understanding the soil's behavior under various loading conditions and support geotechnical projects.<br><br>In summary, the field test with an undeformed block sample is an essential technique in geotechnical engineering for collecting soil samples that preserve their original structure in cohesive and clayey soils. It is employed by various professionals and organizations involved in geotechnical projects, following established standards and procedures.</p>
      </div>
    </section>
