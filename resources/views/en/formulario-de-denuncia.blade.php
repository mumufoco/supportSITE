...
@section('lang', 'en')
@section('title', 'Formulario de Denúncia')
@section('body-class', 'u-body u-clearfix u-xl-mode')

@push('meta')
    <meta name="keywords" content="COMPLAINT FORM">
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Formulario-de-Denúncia.css') }}" media="screen">
        ...
        <div class="u-expanded-width u-form u-form-1">
          <form action="https://service.nicepagesrv.com/form/v4/form-process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-1">
              ...
              <input type="text" placeholder="ENTER YOUR FIRST NAME" id="first-name-3ecd" name="name-1" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-2">
              <label class="u-label">LAST NAME</label>
              <input type="text" placeholder="ENTER YOUR LAST NAME" id="last-name-3ecd" name="name-2" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-email u-form-group">
              <label class="u-label">EMAIL</label>
              <input type="email" placeholder="ENTER A VALID EMAIL ADDRESS" id="email-89e2" name="email" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-date u-form-group u-form-group-4">
              <label class="u-label">DATE OF COMPLAINT</label>
              <input type="text" placeholder="DD/MM/YYYY" id="date-5d4f" name="date" class="u-input u-input-rectangle" required="" data-date-format="dd/mm/yyyy">
            </div>
            <div class="u-form-group u-form-message">
              <label class="u-label">DESCRIBE YOUR MESSAGE</label>
              <textarea placeholder="ALL INFORMATION HERE IS CONFIDENTIAL." id="message-89e2" name="message" class="u-input u-input-rectangle" required=""></textarea>
            </div>
            <div class="u-form-agree u-form-group u-form-group-6">
              <label class="u-block-0151-27 u-field-label" style=""></label>
              <input type="checkbox" id="agree-4a2c" name="agree" class="u-agree-checkbox u-field-input" required="">
              <label class="u-agree-label u-field-label">I ACCEPT THE <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-block-control u-btn-1" href="#" style="background-image: none; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0" data-block="1478">TERMS OF SERVICE</a></label>
            </div>
            ...
            IT WAS NOT POSSIBLE TO SEND YOUR MESSAGE. PLEASE CORRECT THE ERRORS AND TRY AGAIN.
        </div>
