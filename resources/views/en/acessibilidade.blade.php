...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROJECT OF ACCESSIBILITY</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The preparation of accessibility projects is essential to create inclusive environments, which can be used by all people, regardless of their physical, sensory or cognitive abilities. These projects encompass the planning and design of spaces, buildings and infrastructures to ensure access, mobility and full participation of all. The need to prepare accessibility projects is evident for several reasons:<br><br><span style="font-weight: 700;">1. Human Rights:</span> Accessibility is a fundamental human right. The preparation of accessibility projects aims to eliminate barriers that prevent or limit the participation of people with disabilities in all areas of life.<br><span style="font-weight: 700;">2. Social Inclusion:</span> Accessibility projects promote the inclusion of people with disabilities in society, allowing them to have equal opportunities and interact with other people in various environments.<br><span style="font-weight: 700;">3. Access to Services:</span> The preparation of accessibility projects is necessary to ensure that all people can access public services, commerce, buildings and facilities.<br><span style="font-weight: 700;">4. Mobility:</span> Accessibility projects aim to facilitate the mobility of people with disabilities, providing ramps, elevators, handrails and other elements that allow movement.<br><span style="font-weight: 700;">5. Autonomy:</span> Accessibility allows people with disabilities to have greater autonomy, reducing the need for constant assistance to move or perform tasks.<br><span style="font-weight: 700;">6. Compliance with Laws and Regulations:</span> Many countries have laws and regulations that require the inclusion of accessibility resources in buildings and public spaces.<br><span style="font-weight: 700;">7. Aging Population:</span> Accessibility projects also benefit the elderly, whose physical and cognitive abilities may deteriorate with age.<br><span style="font-weight: 700;">8. Universal Design:</span> The preparation of accessibility projects incorporates principles of universal design, which seeks to create environments that can be used by all people, regardless of their characteristics.<br><span style="font-weight: 700;">9. Independence:</span> Accessibility allows people with disabilities to perform daily tasks with independence and dignity.<br><span style="font-weight: 700;">10. Awareness and Sensitization:</span> The inclusion of accessibility resources in projects helps to sensitize people about the importance of diversity and equality.<br><span style="font-weight: 700;">11. Accessible Tourism:</span> Accessibility projects are crucial to promote accessible tourism, allowing people with disabilities to enjoy tourist destinations.<br><span style="font-weight: 700;">12. Security:</span> Accessibility also includes security measures, such as accessible emergency exits and evacuation routes for people with reduced mobility.<br><br>In summary, the preparation of accessibility projects is necessary to create environments that are accessible, inclusive and equitable for all people. These projects ensure that people with disabilities can fully participate in society, promoting dignity, independence and equal opportunities.</p>
      </div>
    </section>
