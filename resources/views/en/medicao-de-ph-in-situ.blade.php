...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">IN-SITU PH MEASUREMENT</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NEED:</span> The pH of the soil and groundwater is a fundamental chemical parameter for understanding corrosion processes, aggressiveness to concrete, electrochemical behavior of grounding systems, mobility of contaminants and stability of buried materials.<br>Measurements made only in the laboratory may undergo changes due to transport, oxidation and temperature changes. For this reason, in-situ pH measurement becomes essential to guarantee real representativeness of environmental conditions at the time of investigation.<br>In infrastructure works, transmission lines, foundations and environmental studies, ignoring the pH of the environment is equivalent to designing materials and solutions without knowing the degree of chemical aggressiveness of the environment.<br><br><span style="font-weight: 700;">OBJECTIVE:</span> The activity aims to determine the hydrogen potential (pH) directly at the point of interest, in soil, surface water or groundwater, obtaining reliable and representative values of the natural conditions of the environment.<br>The results subsidize technical decisions related to the durability of structures, anti-corrosive protection, choice of materials, environmental evaluation and classification of soil aggressiveness.<br><br><span style="font-weight: 700;">REGULATING AND GUIDING STANDARDS:</span> In-situ pH measurements follow nationally and internationally recognized technical standards and guidelines, ensuring standardization and traceability:<br>NBR 6457 - Preparation of soil samples for characterization tests (complementary reference)<br>NBR 9898 - Preservation and sampling techniques for water<br>NBR 15472 - Water quality - Determination of pH<br>ABNT NBR ISO 10523 - Water quality - Determination of pH<br>Standard Methods for the Examination of Water and Wastewater - APHA<br>ASTM D4972 - Standard Test Method for pH of Soils<br>These standards guide the calibration of equipment, reading methods and quality control criteria.<br><br><span style="font-weight: 700;">TARGET AUDIENCE:</span> The activity is indicated for: Civil, geotechnical and environmental engineers; Infrastructure and linear works companies; Designers of grounding and anti-corrosive protection systems; Geotechnical and drilling companies; Environmental and licensing consulting firms; Industries with buried or soil-contacting structures.<br><br><span style="font-weight: 700;">TECHNICAL DESCRIPTION OF THE ACTIVITY:</span> The in-situ pH measurement is performed using a portable pH meter equipped with a combined glass electrode, suitable for field use. Before starting the measurements, the equipment is calibrated with standard buffer solutions (usually pH 4.0; 7.0 and 10.0). The procedures vary according to the analyzed medium:<br><br><span style="font-weight: 700;">SOIL:</span> the electrode is inserted directly into moist soil or into a soil-water paste prepared on site, according to normative guidelines.<br><span style="font-weight: 700;">SURFACE WATER OR GROUNDWATER:</span> the reading is taken directly in the water body or in a clean container, immediately after collection, avoiding chemical changes.<br><br>During the test, factors such as temperature, stabilization time of the reading and electrode cleaning between measurements are controlled. The obtained pH value indicates the degree of acidity, neutrality or alkalinity of the medium, being an essential data for corrosion, soil-structure interaction and environmental impact analyses.<br><br><span style="font-weight: 700;">TECHNICAL DIFFERENCE:</span> <br><span style="font-weight: 700;">IN-SITU PH MEASUREMENT X LABORATORY MEASUREMENT:</span> Although complementary, the two approaches have distinct purposes:<br><br><span style="font-weight: 700;">IN-SITU PH MEASUREMENT:</span> Performed directly at the investigation site. Reflects the real conditions of the environment at the time of measurement. Avoids chemical changes caused by transport and storage. Indicated for rapid diagnostics, field decisions and immediate aggressiveness studies. It is the "chemical photograph" of the environment.<br><span style="font-weight: 700;">LABORATORY PH MEASUREMENT:</span> Performed on transported and prepared samples. Allows greater control of variables and repeatability. May present deviations in relation to the natural conditions of the field. Indicated for comparative studies and complementary analyses. It is the "clinical analysis", precise, but distant from the original environment.<br><br><span style="font-weight: 700;">SUMMARY OF THE ACTIVITY:</span> The in-situ pH measurement is an essential activity for characterizing the chemical behavior of soil and water in engineering projects and environmental studies. Performed with a properly calibrated portable pH meter, it provides reliable data on the aggressiveness of the environment, assisting in the choice of materials, protection of structures and compliance with regulatory requirements.<br>It is a simple test in execution, but decisive for ensuring durability, safety and sustainability of the adopted solutions.​</p>
      </div>
    </section>
