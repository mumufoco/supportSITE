...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">TRIAXIAL TESTS - TRI</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The triaxial tests are a set of laboratory tests used in geotechnics to evaluate the mechanical properties and resistance of soils under different tension and deformation conditions. These tests are crucial to understand the behavior of soils under complex loads and provide valuable information for geotechnical engineering projects. There are different types of triaxial tests, including the unconsolidated-undrained triaxial test (UU), the consolidated-drained triaxial test (CD), and the unconsolidated-drained triaxial test (CU), each with its own characteristics and applications.<br><br>Here is a general description of the triaxial tests:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To evaluate the mechanical properties, resistance, and deformation of soils under different tension and deformation conditions.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. Triaxial testing machine;<br>2. Triaxial cell (confinement cylinder and drainage chamber);<br>3. Soil sample;<br>4. Deformation measurement instruments (extensometers);<br>5. Precision balances;<br>6. Sample saturation devices;</span><br><br><span style="font-weight: 700;">Procedure:<br>1. Sample Preparation:</span>&nbsp;A representative soil sample is collected and prepared according to the appropriate dimensions for the triaxial testing machine.<br><span style="font-weight: 700;">2. Sample Assembly:</span>&nbsp;The sample is placed in the triaxial cell and saturated, ensuring that water is removed from the system. In some cases, a confining pressure may be applied to simulate vertical tension conditions.<br><span style="font-weight: 700;">3. Application of Stresses:</span>&nbsp;The confining and shear stresses are applied to the sample using the triaxial testing machine. In the UU test, the sample is rapidly loaded to failure, maintaining the same level of confining pressure throughout the test. In the CD test, the sample is consolidated under confining pressure and then loaded to failure. In the CU test, the sample is rapidly loaded, allowing water to drain.<br><span style="font-weight: 700;">4. Data Recording:</span>&nbsp;During the test, loads, deformations, and pore pressures are recorded for different stress levels.<br><span style="font-weight: 700;">5. Results Analysis:</span>&nbsp;From the collected data, it is possible to determine mechanical properties such as shear strength, cohesion, internal friction angle, and deformation modulus.<br><span style="font-weight: 700;">6. Interpretation:</span>&nbsp;The results of the triaxial tests are often presented in graphs known as Mohr-Coulomb diagrams, which show the relationship between normal stresses and shear stresses for different stress states.<br><br><span style="font-weight: 700;">Utility:</span>&nbsp;Triaxial tests are used to understand the behavior of soils under complex tension conditions, such as those that occur in foundations, dams, slopes, and other geotechnical projects. They are essential for evaluating the stability and load capacity of structures on soils.<br>In summary, triaxial tests are a crucial tool in geotechnics, allowing the evaluation of the mechanical properties and resistance of soils under different tension and deformation conditions. This helps in understanding the behavior of soils in geotechnical engineering projects and in making informed decisions during the design and construction of structures.</p>
      </div>
    </section>
