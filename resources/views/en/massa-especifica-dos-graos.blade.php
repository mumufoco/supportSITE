...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SPECIFIC MASS OF GRAINS - MESP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory test of specific mass of grains, also known as apparent specific mass test of grains, is a procedure used to determine the density of the grains of a soil or aggregate. This test is important in geotechnics and civil engineering to evaluate the physical characteristics of materials and understand their compaction capacity and behavior in construction works.<br><br>Here is a general description of the specific mass of grains test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the density of the grains of a soil or aggregate, which helps to understand its physical characteristics and compaction capacity.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. Picnometer flask or volumetric balloon;<br>2. Precision balance;<br>3. Distilled water;<br>4. Oven;<br>5. Sieve with known opening (for aggregates);</span><br><br><span style="font-weight: 700;">Procedure:</span><br><span style="font-weight: 700;">1. Sample Preparation:</span>&nbsp;A representative sample of the soil or aggregate is collected and dried in the air to eliminate excess moisture. The sample is then crushed and passed through a 4.75 mm opening sieve (for soils) to remove larger particles.<br><span style="font-weight: 700;">2. Sample Drying:</span>&nbsp;The sample is placed in an oven at a specific temperature (usually around 105°C) until it reaches a constant weight, eliminating any remaining moisture.<br><span style="font-weight: 700;">3. Sieving (only for aggregates):</span>&nbsp;If the test is performed on aggregates, the sample is sieved through a sieve with a known opening to remove fine particles that do not correspond to the grains.<br><span style="font-weight: 700;">4. Filling the Picnometer:</span>&nbsp;The picnometer flask or volumetric balloon is cleaned and dried. It is then weighed (weight "A"). Then, it is filled with distilled water up to a certain volume (known as the filling volume), and the flask is weighed again (weight "B").<br><span style="font-weight: 700;">5. Filling the Picnometer with Grains:</span>&nbsp;A known quantity of dry soil is added to the picnometer flask, taking care to avoid air bubbles. The flask is weighed again (weight "C").<br><span style="font-weight: 700;">6. Calculations:</span> Dry soil mass = Weight "C" - Weight "A"&nbsp;Displaced water mass = Weight "B" - Weight "A";&nbsp;Specific mass of grains (Gama) = Dry soil mass / Displaced water mass<br><span style="font-weight: 700;">7. Interpretation:</span>&nbsp;The result of the test is the specific mass of the grains of the soil or aggregate. This value represents the density of the grains and is a measure of the physical characteristics of the material.<br><br><span style="font-weight: 700;">Usefulness:</span>&nbsp;The specific mass of grains is used to calculate the porosity, relative density, and other parameters that help to understand the compaction capacity, stability, and behavior of materials in construction works.<br>In summary, the laboratory test of specific mass of grains is fundamental to evaluate the density of the grains of soils and aggregates, providing important information about their physical characteristics and behavior in geotechnical and construction engineering works.</p>
      </div>
    </section>
