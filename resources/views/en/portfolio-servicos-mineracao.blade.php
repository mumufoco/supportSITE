          ...
          <div class="u-layout-row">
            <div class="skrollable u-align-center u-container-align-center u-container-style u-layout-cell u-parallax u-shape-rectangle u-size-30 u-layout-cell-1" data-image-width="2000" data-image-height="1333">
              <div class="u-container-layout u-container-layout-1">
                ...
                <h4 class="u-text u-text-2">SOIL ENGINEERING, ANALYSIS, PROJECT ELABORATION AND SOIL LABORATORY</h4>
          ...
          <div class="u-layout-row" style="">
            ...
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <p class="u-text u-text-1"><span style="font-weight: 700;">Regulatory Standards (NRs):</span><br>The Regulatory Standards (NRs) are a set of rules established by the Ministry of Labor and Employment (MTE) with the objective of establishing minimum safety and health requirements at work. They are applicable to all employers and workers in the CLT (Consolidation of Labor Laws) regime and aim to ensure safe and healthy work environments.<br><span style="font-weight: 700;">NR-12: Safety at Work in Machines and Equipment:</span><br>Nr-12 is one of the most important standards when it comes to work safety, as it specifically deals with safety in machines and equipment used in various industry sectors.<br><span style="font-weight: 700;">How Support Solo Drilling Complies with NR-12:</span><br>Support Solo Drilling, when operating with drilling equipment, is subject to NR-12 due to the use of machines and equipment. The company adopts various practices to ensure compliance with this standard:<br><span style="font-weight: 700;">Hydraulic Technology and Technological Innovations:</span><br>The company uses hydraulic technology in its drilling equipment, which provides precise and safe control during operations.<br>The constant technological updating of equipment ensures that they are in compliance with the requirements of NR-12, including safety systems and emergency shutdown devices.<br><span style="font-weight: 700;">Training and Qualification:</span><br>All operators and technicians receive specific training on the safe operation of equipment, including instructions on the risks associated with handling.<br><span style="font-weight: 700;">Preventive Maintenance:</span><br>Support Solo Drilling implements preventive maintenance programs to ensure the proper functioning of equipment, avoiding failures that can put worker safety at risk.<br>Protection and Safety Devices:<br>All equipment is equipped with protection and safety devices, such as guards, sensors, and emergency shutdown systems, as stipulated by NR-12.<br><span style="font-weight: 700;">Risk Assessment:</span><br>Before starting any operation, the company conducts a risk assessment to identify and mitigate possible hazards associated with the use of equipment.<br><span style="font-weight: 700;">Documentation and Records:</span><br>Support Solo Drilling maintains detailed records of inspections, maintenance, and training performed, demonstrating its commitment to compliance.<br>By adopting these practices, Support Solo Drilling demonstrates a solid commitment to worker safety and compliance with regulatory standards, especially NR-12. The integration of hydraulic technology and the continuous search for technological innovations ensure that the company operates efficiently and safely in its geotechnical and geological drilling activities.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="u-layout" style="">
          <div class="u-layout-row" style="">
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                <p class="u-text u-text-1"><span style="font-weight: 700;">Logistics as Part of the Business:</span><br>Support Solo Drilling has a robust and efficient logistics structure to serve mining companies. Logistics is a crucial part of its operations, ensuring that services are provided effectively and within established deadlines. Below is a description of Support Solo Drilling's logistics structure to serve mining companies:<br><span style="font-weight: 700;">Specialized Vehicle Fleet:</span><br>The company maintains a fleet of specialized vehicles, including trucks equipped with the necessary resources to transport drilling equipment and the entire technical team to mine operation sites. These vehicles are adapted to ensure the safety of equipment during transport.<br><span style="font-weight: 700;">Route Planning and Scheduling:</span><br>Support Solo Drilling has a dedicated department for planning and scheduling operations. This sector evaluates road conditions, distance to the operation site, and other logistical factors to determine the best route and estimated arrival time.<br><span style="font-weight: 700;">Logistics and Coordination Team:</span><br>The logistics team is responsible for coordinating all details related to transportation. This includes scheduling, real-time monitoring of vehicles, communication with drivers, and resolving any problems that may arise during the trip.<br><span style="font-weight: 700;">Preventive Maintenance:</span><br>The vehicle fleet is subject to a regular preventive maintenance program to ensure that all vehicles are in perfect working condition. This minimizes the risk of mechanical failures during transportation.<br><span style="font-weight: 700;">Driver Training:</span><br>Drivers undergo specific training to handle drilling equipment and ensure the safety of both equipment and vehicle occupants. They are instructed on defensive driving practices and cargo transportation safety.<br><span style="font-weight: 700;">Compliance with Transportation Regulations:</span><br>Support Solo Drilling ensures that all its vehicles and operations are in full compliance with transportation regulations, including cargo safety standards, driving times, and rest periods, and other legal requirements.<br><span style="font-weight: 700;">Real-Time Monitoring:</span><br>The company uses real-time tracking systems to monitor the location and status of vehicles throughout the journey. This allows for rapid response to any emergencies and optimizes routing.<br>This well-organized and efficient logistics structure enables Support Solo Drilling to serve mining companies reliably, ensuring the delivery of its high-quality geotechnical services in a timely and safe manner.</p>
              </div>
            </div>
      ...
      <div class="data-layout-selected u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
        <div class="u-layout">
          <div class="u-layout-row">
            ...
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <p class="u-text u-text-1"><span style="font-weight: 700;">Mobile and Versatile Drilling Site:</span><br>The drilling site with a container developed by Support Solo Drilling is an innovative and highly functional solution for the execution of geotechnical and geological drilling work. It combines the mobility of a container with the specialized equipment necessary for conducting drilling operations with precision and safety.<br><br><span style="font-weight: 700;">Characteristics of the Container Drilling Site:</span><br><br><span style="font-weight: 700;">Mobility and Adaptability:</span><br>The drilling site is built inside a modified container, which means it can be easily transported to different work sites, adapting to a variety of geographical and environmental conditions.<br><span style="font-weight: 700;">Controlled and Safe Environment:</span> The container is equipped with temperature control systems, ventilation, and lighting, providing a comfortable and safe working environment for drilling technicians.<br><span style="font-weight: 700;">Integrated Specialized Equipment:</span> Within the container, all necessary equipment for drilling operations is installed, including probes, rods, drilling equipment, and other geotechnical instruments.<br><span style="font-weight: 700;">Weather Protection:</span> The container structure offers protection against adverse weather conditions, ensuring that drilling operations can continue uninterrupted, regardless of the weather.<br><span style="font-weight: 700;">Waste Management and Sampling:</span> The drilling site includes an effective system for managing waste generated during operations, as well as facilities for collecting and storing soil and rock samples.<br><span style="font-weight: 700;">Power and Supply System:</span> The container is equipped with power systems, ensuring the supply of all necessary equipment for drilling operations. Additionally, it can include water supply systems and other essential resources.<br><span style="font-weight: 700;">Sample Quality Maintenance:</span> The controlled environment minimizes the interference of external factors, ensuring the integrity and quality of soil and rock samples collected during drilling operations.<br><span style="font-weight: 700;">Safety and Compliance:</span> The drilling site is designed and built in compliance with safety regulations and industry standards, ensuring the safety of technicians and compliance with work norms.<br><br>This innovative drilling site represents a significant advancement in geotechnical and geological drilling operations. By combining the mobility of a container with the specialized equipment necessary for drilling, Support Solo Drilling is positioned to offer high-quality services in a variety of environments and conditions. Additionally, the integration of environmental control and safety systems ensures that operations are conducted efficiently and safely.</p>
              </div>
            </div>
          </div>
        </div>
