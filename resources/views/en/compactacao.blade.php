...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">COMPACTION TEST - COMP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The laboratory compaction test is a fundamental procedure in geotechnical engineering and civil engineering to evaluate the compaction characteristics of soils, especially those that will be used in engineering works, such as road bases, fills, and foundations. The compaction test aims to determine the relationship between the moisture content of a soil and its density after being subjected to a controlled compaction process.<br><br>Here is a general description of the compaction test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To evaluate the compaction characteristics of a soil and determine the relationship between the moisture content and the dry density of a compacted soil.<br><br><span style="font-weight: 700;">Equipment and Materials:</span><br><span style="font-weight: 700;">1. Compaction molds (cylindrical or cubic);<br>2. Sample compactor (hammer or press);<br>3. Soil sample;<br>4. Precision balance;<br>5. Oven;<br>6. Chronometer;</span><br><br><span style="font-weight: 700;">Procedure:<br>1. Sample Preparation:</span>&nbsp;A representative sample of the soil is collected and air-dried to eliminate excess moisture. The sample is then crushed and passed through a 4.75 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Determination of Initial Moisture Content:</span>&nbsp;A portion of the sample is weighed and placed in an oven at a specific temperature (usually around 110°C) until it reaches a constant weight, thus determining the initial moisture content.<br><span style="font-weight: 700;">3. Sample Preparation:</span>&nbsp;Different portions of the sample are mixed with different moisture contents (usually 2 to 4% above and below the optimal moisture content) to create moist samples.<br><span style="font-weight: 700;">4. Compaction of Samples:</span>&nbsp;The moist samples are placed in the compaction molds, in uniform layers, and compacted using a sample compactor, which can be a hammer with a weight or a mechanical press. Each layer is compacted with a specific number of blows.<br><span style="font-weight: 700;">5. Demolding and Weighing:</span>&nbsp;The compacted samples are demolded and weighed.<br><span style="font-weight: 700;">6. Determination of Final Moisture Content:</span>&nbsp;A portion of the compacted sample is weighed and placed in an oven to determine its final moisture content.<br><span style="font-weight: 700;">7. Calculations:</span>&nbsp;Based on the masses and moisture contents, it is possible to calculate the dry density of the compacted samples.<br><span style="font-weight: 700;">8. Interpretation:</span>&nbsp;The results of the test are usually presented in a graph called the Compaction Curve, which shows the relationship between the moisture content and the dry density of the compacted soil. From this curve, it is possible to identify the optimal moisture content to achieve the maximum dry density.<br><br><span style="font-weight: 700;">Usefulness:</span>&nbsp;The compaction test is fundamental for optimizing the moisture content in soils for construction purposes. It helps to determine the maximum density that a soil can achieve under certain compaction conditions, assisting in the choice of the ideal moisture content for the construction of geotechnical structures.<br>In summary, the laboratory compaction test is a crucial tool for evaluating the compaction characteristics of soils, providing essential information for geotechnical engineering and construction projects.​</p>
      </div>
    </section>
