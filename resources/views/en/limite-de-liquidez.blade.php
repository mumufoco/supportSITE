...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">LIQUID LIMIT - LL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">The laboratory test of liquid limit is a procedure used to determine the moisture at which a clayey soil passes from the liquid state to the plastic state. This test is fundamental in geotechnical and civil engineering to evaluate the plasticity characteristics of soils and classify them according to their consistency. The liquid limit is one of the parameters used in the classification of soils according to their plasticity.<br><br>Here is a general description of the liquid limit test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the moisture content at which a clayey soil passes from the liquid state to the plastic state, defining the limit between these two states of behavior.<br><br><span style="font-weight: 700;">Equipment and Materials:</span><br><span style="font-weight: 700;">1. Casagrande cups;</span><br><span style="font-weight: 700;">2. Soil sample;</span><br><span style="font-weight: 700;">3. Spatula;</span><br><span style="font-weight: 700;">4. Precision balance;</span><br><span style="font-weight: 700;">5. Oven;</span><br><br><span style="font-weight: 700;">Procedure:</span><br><span style="font-weight: 700;">1. Sample Preparation:</span>&nbsp;A representative soil sample is collected and dried in the air to eliminate excess moisture. Then, the sample is crushed and passed through a 0.425 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Preparation of the Cups:</span>&nbsp;The Casagrande cups, which have a standardized opening, are cleaned and dried, and their mass is measured.<br><span style="font-weight: 700;">3. Sample Molding:</span>&nbsp;The soil sample is mixed with water until it reaches a paste-like consistency. The sample is then placed in one of the Casagrande cups.<br><span style="font-weight: 700;">4. Determination of the Liquid Limit:</span>&nbsp;The sample is molded into a groove shape inside the cup, and the device is adjusted to allow the groove to close at a specified distance (usually 10 mm). The groove closure process is carried out through a series of blows on a standardized base.<br><span style="font-weight: 700;">5. Drying in the Oven:</span>&nbsp;The cup with the molded sample is placed in an oven at a specific temperature (usually 105°C to 110°C) until it reaches a constant weight.<br><span style="font-weight: 700;">6. Calculations:</span>&nbsp;Based on the initial mass of the sample and the mass after drying, the initial moisture and the moisture after drying are determined. The liquid limit is calculated using a specific formula, relating the moisture to the number of blows required to close the groove.<br><span style="font-weight: 700;">7. Interpretation:</span>&nbsp;The result of the test is expressed in terms of moisture (percentage of water) at which the soil passes from the liquid state to the plastic state. This value is known as the “liquid limit”.<br><br>The liquid limit test is often performed together with the plastic limit test to determine the plasticity of a soil and classify it according to the Unified Soil Classification System (USCS). In summary, the laboratory test of liquid limit is essential to understand the plasticity characteristics of clayey soils and assist in the classification of soils and the design of geotechnical engineering works.​</p>
      </div>
    </section>
