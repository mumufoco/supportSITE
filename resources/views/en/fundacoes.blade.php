...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">FOUNDATION PROJECTS</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">The preparation of foundation projects, whether superficial or deep, is fundamental to ensure the stability, safety, and durability of the constructed structures. The foundations are responsible for transmitting the building loads to the soil in an efficient and safe manner, taking into account the soil characteristics, applied loads, and other relevant factors. The need to prepare foundation projects, whether superficial or deep, is evidenced by several reasons:<br><br><span style="font-weight: 700;">Superficial Foundations:</span><br><br><span style="font-weight: 700;">1. Load Distribution:</span> Superficial foundations, such as slabs and blocks, distribute the structure loads over a larger area of the soil. The project preparation considers the load, size, and shape of the foundation to avoid overloading the soil.<br><span style="font-weight: 700;">2. Soil Characteristics:</span> The project must take into account the soil's load-bearing capacity, cohesion, density, and other properties. Geotechnical analysis is crucial to determine the most suitable foundation for the site conditions.<br><span style="font-weight: 700;">3. Stability and Settlement:</span> A well-prepared project considers the possibility of differential settlement of the soil and the overall stability of the foundation, ensuring that the structure remains level and stable.<br><span style="font-weight: 700;">4. Protection against Erosion and Infiltration:</span> Superficial foundations can also include measures to protect against erosion caused by water and infiltration, preventing the soil beneath the foundation from deteriorating.<br><br><span style="font-weight: 700;">Deep Foundations:</span>&nbsp;<br><br><span style="font-weight: 700;">1. Heavy Load Support:</span> Deep foundations, such as piles and tubular foundations, are used when the applied loads are significantly high or when the superficial soil characteristics are inadequate to support the structure.<br><span style="font-weight: 700;">2. Depth and Load-Bearing Capacity:</span> The preparation of deep foundation projects considers the adequate depth to reach a soil stratum with sufficient load-bearing capacity.<br><span style="font-weight: 700;">3. Vertical and Lateral Load Distribution:</span> The project must consider both the vertical and lateral load-bearing capacity of the deep foundations to ensure that the structure is adequately supported in both directions.<br><span style="font-weight: 700;">4. Compatibility with Subterranean Conditions:</span> In areas where high water tables or hard rocks may exist, deep foundations need to be designed to handle these challenging conditions.<br><span style="font-weight: 700;">5. Lateral Stability:</span> In locations subject to lateral loads, such as wind or seismic forces, the deep foundation project considers the lateral stability of the structure.<br><br><span style="font-weight: 700;">General Need:</span>&nbsp;<br><br><span style="font-weight: 700;">1. Structural Safety:</span> The primary need for foundation projects is to ensure the safety and stability of the constructed structure. Inadequate foundations can result in cracks, displacements, or even collapses.<br><span style="font-weight: 700;">2. Compliance with Standards:</span> Foundation projects must follow engineering standards and local regulations that ensure structures are built safely and durably.<br><span style="font-weight: 700;">3. Site-Specific Conditions:</span> Each construction site presents unique challenges in terms of soil, topography, climate, and other factors. Foundation projects consider these conditions to provide adapted solutions.<br><span style="font-weight: 700;">4. Structure Longevity:</span> Well-designed foundations contribute to the structure's longevity, avoiding future problems that may arise due to settlement or instability issues.<br><span style="font-weight: 700;">5. Cost Efficiency:</span> The preparation of foundation projects helps avoid material and resource waste, ensuring that the foundation is dimensioned adequately for the applied loads.<br><br>In summary, the preparation of foundation projects, whether superficial or deep, is necessary to ensure that structures are built safely, stably, and durably, considering soil characteristics, applied loads, and site-specific conditions. This helps prevent risks, structural problems, and unnecessary long-term costs.​</p>
      </div>
    </section>
