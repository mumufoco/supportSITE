...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ENVIRONMENTAL MANAGEMENT POLICY</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">INTRODUCTION:</span><br>The Environmental Management System (EMS) of Support Solo Drilling is a structured approach that aims to integrate environmentally responsible practices into all company operations. Given the focus on geological studies, the EMS is specifically designed to minimize the environmental impacts associated with drilling activities and maximize the positive contribution to sustainability.<br><br><span style="font-weight: 700;">EMS OBJECTIVES:</span><br><span style="font-weight: 700;">1. IMPACT MINIMIZATION:</span>&nbsp;Reduce the environmental impact of geological drilling operations, minimizing soil disturbance, waste generation, and natural resource consumption.<br><span style="font-weight: 700;">2. LEGAL COMPLIANCE:</span>&nbsp;Strictly comply with all relevant environmental regulations and standards, ensuring that company activities are in accordance with applicable laws.<br><span style="font-weight: 700;">3. ECOSYSTEM PRESERVATION:</span>&nbsp;Protect local ecosystems and biodiversity by identifying and mitigating potential negative impacts.<br><span style="font-weight: 700;">4. RESOURCE EFFICIENCY:</span>&nbsp;Use resources, such as water and energy, efficiently, adopting conservation practices and reducing waste.<br><span style="font-weight: 700;">5. EDUCATION AND AWARENESS:</span>&nbsp;Promote environmental awareness among employees, suppliers, and partners, encouraging the adoption of sustainable practices.<br><br><span style="font-weight: 700;">EMS COMPONENTS:</span><br><span style="font-weight: 700;">1. ENVIRONMENTAL IMPACT ASSESSMENT:</span>&nbsp;Before starting any drilling project, Support Solo Drilling conducts environmental impact assessments to identify potential risks and develop mitigation strategies.<br><span style="font-weight: 700;">2. WASTE MANAGEMENT PLAN:</span>&nbsp;Establish protocols for the proper management of waste generated during operations, promoting recycling, reuse, and proper disposal.<br><span style="font-weight: 700;">3. ENERGY EFFICIENCY:</span>&nbsp;Implement measures to reduce energy consumption, such as using efficient equipment and conservation practices.<br><span style="font-weight: 700;">4. WATER CONSERVATION:</span>&nbsp;Adopt responsible water use practices and implement measures to minimize consumption in drilling processes.<br><span style="font-weight: 700;">5. BIODIVERSITY PROTECTION:</span>&nbsp;Identify sensitive areas and implement measures to avoid disturbing natural habitats and ecosystems.<br><span style="font-weight: 700;">6. TRAINING AND AWARENESS:</span>&nbsp;Conduct regular training sessions to raise employees' awareness of proper environmental practices and the importance of sustainability.<br><span style="font-weight: 700;">7. ENVIRONMENTAL MONITORING:</span>&nbsp;Establish monitoring systems to continuously evaluate the company's environmental performance and identify areas for improvement.<br><span style="font-weight: 700;">8. CONTINUOUS IMPROVEMENT:</span>&nbsp;Periodically review the EMS's performance, identify opportunities for improvement, and implement corrective and preventive actions.<br><br><span style="font-weight: 700;">MANAGEMENT COMMITMENT:</span><br>The senior management of Support Solo Drilling is committed to promoting the implementation, maintenance, and continuous improvement of the EMS. The leadership demonstrates its commitment to sustainability by providing the necessary resources and encouraging the adoption of environmentally responsible practices.<br><br>By implementing an Environmental Management System, Support Solo Drilling demonstrates its commitment to protecting the environment while continuing to offer high-quality geological services. The EMS ensures that the company's operations are aligned with sustainability principles and contribute positively to the health of the ecosystem and the community.</p>
      </div>
    </section>
