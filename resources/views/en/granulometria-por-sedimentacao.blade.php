...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">GRANULOMETRY BY SEDIMENTATION - SED</h2>
        <p class="u-align-justify u-text u-text-2">The laboratory test of granulometry by sedimentation is a procedure used to determine the distribution of the different granulometric fractions present in a soil or aggregate sample, based on the sedimentation velocity of the particles in a liquid. This test is crucial in geotechnics and civil engineering to evaluate the granulometric composition of materials used in construction, such as sand, gravel, and soils. The granulometric distribution influences the properties and behavior of the materials in engineering works.<br><br>Here is a general description of the granulometry by sedimentation test:<br><br><span style="font-weight: 700;">Objective:</span>&nbsp;To determine the distribution of the different granulometric fractions present in a soil or aggregate sample based on the sedimentation velocity of the particles in a liquid.<br><br><span style="font-weight: 700;">Equipment and Materials:<br>1. Sedimentation cylinder (pipette or Imhoff cylinder);<br>2. Soil sample;<br>3. Distilled water;<br>4. Precision balance;<br>5. Chronometer;<br>6. Dispersion tube (chemical dispersant);<br>7. Magnetic stirrer (optional);</span><br><br><span style="font-weight: 700;">Procedure:</span><br><span style="font-weight: 700;">1. Sample Preparation:</span>&nbsp;A representative sample of the soil or aggregate is collected and dried in the air to eliminate excess moisture. The sample is then crushed and passed through a 4.75 mm opening sieve to remove larger particles.<br><span style="font-weight: 700;">2. Suspension Preparation:</span>&nbsp;The sample is placed in distilled water and a dispersion tube is used to agitate and disperse the particles. The dispersion tube helps to avoid particle agglomeration and air bubble formation.<br><span style="font-weight: 700;">3. Filling the Cylinder:</span>&nbsp;The sedimentation cylinder is filled with the resulting suspension of the sample and distilled water. The suspension is well mixed to ensure a uniform distribution of the particles.<br><span style="font-weight: 700;">4. Start of Sedimentation:</span>&nbsp;The chronometer is started at the moment the suspension is placed in the sedimentation cylinder. Sedimentation occurs over time, with larger particles sedimenting more rapidly than smaller ones.<br><span style="font-weight: 700;">5. Measuring Sedimentation Heights:</span>&nbsp;After specific times (usually every 30 minutes or 1 hour), the height of the interface between the sedimented particles and the liquid is measured in the cylinder.<br><span style="font-weight: 700;">6. Calculations:</span>&nbsp;Based on the sedimentation heights measured over time, a sedimentation curve is constructed. From this curve, it is possible to determine the accumulated percentage of particles that sedimented in specific time intervals.<br><span style="font-weight: 700;">7. Interpretation:</span>&nbsp;The resulting sedimentation curve from the granulometry by sedimentation test shows the accumulated distribution of the different granulometric fractions as a function of time. This helps to identify the sedimentation rate of the particles in relation to their size.<br><br>Utility:&nbsp;Granulometric analysis by sedimentation is an alternative to the granulometry by sieving test and is used when the particles are too fine to be effectively sieved. This test provides important information about the granulometric distribution of soils and aggregates.<br>In summary, the laboratory test of granulometry by sedimentation is an essential tool for evaluating the granulometric composition of soils and aggregates with fine particles, providing crucial information for geotechnical engineering and construction projects.</p>
      </div>
    </section>
