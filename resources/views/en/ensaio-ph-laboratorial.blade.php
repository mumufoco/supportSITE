...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">LABORATORY pH TEST</h2>
        <p class="u-align-justify u-text u-text-2"><span style="font-weight: 700;">OBJECTIVE:</span> The soil pH test has the purpose of determining the level of acidity or alkalinity present in the soil, which is crucial to understand the chemical characteristics and the viability of certain construction activities.<br>PROCEDURE:<br>SAMPLE COLLECTION:<br>A representative sample of the soil is collected at the drilling site, considering the adequate depth and location.<br><br><span style="font-weight: 700;">1. SAMPLE PREPARATION:</span> The sample is prepared for the test, removing impurities and foreign materials that may interfere with the results.<br><br><span style="font-weight: 700;">2. pH MEASUREMENT:</span> Using a calibrated pH meter, the soil sample is mixed with distilled water in specific proportions to obtain a homogeneous suspension. The electrode of the meter is then inserted into the suspension and the pH is recorded.<br><br><span style="font-weight: 700;">3. RESULTS RECORDING</span>: The obtained pH value is recorded and associated with the depth and location of the sample.<br><br><span style="font-weight: 700;">4. RESULTS INTERPRETATION:</span> pH &lt; 7 indicates acidic soil; pH = 7 indicates neutral soil; pH &gt; 7 indicates alkaline soil;<br>REPORT OF pH TEST:<br><br><span style="font-weight: 700;">OBSERVATION:</span> Make sure to follow the standards and good practices of geotechnical tests when performing this procedure. The results must be interpreted by a qualified professional.</p>
      </div>
    </section>
