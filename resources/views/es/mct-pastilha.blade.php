...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/MCT-Pastilha.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">CLASIFICACIÓN MCT – PASTILLAS - MCT.P</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial de clasificación MCT (Miniatura de Compactación Triplo) con pastillas es un procedimiento utilizado para clasificar suelos finos, especialmente arcillas, de acuerdo con la norma brasileña NBR 7182. Este ensayo evalúa la capacidad del suelo de ser compactado en diferentes estados de humedad y proporciona información sobre su consistencia y plasticidad.<br><br>Aquí está una descripción general del ensayo de clasificación MCT con pastillas:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Clasificar suelos finos, especialmente arcillas, con base en la capacidad de compactación en diferentes estados de humedad.<br><br><span style="font-weight: 700;">Equipos y Materiales:<br>1.Dispositivo de compactación MCT;<br>2. Moldes para pastillas (cilíndricos);<br>3. Base de compactación;<br>4. Muestra de suelo;<br>5. Balanza de precisión;<br>6. Estufa;<br>7. Cronómetro;</span><br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo es colectada y seca al aire para eliminar el exceso de humedad. La muestra es entonces triturada y pasada por la peneira de abertura 4,75 mm para remover partículas mayores.<br><span style="font-weight: 700;">2. Determinación del Teor de Humedad Inicial:</span>&nbsp;Una porción de la muestra es pesada y colocada en una estufa a una temperatura específica (generalmente alrededor de 110°C) hasta alcanzar peso constante, determinando así el teor de humedad inicial.<br><span style="font-weight: 700;">3. Compactación de las Pastillas:</span>&nbsp;La muestra es mezclada con agua destilada para alcanzar diferentes teores de humedad (generalmente 4, 6, 8, 10 y 12%) en relación con el peso seco. La muestra húmeda es entonces colocada en los moldes cilíndricos y compactada utilizando el dispositivo MCT, aplicando un número fijo de golpes de compactación.<br><span style="font-weight: 700;">4. Determinación de la Masa y del Teor de Humedad Final:</span>&nbsp;Las pastillas compactadas son retiradas de los moldes y pesadas. La diferencia de peso antes y después de la compactación proporciona la masa del agua desplazada por la compactación. El teor de humedad final es calculado con base en la masa del agua desplazada y en la masa inicial de la muestra.<br><span style="font-weight: 700;">5. Interpretación:</span>&nbsp;Con base en los teores de humedad y en las masas compactadas, es posible construir una curva de compactación MCT. La curva ayuda a clasificar el suelo de acuerdo con la norma NBR 7182 en términos de estados de consistencia y plasticidad.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El ensayo MCT con pastillas es utilizado para clasificar suelos finos y arcillas de acuerdo con los límites de Atterberg, como el Límite de Líquido (LL) y el Límite de Plasticidad (LP), auxiliando en la comprensión de sus características de consistencia y plasticidad.<br>En resumen, el ensayo laboratorial de clasificación MCT con pastillas es una herramienta importante para evaluar la consistencia y plasticidad de suelos finos y arcillas, conforme a la norma NBR 7182. Esto auxilia en la comprensión de las propiedades geotécnicas de estos suelos y en su utilización en proyectos de ingeniería civil.</p>
      </div>
    </section>
