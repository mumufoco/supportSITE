...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Demolição.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Demolição.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Demolição.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Demolição.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1708">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTO DE DEMOLICIÓN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">La elaboración de proyectos de demolición es una etapa esencial cuando se trata de remover estructuras, edificios o instalaciones existentes de manera segura, eficiente y legalmente regulada. La demolición es un proceso complejo que envuelve diversos riesgos y consideraciones, y la elaboración de un proyecto de demolición es necesaria por varios motivos:<br><br><span style="font-weight: 700;">1. Seguridad Pública y de los Trabajadores:</span> La seguridad es una prioridad absoluta durante cualquier operación de demolición. Un proyecto de demolición detallado incluye evaluaciones de riesgo, planes de contingencia y medidas para garantizar que la demolición sea realizada con el mínimo de riesgos para las personas involucradas y para el público circundante.<br><span style="font-weight: 700;">2. Preservación Ambiental:</span> Dependiendo de la localización y de las estructuras involucradas, la demolición puede impactar el medio ambiente. La elaboración de proyectos de demolición considera medidas para minimizar los daños ambientales, como el gerenciamiento adecuado de residuos y la prevención de la contaminación.<br><span style="font-weight: 700;">3. Conformidad Legal:</span> La demolición está sujeta a regulaciones y requisitos legales específicos, como licencias y permisos. Un proyecto de demolición detallado garantiza que todas las etapas se realicen de acuerdo con las leyes y regulaciones locales y nacionales.<br><span style="font-weight: 700;">4. Evaluación Estructural:</span> Antes de la demolición, es importante evaluar la condición estructural de la edificación o estructura a ser removida. Esto ayuda a determinar el método de demolición más apropiado y a garantizar que no haya colapsos inesperados.<br><span style="font-weight: 700;">5. Planificación Logística:</span> Un proyecto de demolición incluye la planificación detallada de las etapas a seguir, incluyendo el orden de las demoliciones, la remoción de materiales, el gerenciamiento de detritos y la coordinación de equipos y equipos.<br><span style="font-weight: 700;">6. Selección de Métodos de Demolición:</span> Existen diferentes métodos de demolición, como demolición por explosivos, demolición mecánica y demolición controlada. El proyecto de demolición ayuda a seleccionar el método más adecuado con base en la estructura, localización y circunstancias específicas.<br><span style="font-weight: 700;">7. Evaluación de Riesgos Ambientales:</span> Algunas estructuras antiguas pueden contener materiales peligrosos, como amianto o materiales químicos tóxicos. Un proyecto de demolición debe identificar y gerenciar esos riesgos de forma adecuada.<br><span style="font-weight: 700;">8. Preservación de Recursos:</span> La demolición también puede ser vista como una oportunidad para la recuperación de materiales y recursos, como la reciclaje de concreto, metal y otros materiales que pueden ser reutilizados.<br><span style="font-weight: 700;">9. Impactos en la Vecindad:</span> La elaboración de un proyecto de demolición considera los impactos en la vecindad, como ruido, polvo y perturbaciones, e incluye medidas para minimizar esos efectos.<br><span style="font-weight: 700;">10. Comunicación y Transparencia:</span> Un proyecto de demolición bien documentado facilita la comunicación entre las partes interesadas, como propietarios, autoridades reguladoras, vecinos y trabajadores.<br><br>En resumen, la elaboración de proyectos de demolición es necesaria para garantizar que la remoción de estructuras sea realizada de manera segura, regulada y planeada. Esto ayuda a mitigar riesgos, proteger la seguridad pública, preservar el medio ambiente y cumplir con las exigencias legales, resultando en operaciones de demolición más eficaces y responsables.</p>
      </div>
    </section>
