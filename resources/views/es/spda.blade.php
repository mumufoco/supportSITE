...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/SPDA.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.spda') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/SPDA.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/SPDA.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1921">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTO SPDA – DESCARGAS ATMOSFÉRICAS</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">LA ELABORACIÓN DE PROYECTOS DE SISTEMA DE PROTECCIÓN CONTRA DESCARGAS ATMOSFÉRICAS (SPDA), TAMBIÉN CONOCIDOS COMO PARARRAYOS, ES ESENCIAL PARA CREAR SISTEMAS DE PROTECCIÓN QUE MINIMIZEN LOS RIESGOS DE DAÑOS CAUSADOS POR DESCARGAS ATMOSFÉRICAS, COMO RAYOS, EN EDIFICACIONES, ESTRUCTURAS Y EQUIPOS. ESTOS PROYECTOS ENGLOBAN EL PLANEAMIENTO Y EL DISEÑO DE SISTEMAS QUE DIRECCIONAN LAS DESCARGAS ELÉCTRICAS HACIA LA TIERRA DE FORMA SEGURO, PROTEGIENDO A LAS PERSONAS, LAS PROPIEDADES Y LOS SISTEMAS ELECTRÓNICOS. LA NECESIDAD DE ELABORAR PROYECTOS DE SPDA ES EVIDENTE POR DIVERSOS MOTIVOS:<br><br><span style="font-weight: 700;">1. SEGURIDAD DE LAS PERSONAS:</span> LA PRINCIPAL FUNCIÓN DE LOS SISTEMAS DE SPDA ES PROTEGER A LAS PERSONAS CONTRA LOS RIESGOS DE RAYOS, MINIMIZANDO LAS POSIBILIDADES DE LESIONES O MUERTE CAUSADAS POR DESCARGAS ELÉCTRICAS.<br><span style="font-weight: 700;">2. PROTECCIÓN DE ESTRUCTURAS:</span> PROYECTOS DE SPDA TIENEN COMO OBJETIVO PROTEGER LAS ESTRUCTURAS CONTRA DAÑOS CAUSADOS POR INCENDIOS, EXPLOSIONES Y IMPACTOS ASOCIADOS A DESCARGAS ATMOSFÉRICAS.<br><span style="font-weight: 700;">3. EQUIPOS ELECTRÓNICOS:</span> SISTEMAS DE SPDA PROTEGEN EQUIPOS ELECTRÓNICOS SENSIBLES, COMO COMPUTADORAS, SISTEMAS DE COMUNICACIÓN Y DISPOSITIVOS DE AUTOMATIZACIÓN, CONTRA DAÑOS ELÉCTRICOS.<br><span style="font-weight: 700;">4. PREVENCIÓN DE INCENDIOS:</span> LA ELABORACIÓN DE PROYECTOS BUSCA PREVENIR INCENDIOS CAUSADOS POR RAYOS, QUE PUEDEN OCURRIR CUANDO LAS DESCARGAS ELÉCTRICAS ATINGEN MATERIALES INFLAMABLES.<br><span style="font-weight: 700;">5. CONFORMIDAD CON NORMAS:</span> MUCHAS REGIONES POSEEN REGULAMENTACIONES QUE EXIGEN LA IMPLEMENTACIÓN DE SISTEMAS DE SPDA EN DETERMINADOS TIPOS DE EDIFICACIONES Y ESTRUCTURAS.<br><span style="font-weight: 700;">6. MINIMIZACIÓN DE RIESGOS:</span> PROYECTOS DE SPDA AYUDAN A MINIMIZAR LOS RIESGOS DE DAÑOS CAUSADOS POR RAYOS, PROPORCIONANDO TRANQUILIDAD A LOS OCUPANTES.<br><span style="font-weight: 700;">7. PATRIMONIO CULTURAL:</span> EN LUGARES HISTÓRICOS Y PATRIMONIOS CULTURALES, SISTEMAS DE SPDA PROTEGEN ESTRUCTURAS VALIOSAS CONTRA DAÑOS IRREPARABLES.<br><span style="font-weight: 700;">8. ATENUACIÓN DE DAÑOS:</span> INCLUSO CUANDO NO SEA POSIBLE EVITAR TOTALMENTE LOS DAÑOS CAUSADOS POR RAYOS, SISTEMAS DE SPDA ATENUAN LOS EFECTOS Y LOS CONCENTRAN EN LUGARES SEGUROS.<br><span style="font-weight: 700;">9. SEGURIDAD EN AMBIENTES EXTERNOS:</span> SISTEMAS DE SPDA TAMBIÉN PUEDEN SER INSTALADOS EN ÁREAS EXTERNAS, COMO PARQUES Y CAMPOS DEPORTIVOS, PROTEGIENDO A LAS PERSONAS DURANTE ACTIVIDADES AL AIRE LIBRE.<br><span style="font-weight: 700;">10. INVERSIÓN A LARGO PLAZO:</span> LA IMPLEMENTACIÓN DE PROYECTOS DE SPDA ES UNA INVERSIÓN A LARGO PLAZO, REDUCIENDO COSTOS CON REPAROS Y SUSTITUCIONES DE EQUIPOS.<br><span style="font-weight: 700;">11. CREACIÓN DE RUTAS PREFERENCIALES:</span> PROYECTOS DE SPDA CREAN RUTAS PREFERENCIALES PARA LAS DESCARGAS ELÉCTRICAS, MINIMIZANDO LOS RIESGOS DE DAÑOS ACCIDENTALES.<br><span style="font-weight: 700;">12. INGENIERÍA DE SEGURIDAD:</span> LA ELABORACIÓN DE PROYECTOS DE SPDA REQUIERE CONOCIMIENTO ESPECIALIZADO EN INGENIERÍA ELÉCTRICA Y DE PROTECCIÓN CONTRA RAYOS.<br><br>EN RESUMEN, LA ELABORACIÓN DE PROYECTOS DE SPDA ES NECESARIA PARA PROTEGER A LAS PERSONAS, LAS ESTRUCTURAS Y LOS EQUIPOS CONTRA LOS RIESGOS ASOCIADOS A DESCARGAS ATMOSFÉRICAS. ESTOS PROYECTOS BUSCAN MINIMIZAR LOS DAÑOS CAUSADOS POR RAYOS, PROPORCIONANDO SEGURIDAD Y CONFORMIDAD CON REGULAMENTACIONES ESPECÍFICAS. LA IMPLEMENTACIÓN DE SISTEMAS DE SPDA CONTRIBUYE A LA SEGURIDAD Y LA INTEGRIDAD DE EDIFICACIONES Y AMBIENTES EN GENERAL.</p>
      </div>
    </section>
