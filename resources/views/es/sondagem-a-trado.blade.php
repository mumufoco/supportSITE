...
@section('lang', 'es')
@section('title', 'Sondagem a Trado')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-a-Trado.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SONDEO A TRADO - ST</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo de sondeo a trado es necesaria para obtener información sobre las características del suelo en profundidades superficiales y subsuperficiales. Esta información es crucial para la evaluación de las propiedades del suelo, la determinación de su capacidad de carga, la identificación de capas estratigráficas y otras características relevantes para proyectos de ingeniería geotécnica y ambiental.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo de sondeo a trado es obtener muestras de suelo y información sobre sus características físicas y geotécnicas. Esto incluye la identificación de diferentes capas del suelo, su composición, textura, humedad y otras propiedades que son relevantes para proyectos de construcción, fundaciones, investigaciones ambientales y otras aplicaciones geotécnicas.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo de sondeo a trado son:<br>NBR 9603:1986 – Proyecto y Ejecución de Sondeos de Simples Reconocimiento de Suelos para Fundaciones de Edificios.<br>NBR 6502:1995 – Rocas y Suelos – Terminología.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;El público objetivo de la prueba de campo de sondeo a trado incluye ingenieros geotécnicos, ingenieros civiles, geólogos, arquitectos y otros profesionales involucrados en proyectos de construcción, fundaciones e investigaciones geotécnicas. Además, profesionales involucrados en proyectos de remediación ambiental, monitoreo de áreas contaminadas y estudios de impacto ambiental también pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo de sondeo a trado implica las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span>&nbsp;El lugar de sondeo es preparado, y el área es limpia de obstáculos para facilitar la operación del trado.<br><span style="font-weight: 700;">2. INSTALACIÓN DEL TRADO:</span>&nbsp;El trado es introducido en el suelo por medio de rotación manual o mecánica. El trado está compuesto por una lámina cortante en la punta y una vara para perforación.<br><span style="font-weight: 700;">3. PENETRACIÓN Y MUESTREO:</span>&nbsp;A medida que el trado penetra en el suelo, él colecta muestras del suelo a su alrededor. La profundidad de la perforación es medida, y muestras pueden ser retiradas manualmente para análisis posterior.<br>REGISTRO DE CAPAS:&nbsp;Durante la perforación, se registran las características del suelo, como color, textura, granulometría y posibles cambios de capa.<br><span style="font-weight: 700;">4. COLECCIÓN DE MUESTRAS:</span>&nbsp;Las muestras retiradas del trado pueden ser analizadas en laboratorio para determinar propiedades físicas, teor de humedad, granulometría y otras características relevantes.<br><br><span style="font-weight: 700;">INTERPRETACIÓN:</span>&nbsp;Las muestras y la información colectadas durante la prueba de campo de sondeo a trado son usadas para entender la estratigrafía del suelo, su composición, humedad, granulometría y otras propiedades físicas. Estos datos son valiosos para proyectos de fundaciones, construcción, investigaciones ambientales y otras aplicaciones geotécnicas.<br>En resumen, la prueba de campo de sondeo a trado es una técnica importante en la ingeniería geotécnica para obtener información sobre las características del suelo en profundidades superficiales y subsuperficiales. Él es utilizado por una variedad de profesionales y organizaciones involucradas en proyectos de ingeniería, construcción e investigaciones ambientales, siguiendo las normas establecidas.</p>
      </div>
    </section>
