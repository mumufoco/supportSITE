...
@section('lang', 'es')
@section('title', 'Resistividade Térmica do Solo')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Resistividade-Térmica-do-Solo.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">RESISTIVIDAD TÉRMICA DEL SUELO - RT</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">El ensayo de resistividad térmica del suelo in-situ es una técnica utilizada para determinar la capacidad del suelo de conducir calor. Este parámetro es esencial para la evaluación y proyecto de sistemas de intercambio térmico enterrados, como cables subterráneos y sistemas de calefacción y refrigeración geotérmica. La resistividad térmica del suelo influye en la disipación de calor generado por estas instalaciones y, por lo tanto, afecta la eficiencia y la seguridad del sistema.<br><br><span style="font-weight: 700;">Normas que abarcan el ensayo de resistividad térmica del suelo:</span><br>IEEE 442-2017: "Guía para mediciones de resistividad térmica de suelos y materiales de relleno" – Esta norma proporciona orientación sobre los métodos y procedimientos para medir la resistividad térmica de suelos y materiales de relleno in-situ y en laboratorio.<br>ASTM D5334-22: "Método de prueba estándar para la determinación de la conductividad térmica de suelos y rocas blandas mediante el procedimiento de sonda térmica" – Esta norma describe el método de la "sonda térmica" para medir la conductividad térmica de suelos y rocas blandas.<br>IEC/TS 62039:2007: "Guía para la medición de la resistividad del suelo" – Esta norma ofrece directrices para medir la resistividad térmica del suelo en campo e incluye métodos de medición e interpretación de los datos.<br><br><span style="font-weight: 700;">Detalles de la ejecución del ensayo de resistividad térmica del suelo in-situ:</span><br><span style="font-weight: 700;">1. Preparación del lugar de ensayo:</span> Selección de un lugar representativo del suelo donde se instalará el sistema de intercambio térmico.<br>Remoción de cualquier vegetación o detritos de la superficie.<br>Excavación de un pequeño pozo o hueco de sondeo para alcanzar la profundidad deseada para la medición.<br><span style="font-weight: 700;">2. Instalación de la sonda térmica:</span> Introducción de una sonda térmica en el suelo a la profundidad determinada. La sonda puede ser una sonda de aguja, que consiste en un elemento de calentamiento y sensores de temperatura.<br>Garantizar que la sonda esté en buen contacto térmico con el suelo que la rodea, sin espacios de aire o materiales extraños.<br><span style="font-weight: 700;">3. Aplicación de calor:</span> Aplicación de una corriente eléctrica constante al elemento de calentamiento en la sonda térmica, generando un flujo de calor constante.<br>Monitoreo de las variaciones de temperatura en la sonda en función del tiempo, utilizando los sensores de temperatura integrados.<br><span style="font-weight: 700;">4. Medición y registro de datos:</span> Registro continuo de las lecturas de temperatura durante el período de calentamiento.<br>Después de un período de tiempo suficiente (generalmente entre 10 y 20 minutos), los datos de temperatura se estabilizan.<br><span style="font-weight: 700;">5. Cálculo de la resistividad térmica:</span> Utilización de los datos de temperatura y del flujo de calor aplicado para calcular la resistividad térmica del suelo.<br>La resistividad térmica (ρ) se calcula con base en la fórmula: ρ = dT/dQ <br>Donde dT es la diferencia de temperatura registrada y dQ es el flujo de calor aplicado.<br><span style="font-weight: 700;">6. Interpretación de los resultados:</span> Comparación de los valores obtenidos con los criterios de proyecto y las especificaciones del sistema de intercambio térmico.<br>Ajustes en el diseño del sistema, si es necesario, con base en la resistividad térmica medida.<br><br><span style="font-weight: 700;">Consideraciones adicionales</span><span style="font-weight: 700;"> Calibración del equipo:</span> Las sondas térmicas y los equipos de medición deben ser calibrados regularmente para garantizar la precisión de las mediciones.<br><br><span style="font-weight: 700;">Condiciones del suelo:</span> La humedad, la densidad y la composición del suelo pueden afectar significativamente los resultados. Se recomienda realizar mediciones en diferentes condiciones estacionales para un análisis más completo.<br><br><span style="font-weight: 700;">Seguridad:</span> Asegúrese de seguir todas las normas de seguridad al manejar equipos eléctricos y durante la excavación.<br>El ensayo de resistividad térmica del suelo in-situ es una herramienta crucial para garantizar la eficiencia y la durabilidad de los sistemas de intercambio térmico enterrados.​</p>
      </div>
    </section>
