...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
          ...
          <div class="u-layout-row">
            <div class="skrollable u-align-center u-container-align-center u-container-style u-layout-cell u-parallax u-shape-rectangle u-size-30 u-layout-cell-1" data-image-width="2000" data-image-height="1333">
              <div class="u-container-layout u-container-layout-1">
                ...
                <h5 class="u-text u-text-palette-1-base u-text-3">https://www.soportesonddagens.com.br​</h5>
              </div>
            </div>
    ...
    <section class="u-clearfix u-section-3" id="block-9">
      <p class="u-text u-text-1"><span style="font-weight: 700;">La Soporte de Sondaje de Suelo</span> es una empresa especializada en investigaciones geotécnicas y geológicas de alta precisión. Fundada en 2015 y con enfoque estratégico en proyectos de gran complejidad desde 2018, poseemos la experiencia y la infraestructura necesarias para ser el socio técnico confiable en el desarrollo y la expansión del Sistema de Transmisión de Energía brasileño.<br>Comprendemos que la confiabilidad de la red comienza con la robustez de las fundaciones. Nuestra misión es proporcionar datos subsuperficiales precisos y análisis técnicos detallados que garanticen la seguridad, la economía y la viabilidad de proyectos de líneas de transmisión y subestaciones, desde la fase de planificación hasta la ejecución.<br><br><span style="font-weight: 700;">Servicios Aplicables a la Transmisión de Energía:</span><br><br>Ofrecemos un portafolio integrado de servicios, diseñado para atender todas las etapas de la investigación geotécnica en el sector eléctrico.<br><br><span style="font-weight: 700;">Investigación Geotécnica para Proyectos de Fundaciones:</span><br><br><span style="font-weight: 700;">Sondaje a Percusión (SPT):</span> Ejecutado conforme la norma ABNT NBR 6484, es fundamental para definir el perfil estratigráfico, el nivel de agua y la capacidad de carga de suelos para fundaciones rasas y profundas de torres y subestaciones.<br><span style="font-weight: 700;">Sondaje Rotativo:</span> Esencial para la caracterización de macizos rocosos, permitiendo la obtención de testigos para determinar el RQD (Rock Quality Designation), resistencia de la roca y definición de la cota de embutimiento de fundaciones en estacas o tubulones.<br><span style="font-weight: 700;">Sondaje Mixto (Rotopercusión):</span> Combina eficiencia y detalle para atravesar suelos resistentes y rocas alteradas, comunes en terrenos brasileños.<br><br><span style="font-weight: 700;">Ensayos de Campo y Monitoreo Especializados:</span><br><br><span style="font-weight: 700;">Ensayos de Penetración de Cono (CPT):</span> Proporciona parámetros continuos y más detallados del suelo (resistencia, fricción, poropresión), ideal para proyectos en suelos homogéneos y análisis de estabilidad.<br><span style="font-weight: 700;">Ensayos de Permeabilidad: </span>Críticos para proyectos de drenaje, contención y análisis de estabilidad de taludes en áreas de subestaciones y accesos.<br><span style="font-weight: 700;">Recolección de Muestras Indeformadas:</span> Para la realización de ensayos laboratoriales avanzados de resistencia y deformabilidad.<br><br><span style="font-weight: 700;">Laboratorio de Suelos y Rocas:</span><br><br>Ensayos de caracterización física (granulometría, límites de Atterberg).<br>Ensayos de resistencia (corte directo, compresión simple en rocas).<br>Ensayos de compactación (Proctor Normal y Modificado) para control de aterros y estructuras de tierra.<br><br><span style="font-weight: 700;">Logística y Movilidad para Acceder a Cualquier Terreno:</span><br><br><span style="font-weight: 700;">Unidades Móviles de Sondaje en Contenedor:</span> Nuestra solución exclusiva permite implantar cantones completos de investigación en áreas remotas y de difícil acceso, típicas de trazados de líneas de transmisión, con agilidad, seguridad y preservación ambiental. Garantizamos la continuidad de las operaciones independientemente de las condiciones climáticas.</p>
    </section>
        ...
        <div class="u-layout" style="">
          <div class="u-layout-row" style="">
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                <p class="u-text u-text-1"><span style="font-weight: 700;">​​</span><span style="font-weight: 700;">Experiencia, Capacidad Técnica y Confiabilidad:</span><br><br><span style="font-weight: 700;">Competencia Técnica Certificada:</span> Nuestras operaciones siguen rigurosamente las Normas Brasileñas (ABNT) pertinentes y las Normas Regulamentadoras (NRs), con destaque para la NR-12 (Seguridad en Máquinas). Estamos preparados para atender a requisitos específicos de órganos reguladores y concesionarios.<br><span style="font-weight: 700;">Equipo Calificado: </span>Contamos con ingenieros geotécnicos y geólogos experimentados, capaces de interpretar datos complejos y ofrecer recomendaciones prácticas para optimizar proyectos de fundaciones.<br><span style="font-weight: 700;">Tecnología e Innovación: </span>Invertimos continuamente en equipos de punta y en la formación de nuestro equipo, asegurando la calidad y la confiabilidad de los datos entregados.<br><span style="font-weight: 700;">Compromiso con Plazos y Resultados:</span> Nuestra estructura logística propia y planeamiento detallado garantizan la movilización ágil y la ejecución dentro de los cronogramas, críticos para el avance de las obras de transmisión.<br><br><span style="font-weight: 700;">Diferenciales Estratégicos para el Sector Eléctrico:</span><br><br><span style="font-weight: 700;">Enfoque en la Solución del Problema de Fundación:</span> Vamos más allá de la recopilación de datos. Nuestros informes interpretan la geotecnia para orientar las mejores decisiones de proyecto, visando seguridad y economía.<br><span style="font-weight: 700;">Movilidad y Resiliencia Operacional:</span> Nuestra plaza de sondaje móvil elimina barreras logísticas, asegurando que las investigaciones prosigan en cualquier localidad, manteniendo el cronograma del proyecto.<br><span style="font-weight: 700;">Conformidad y Seguridad Integral:</span> Adoptamos un Sistema de Gestión de Salud y Seguridad robusto, esencial para operar en cantones de obra complejos y en coordinación con otras contratadas.<br><span style="font-weight: 700;">Asociación Técnica:</span> Actuamos como una extensión del equipo de ingeniería de nuestros clientes, ofreciendo soporte técnico desde la definición de la malla de sondajes hasta el análisis de los resultados.</p>
              </div>
            </div>
    ...
    <section class="u-clearfix u-section-10" id="sec-a700">
      <p class="u-text u-text-1"><span style="font-weight: 700;">​​</span><span style="font-weight: 700;">Conclusión y Recomendaciones para Implementación:</span><br>La Soporte de Sondaje de Suelo posee la base técnica, operacional y de seguridad totalmente adecuada para actuar con excelencia en el sector de transmisión de energía. El portafolio anterior propone una reformulación estratégica de la comunicación, traduciendo las competencias existentes para la lengua y las necesidades específicas del mercado eléctrico.<br><br><span style="font-weight: 700;">Para implementar esta transformación, recomiendo:</span><br><br><span style="font-weight: 700;">Revisar el sitio institucional:</span> para incluir una sección dedicada al “Sector Eléctrico”, incorporando el contenido desarrollado.<br><span style="font-weight: 700;">Desarrollar casos técnicos:</span> (incluso si son iniciales) que demuestren la aplicación de los servicios en escenarios análogos a los de transmisión.<br><span style="font-weight: 700;">Producir contenido técnico:</span> (artículos, notas técnicas) sobre la importancia de la investigación geotécnica para fundaciones de torres, alineando la marca al sector.<br><br>Este portafolio posiciona a la empresa no como una simple ejecutora de sondajes, sino como una asociación especializada en geotecnia para infraestructura crítica, apta para contribuir decisivamente a la seguridad y eficiencia del sistema eléctrico nacional.</p>
    </section>
