...
@push('meta')
    <meta name="keywords" content="FORMULARIO DE DENUNCIA">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="block-1">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">FORMULARIO DE DENUNCIA</h2>
        <div class="u-expanded-width u-form u-form-1">
          <form action="https://service.nicepagesrv.com/form/v4/form-process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-1">
              ...
              <input type="text" placeholder="DIGITE SU PRIMER NOMBRE" id="first-name-3ecd" name="name-1" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-2">
              <label class="u-label">APELLIDO</label>
              <input type="text" placeholder="DIGITE SU ÚLTIMO NOMBRE" id="last-name-3ecd" name="name-2" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-email u-form-group">
              <label class="u-label">CORREO ELECTRÓNICO</label>
              <input type="email" placeholder="INSIRA UNA DIRECCIÓN DE CORREO ELECTRÓNICO VÁLIDA" id="email-89e2" name="email" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-date u-form-group u-form-group-4">
              <label class="u-label">FECHA DE LA DENUNCIA</label>
              <input type="text" placeholder="DD/MM/AAAA" id="date-5d4f" name="date" class="u-input u-input-rectangle" required="" data-date-format="dd/mm/yyyy">
            </div>
            <div class="u-form-group u-form-message">
              <label class="u-label">DESCRIBA SU MENSAJE</label>
              <textarea placeholder="TODA LA INFORMACIÓN AQUÍ ES SIGILOSA" id="message-89e2" name="message" class="u-input u-input-rectangle" required=""></textarea>
            </div>
            <div class="u-form-agree u-form-group u-form-group-6">
              ...
              <label class="u-agree-label u-field-label">YO ACEPTO LOS <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-block-control u-btn-1" href="#" style="background-image: none; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0" data-block="1478">TÉRMINOS DE SERVICIO</a></label>
            </div>
            ...
            NO FUE POSIBLE ENVIAR SU MENSAJE. POR FAVOR, CORRIJA LOS ERRORES Y VUELVA A INTENTAR.
        </div>
