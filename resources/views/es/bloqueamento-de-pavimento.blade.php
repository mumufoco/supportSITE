...
@section('lang', 'es')
@section('title', 'Bloqueamento de Pavimento')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Bloqueamento-de-Pavimento.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​BROQUEAMIENTO DE PAVIMENTO - BQ</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo de broqueamiento de pavimento es necesaria para determinar el grosor de las capas de pavimento y la existencia de posibles defectos, como grietas, desplazamientos e irregularidades. Esta información es crucial para evaluar la integridad estructural del pavimento, planificar mantenimientos, realizar proyectos de rehabilitación y optimizar la gestión de carreteras y autopistas.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo de broqueamiento de pavimento es obtener información sobre el grosor de las capas del pavimento, así como identificar la presencia de defectos que puedan comprometer su durabilidad y seguridad. Esto permite evaluar la necesidad de intervenciones, como reparos localizados o recubrimiento, para garantizar la calidad y la vida útil del pavimento.&nbsp;<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo de broqueamiento de pavimento están relacionadas con pruebas de pavimento, investigación de defectos y evaluación del grosor de las capas. Algunos ejemplos de normas que pueden ser relevantes incluyen:<br>DNIT 029/2004 – Método de Ensayo – Determinación del Grosor de la Capa Asfáltica (Broqueamiento).<br>ABNT NBR 9895:2016 – Agregado grueso – Determinación de impurezas orgánicas – Método de ensayo.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;El público objetivo de la prueba de campo de broqueamiento de pavimento incluye ingenieros de pavimentación, ingenieros civiles, técnicos en infraestructura, gestores de carreteras y autopistas, órganos de tráfico y transporte, así como contratistas involucrados en la construcción y mantenimiento de pavimentos.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo de broqueamiento de pavimento implica las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span>&nbsp;El lugar de la prueba es elegido con base en criterios preestablecidos, teniendo en cuenta la extensión de la carretera, el tipo de pavimento y otros factores relevantes.<br><span style="font-weight: 700;">2. BROQUEAMIENTO:</span>&nbsp;Un equipo de broqueamiento se utiliza para cortar una sección transversal del pavimento. Este equipo elimina una muestra de la capa asfáltica, exponiendo las capas subyacentes.<br><span style="font-weight: 700;">3. EVALUACIÓN VISUAL:</span>&nbsp;La exposición de las capas del pavimento permite la evaluación visual de las diferentes capas, como la capa asfáltica, la base y el sublecho. Defectos como grietas, desplazamientos e irregularidades pueden ser observados.<br><span style="font-weight: 700;">4. MEDICIÓN DEL GROSOR:</span>&nbsp;El grosor de la capa asfáltica se mide a partir del corte realizado por el broqueamiento. Esto se hace con el uso de instrumentos de medición adecuados.<br><span style="font-weight: 700;">5. REGISTRO DE DATOS:</span>&nbsp;Todos los datos obtenidos durante la prueba son registrados, incluyendo el grosor de las capas, defectos observados, características del pavimento y otros aspectos relevantes.<br><span style="font-weight: 700;">6. INTERPRETACIÓN:</span>&nbsp;El análisis de los datos obtenidos en la prueba de campo de broqueamiento de pavimento permite determinar el grosor de la capa asfáltica e identificar defectos que puedan comprometer su integridad. Estas informaciones son fundamentales para el planeamiento de intervenciones, como reparos, recubrimiento o rehabilitación del pavimento.<br><br>En resumen, la prueba de campo de broqueamiento de pavimento es una técnica importante en la ingeniería de pavimentos para evaluar el grosor de las capas del pavimento e identificar defectos. Se utiliza por una variedad de profesionales y organizaciones involucradas en la construcción y mantenimiento de pavimentos, siguiendo las normas establecidas.​</p>
      </div>
    </section>
