...
@section('lang', 'es')
@section('title', 'Política de Qualidade')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-de-Qualidade.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-2" id="block-14">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-absolute-hcenter u-expanded-height u-image u-image-contain u-image-1" src="{{ asset('images/Circulo-de-melhoria.png') }}" data-image-width="500" data-image-height="500">
      </div>
    </section>
    <section class="u-clearfix u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">​</span>En Support Solo Sondeos, estamos comprometidos con la excelencia en nuestros servicios de sondeo geotécnico, con el objetivo de satisfacer plenamente a nuestros clientes, desarrollar profesionalmente a nuestros colaboradores y contribuir al éxito y la seguridad de los proyectos de nuestros clientes. Esta Política de Calidad establece los principios fundamentales por los que conducimos nuestras operaciones.<br><br><span style="font-weight: 700;">Compromisos:</span><br><span style="font-weight: 700;">1. Excelencia Técnica:</span>&nbsp;Buscamos constantemente mejorar nuestro conocimiento técnico y la experticia en el área de sondeo geotécnico. Realizamos procedimientos de alta calidad utilizando tecnologías modernas y técnicas avanzadas.<br><span style="font-weight: 700;">2. Satisfacción del Cliente:</span>&nbsp;Nuestros clientes son nuestra prioridad máxima. Nos comprometemos a entender sus necesidades, superar sus expectativas y proporcionar resultados precisos, confiables y oportunos.<br><span style="font-weight: 700;">3. Comunicación Clara:</span>&nbsp;Promovemos una comunicación abierta y transparente con nuestros clientes, socios y colaboradores. Mantenemos a nuestros clientes informados sobre el progreso de los proyectos y los resultados de los sondeos de manera clara y comprensible.<br><span style="font-weight: 700;">4. Cumplimiento de Plazos:</span>&nbsp;Reconocemos la importancia de los plazos en proyectos de construcción e ingeniería. Nos comprometemos a realizar nuestras actividades de sondeo de acuerdo con los cronogramas acordados, minimizando retrasos.<br><span style="font-weight: 700;">5. Mejora Continua:</span>&nbsp;Valoramos la búsqueda constante de la mejora. Evaluamos regularmente nuestros procesos y procedimientos para identificar oportunidades de mejora y implementamos acciones correctivas y preventivas de forma proactiva.<br><span style="font-weight: 700;">6. Seguridad y Salud:</span>&nbsp;Priorizamos la seguridad de nuestros colaboradores y de los lugares donde realizamos los sondeos. Implementamos prácticas seguras de trabajo y cumplimos con las regulaciones de salud y seguridad.<br><span style="font-weight: 700;">7. Desarrollo de Colaboradores:</span>&nbsp;Reconocemos que nuestro equipo es nuestro activo más valioso. Invertimos en capacitación y desarrollo para garantizar que nuestros colaboradores tengan las habilidades y conocimientos necesarios para ejecutar con excelencia.<br><span style="font-weight: 700;">8. Responsabilidad Ambiental:</span>&nbsp;Realizamos nuestras actividades con respeto al medio ambiente. Minimizamos los impactos ambientales y cumplimos con las regulaciones aplicables.<br><br><span style="font-weight: 700;">Responsabilidad de la Dirección:</span><br>La alta dirección de Support Solo Sondeos está totalmente comprometida con la implementación, mantenimiento y mejora continua de nuestro Sistema de Gestión de la Calidad, garantizando que esta Política de Calidad sea comunicada, entendida y aplicada en todos los niveles de la organización.<br><br><span style="font-weight: 700;">Cumplimiento de la Política:</span><br>Esta Política de Calidad es una referencia central para nuestros objetivos de calidad y dirige nuestras acciones diarias. Es revisada periódicamente para garantizar su relevancia y eficacia.<br>Esta Política de Calidad es efectiva a partir de la fecha anterior y se aplica a todos los aspectos de las operaciones de Support Solo Sondeos.</p>
      </div>
    </section>
