...
@section('lang', 'es')
@section('title', 'Termo de Serviços')
...
@push('meta')
    ...
    <meta property="og:title" content="Termo de Serviços">
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Termo-de-Serviços.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.termo-de-servicos') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Termo-de-Serviços.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Termo-de-Serviços.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-16">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​TERMO DE SERVIÇO –&nbsp;<br>SUPPORT SOLO SONDAGENS</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-17">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h4 class="u-text u-text-default u-text-1">​Última atualização: 02 de janeiro de 2026</h4>
      </div>
    </section>
    <section class="u-clearfix u-container-align-center u-section-3" id="block-15">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-1">Por favor, leia estes Termos de Serviço (“Termos”) com atenção antes de utilizar os serviços oferecidos por meio do site <a data-start="1669" data-end="1705" rel="noopener" target="_new" class="decorated-link u-btn u-button-style u-none u-hover-none u-active-none u-border-none u-text-palette-1-base u-btn-1" href="https://site.supportsondagens.com.br?utm_source=chatgpt.com" style="background-image: none; padding: 0px;">https://site.supportsondagens.com.br</a> (o “Site”), e quaisquer plataformas, páginas anexas, áreas restritas ou portais eletrônicos de clientes (“Plataformas”).
Ao acessar ou utilizar os serviços oferecidos pela Support Solo Sondagens, você concorda integralmente com estes Termos.&nbsp;<br><br>1. Definições
<br>
Support Solo Sondagens refere-se à empresa que presta serviços geotécnicos e correlatos, operando o Site e as Pltaformas.
<br>
Usuário/Cliente refere-se à pessoa física ou jurídica que acessa o Site ou contrata serviços oferecidos por meio dele.
<br>
Serviços referem-se às atividades técnicas de sondagem, ensaios, projetos ou quaisquer outros serviços listados no Site.
<br><br>2. Aceitação dos Termos
Ao acessar o Site ou contratar quaisquer serviços, o Usuário declara que leu, compreendeu e concorda com estes Termos, bem como com qualquer outro documento legal aplicável, incluindo Políticas de Privacidade e quaisquer termos específicos de contratação.
Caso não concorde com estes Termos, não utilize o Site nem contrate nenhum serviço por meio dele.&nbsp;<br><br>3. Uso do Site e das Plataformas
O Usuário concorda em utilizar o Site apenas para fins legais e em conformidade com estes Termos.
<br>
O Usuário é responsável por manter a confidencialidade de qualquer login e senha vinculados a serviços ou áreas restritas.
<br>
O acesso a áreas restritas (como Área do Cliente) é pessoal e intransferível.
<br><br>4. Descrição dos Serviços
A Support Solo Sondagens presta serviços especializados em sondagens geotécnicas, ensaios de solos, análise laboratorial, projeto de engenharia e execução de fundações profundas, conforme descrito no Site. 
<br>
As descrições de serviços podem ser atualizadas periodicamente, e o Usuário concorda que tais alterações entram em vigor imediatamente após sua publicação no Site.
<br><br>5. Contratação e Execução dos Serviços
A contratação de serviços se dará por meio de proposta formal enviada pela Support Solo Sondagens e aceita pelo Cliente, contendo preço, prazos, condições de pagamento e requisitos técnicos. 
<br>
A Support Solo Sondagens reserva-se o direito de recusar a prestação de serviços a qualquer Cliente que não cumpra requisitos ou condições legais/regulatórias.
<br>
O Cliente deve fornecer informações verdadeiras e completas necessárias para a execução dos serviços, sob pena de responsabilização por informações falsas.
<br><br>6. Pagamento e Condições Comerciais
Os valores e condições de pagamento serão estipulados em contrato ou proposta aceita pelo Cliente.
<br>
Eventuais atrasos nas obrigações de pagamento poderão acarretar juros, correções e suspensão da execução dos serviços até a regularização.
<br><br>7. Propriedade Intelectual
Todo o conteúdo do Site (textos, imagens, marcas, logotipos) é de propriedade exclusiva da Support Solo Sondagens ou de seus licenciadores.
<br>
É proibida qualquer reprodução, modificação ou distribuição de conteúdo sem autorização expressa.
<br><br>8. Limitações de Responsabilidade
A Support Solo Sondagens não será responsável por danos indiretos, especiais, incidentais ou consequenciais decorrentes da utilização do Site ou da contratação de serviços.
<br>
A Support Solo Sondagens envidará esforços razoáveis para fornecer informações precisas, mas não garante que o Site será contínuo, ininterrupto ou livre de erros.
<br><br>9. Privacidade e Proteção de Dados
A coleta e o tratamento de dados pessoais do Usuário/Cliente serão regidos pela Política de Privacidade aplicável, a qual faz parte integrante destes Termos.
<br>
O Usuário consente com a utilização de seus dados conforme descrito na Política de Privacidade.
<br><br>10. Alterações dos Termos
A Support Solo Sondagens pode atualizar estes Termos a qualquer momento, mediante publicação no Site. O uso continuado após as alterações constitui aceitação das versões atualizadas.
11. Vigência e Rescisão
Estes Termos entram em vigor a partir da data de sua aceitação pelo Usuário e permanecem válidos enquanto o Cliente acessar o Site ou utilizar os serviços.
<br>
A Support Solo Sondagens pode encerrar ou suspender o acesso ao Site e às Pltaformas, a seu critério, mediante violação destes Termos.
<br><br>12. Lei Aplicável e Foro
Estes Termos são regidos pelas leis brasileiras. As partes elegem o foro da comarca onde a Support Solo Sondagens está sediada para dirimir quaisquer disputas oriundas destes Termos, com renúncia de qualquer outro foro, por mais privilegiado que seja.&nbsp;<br><br>13. Contato
Para dúvidas, suporte ou esclarecimentos sobre estes Termos, entre em contato através de:<br>
Email: <a data-start="6455" data-end="6486" class="decorated-link cursor-pointer u-btn u-button-style u-none u-hover-none u-active-none u-border-none u-text-palette-1-base u-btn-2" rel="noopener" style="background-image: none; padding: 0px;">contato@supportsondagens.com.br</a> <br>
Website: <a data-start="6540" data-end="6576" rel="noopener" target="_new" class="decorated-link u-btn u-button-style u-none u-hover-none u-active-none u-border-none u-text-palette-1-base u-btn-3" href="https://site.supportsondagens.com.br?utm_source=chatgpt.com" style="background-image: none; padding: 0px;">https://site.supportsondagens.com.br</a></p>
      </div>
    </section>
