...
@section('lang', 'es')
@section('title', 'Política de Gestão Ambiental')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-de-Gestão-Ambiental.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.politica-de-gestao-ambiental') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Política-de-Gestão-Ambiental.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Política-de-Gestão-Ambiental.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POLÍTICA DE GESTIÓN AMBIENTAL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">INTRODUCCIÓN:</span><br>El Sistema de Gestión Ambiental (SGA) de Support Solo Sondajes es un enfoque estructurado que busca integrar prácticas ambientalmente responsables en todas las operaciones de la empresa. Dado el enfoque en estudios geológicos, el SGA es especialmente diseñado para minimizar los impactos ambientales asociados con las actividades de sondeo y maximizar la contribución positiva a la sostenibilidad.<br><br><span style="font-weight: 700;">OBJETIVOS DEL SGA:</span><br><span style="font-weight: 700;">1. MINIMIZACIÓN DE IMPACTOS:</span>&nbsp;Reducir el impacto ambiental de las operaciones de sondeo geológico, minimizando la perturbación del suelo, la generación de residuos y el consumo de recursos naturales.<br><span style="font-weight: 700;">2. CONFORMIDAD LEGAL:</span>&nbsp;Cumplir rigurosamente con todas las regulaciones y normas ambientales relevantes, garantizando que las actividades de la empresa estén en conformidad con las leyes aplicables.<br><span style="font-weight: 700;">3. PRESERVACIÓN DE ECOSISTEMAS:</span>&nbsp;Proteger los ecosistemas locales y la biodiversidad mediante la identificación y mitigación de posibles impactos negativos.<br><span style="font-weight: 700;">4. EFICIENCIA DE RECURSOS:</span>&nbsp;Utilizar recursos, como agua y energía, de manera eficiente, adoptando prácticas de conservación y reducción del desperdicio.<br><span style="font-weight: 700;">5. EDUCACIÓN Y SENSIBILIZACIÓN:</span>&nbsp;Promover la conciencia ambiental entre los colaboradores, proveedores y socios, incentivando la adopción de prácticas sostenibles.<br><br><span style="font-weight: 700;">COMPONENTES DEL SGA:</span><br><span style="font-weight: 700;">1. EVALUACIÓN DE IMPACTO AMBIENTAL:</span>&nbsp;Antes de iniciar cualquier proyecto de sondeo, Support Solo Sondajes conduce evaluaciones de impacto ambiental para identificar posibles riesgos y desarrollar estrategias de mitigación.<br><span style="font-weight: 700;">2. PLAN DE GESTIÓN DE RESIDUOS:</span>&nbsp;Establecer protocolos para la gestión adecuada de residuos generados durante las operaciones, promoviendo la reciclaje, reutilización y eliminación adecuada.<br><span style="font-weight: 700;">3. EFICIENCIA ENERGÉTICA:</span>&nbsp;Implementar medidas para reducir el consumo de energía, como el uso de equipos eficientes y prácticas de conservación.<br><span style="font-weight: 700;">4. CONSERVACIÓN DE AGUA:</span>&nbsp;Adoptar prácticas de uso responsable del agua e implementar medidas para minimizar el consumo en procesos de sondeo.<br><span style="font-weight: 700;">5. PROTECCIÓN DE LA BIODIVERSIDAD:</span>&nbsp;Identificar áreas sensibles e implementar medidas para evitar la perturbación de hábitats naturales y ecosistemas.<br><span style="font-weight: 700;">6. CAPACITACIÓN Y CONCIENTIZACIÓN:</span>&nbsp;Realizar capacitaciones regulares para concienciar a los colaboradores sobre prácticas ambientales adecuadas y la importancia de la sostenibilidad.<br><span style="font-weight: 700;">7. MONITOREO AMBIENTAL:</span>&nbsp;Establecer sistemas de monitoreo para evaluar continuamente el desempeño ambiental de la empresa e identificar áreas de mejora.<br><span style="font-weight: 700;">8. MEJORA CONTINUA:</span>&nbsp;Revisar periódicamente el desempeño del SGA, identificar oportunidades de mejora y implementar acciones correctivas y preventivas.<br><br><span style="font-weight: 700;">COMPROMISO DE LA DIRECCIÓN:</span><br>La alta dirección de Support Solo Sondajes está comprometida en promover la implementación, mantenimiento y mejora continua del SGA. La liderazgo demuestra su compromiso con la sostenibilidad, proporcionando los recursos necesarios e incentivando la adopción de prácticas ambientalmente responsables.<br><br>Al implementar un Sistema de Gestión Ambiental, Support Solo Sondajes demuestra su compromiso con la protección del medio ambiente, mientras continúa ofreciendo servicios geológicos de alta calidad. El SGA garantiza que las operaciones de la empresa estén alineadas con principios de sostenibilidad y contribuyan positivamente a la salud del ecosistema y la comunidad.</p>
      </div>
    </section>
