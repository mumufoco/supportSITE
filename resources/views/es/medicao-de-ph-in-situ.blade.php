...
@section('lang', 'es')
@section('title', 'Medição de PH in-situ')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Medição-de-PH-in-situ.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">Medición PH in situ</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">Necesidad:</span> El pH del suelo y del agua subterránea es un parámetro químico fundamental para comprender procesos de corrosión, agresividad al concreto, comportamiento electroquímico de sistemas de aterramiento, movilidad de contaminantes y estabilidad de materiales enterrados.<br>Las mediciones realizadas solo en laboratorio pueden sufrir alteraciones debido al transporte, oxidación y cambios de temperatura. Por este motivo, la medición de pH in situ se vuelve esencial para garantizar la representatividad real de las condiciones ambientales en el momento de la investigación.<br>En obras de infraestructura, líneas de transmisión, fundaciones y estudios ambientales, ignorar el pH del medio es equivalente a diseñar materiales y soluciones sin conocer el grado de agresividad química del ambiente.<br><br><span style="font-weight: 700;">Objetivo:</span> La actividad tiene como objetivo determinar el potencial hidrogeniónico (pH) directamente en el lugar de interés, en suelo, agua superficial o agua subterránea, obteniendo valores confiables y representativos de las condiciones naturales del medio.<br>Los resultados subsidian decisiones técnicas relacionadas con la durabilidad de estructuras, protección anticorrosiva, elección de materiales, evaluación ambiental y clasificación de la agresividad del suelo.<br><br><span style="font-weight: 700;">Normas que regulan y orientan:</span> Las mediciones de pH in situ siguen normas técnicas y directrices reconocidas a nivel nacional e internacional, garantizando la estandarización y la trazabilidad:<br>NBR 6457 – Preparación de muestras de suelo para ensayos de caracterización (referencia complementaria)<br>NBR 9898 – Conservación y técnicas de muestreo de agua<br>NBR 15472 – Calidad del agua – Determinación del pH<br>ABNT NBR ISO 10523 – Calidad del agua – Determinación del pH<br>Standard Methods for the Examination of Water and Wastewater – APHA<br>ASTM D4972 – Método de prueba estándar para el pH de suelos<br>Estas normas orientan la calibración de los equipos, métodos de lectura y criterios de control de calidad.<br><br><span style="font-weight: 700;">Público objetivo:</span> La actividad es indicada para: Ingenieros civiles, geotécnicos y ambientales; Empresas de infraestructura y obras lineales; Diseñadores de sistemas de aterramiento y protección anticorrosiva; Empresas de geotecnia y sondeos; Consultorías ambientales y de licenciamiento; e Industrias con estructuras enterradas o en contacto con el suelo.<br><br><span style="font-weight: 700;">Descripción técnica de la actividad:</span> La medición de pH in situ se realiza por medio de un pHmetro portátil equipado con un electrodo combinado de vidrio, adecuado para uso en campo. Antes del inicio de las mediciones, el equipo se calibra con soluciones tampón estándar (generalmente pH 4,0; 7,0 y 10,0). Los procedimientos varían según el medio analizado:<br><br><span style="font-weight: 700;">Suelo:</span> el electrodo se inserta directamente en suelo húmedo o en una pasta suelo-agua preparada en el lugar, según la orientación normativa.<br><span style="font-weight: 700;">Agua superficial o subterránea:</span> la lectura se realiza directamente en el cuerpo de agua o en un recipiente limpio, inmediatamente después de la recolección, evitando alteraciones químicas.<br><br>Durante la prueba, se controlan factores como la temperatura, el tiempo de estabilización de la lectura y la limpieza del electrodo entre mediciones.<br>El valor de pH obtenido indica el grado de acidez, neutralidad o alcalinidad del medio, siendo un dato esencial para análisis de corrosividad, interacción suelo-estructura e impacto ambiental.<br><br><span style="font-weight: 700;">Diferencia técnica:</span> <br><span style="font-weight: 700;">Medición de pH in situ x Medición laboratorial:</span> Aunque son complementarias, las dos aproximaciones tienen objetivos distintos:<br><br><span style="font-weight: 700;">Medición de pH in situ:</span> Realizada directamente en el lugar de la investigación. Refleja las condiciones reales del medio en el momento de la medición.<br>Evita alteraciones químicas causadas por el transporte y el almacenamiento. Indicada para diagnósticos rápidos, decisiones de campo y estudios de agresividad inmediata. Es la "fotografía química" del ambiente.<br><span style="font-weight: 700;">Medición de pH en laboratorio:</span> Realizada en muestras transportadas y preparadas. Permite un mayor control de variables y repetibilidad. Puede presentar desviaciones en relación con las condiciones naturales del campo. Indicada para estudios comparativos y análisis complementarios. Es el "análisis clínico", preciso, pero distante del ambiente original.<br><br><span style="font-weight: 700;">Resumen de la actividad:</span> La medición de pH in situ es una actividad esencial para caracterizar el comportamiento químico del suelo y del agua en proyectos de ingeniería y estudios ambientales. Ejecutada con un pHmetro portátil debidamente calibrado, proporciona datos confiables sobre la agresividad del medio, auxiliando en la elección de materiales, en la protección de estructuras y en el cumplimiento de las exigencias normativas.<br>Se trata de una prueba simple en la ejecución, pero decisiva para garantizar la durabilidad, la seguridad y la sostenibilidad de las soluciones adoptadas.​</p>
      </div>
    </section>
