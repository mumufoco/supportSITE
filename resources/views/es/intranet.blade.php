...
@section('lang', 'es')
@section('title', 'Page Password Template')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Page-Password-Template.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-container-align-center u-section-1" id="block-1">
      <div class="u-align-left u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1"><span class="u-icon u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 96.668 96.668" style=""><use xlink:href="#svg-bd4a"></use></svg><svg class="u-svg-content" viewBox="0 0 96.668 96.668" x="0px" y="0px" id="svg-bd4a" style="enable-background:new 0 0 96.668 96.668;"><g><path d="M80.372,40.605h-5.7V26.338C74.672,11.815,62.856,0,48.334,0C33.811,0,21.996,11.815,21.996,26.338v14.267h-5.7
        ...
        <h2 class="u-text u-text-default u-text-1"> Página Protegida</h2><!--password_form-->
        <div class="u-form u-password-control u-form-1"><!--password_form_inner-->
          <form action="#" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" method="post">
            <div class="u-align-center u-form-group u-form-password u-label-top">
              <label for="password-4c82" class="u-form-control-hidden u-label"></label><!--password_form_input-->
              <input type="password" placeholder="Digite sua senha" id="password-4c82" name="password" class="u-border-2 u-input u-input-rectangle u-none u-input-1" autofocus="autofocus" required=""><!--/password_form_input-->
            </div><!--password_form_submit-->
            <div class="u-align-left u-form-group u-form-submit u-label-top">
              <input type="submit" value="submit" class="u-form-control-hidden">
              <div class="u-form-send-error u-form-send-message">A senha está incorreta.</div>
              <a href="#" class="u-active-palette-1-light-1 u-border-2 u-border-active-palette-1-light-1 u-border-hover-palette-1-light-1 u-border-palette-1-base u-btn u-btn-submit u-button-style u-hover-palette-1-light-1 u-palette-1-base u-btn-1">Enviar</a>
            </div><!--/password_form_submit-->
