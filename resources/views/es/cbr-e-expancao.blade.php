...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/CBR-e-Expanção.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ENSAYO DE CBR Y EXPANSIÓN - CBR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial de CBR (Relación de Soporte de California) y expansión es un procedimiento utilizado para evaluar la capacidad de soporte de un suelo subyacente, especialmente cuando se utiliza como material de base o subbase en pavimentos rodoviarios. El ensayo de CBR mide la relación entre la capacidad de soporte de un suelo y la capacidad de soporte de un material de referencia, generalmente una piedra triturada. Además, el ensayo evalúa la expansión del suelo bajo humedecimiento, que puede ser crítico en determinadas condiciones.<br><br>Aquí está una descripción general del ensayo de CBR y expansión:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Evaluar la capacidad de soporte de un suelo subyacente en relación con la capacidad de soporte de un material de referencia (piedra triturada) y medir la expansión del suelo bajo humedecimiento.<br><br><span style="font-weight: 700;">Equipos y Materiales:<br>1. Molde CBR;<br>2. Compactador Proctor (para determinar la densidad seca máxima);<br>3. Muestra de suelo;<br>4. Piedra triturada (material de referencia);<br>5. Penetrómetro CBR;<br>6. Varilla de expansión;<br>7. Plato de expansión;<br>8. Cámara de expansión;<br>9. Balanza de precisión;<br>10. Estufa;<br>11. Dispositivo de humedecimiento (puede ser un recipiente y agua)</span><br><br><span style="font-weight: 700;">Procedimiento:<br>1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo se recolecta y se seca al aire para eliminar el exceso de humedad. La muestra se tritura y se pasa por la criba de abertura 19 mm.<br><span style="font-weight: 700;">2. Determinación de la Densidad Seca Máxima:</span>&nbsp;Una porción de la muestra se compacta en capas en el molde CBR usando un compactador Proctor. La densidad seca máxima de la muestra se determina con base en el ensayo Proctor.<br><span style="font-weight: 700;">3. Ensayo de CBR:</span>&nbsp;La muestra compactada se satura con agua y, a continuación, se introduce el penetrómetro CBR en el suelo hasta una profundidad estándar. La carga necesaria para penetrar en el suelo se registra y se compara con la carga necesaria para penetrar en el material de referencia (piedra triturada). El resultado se expresa como el índice de CBR.<br><span style="font-weight: 700;">4. Ensayo de Expansión:</span>&nbsp;La muestra de suelo se utiliza para realizar el ensayo de expansión. La muestra se coloca en el plato de expansión dentro de la cámara de expansión, y se agrega agua gradualmente. La expansión del suelo se mide a través de la variación en la altura de la muestra.<br><span style="font-weight: 700;">5. Interpretación:</span>&nbsp;El resultado del ensayo de CBR se expresa como un porcentaje, indicando la capacidad de soporte del suelo en relación con la piedra triturada. Cuanto mayor es el valor de CBR, mayor es la capacidad de soporte del suelo. En el ensayo de expansión, la variación en la altura de la muestra de suelo después del humedecimiento se registra como una medida de la expansión.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El ensayo de CBR y expansión es importante para evaluar la idoneidad del suelo subyacente para soportar cargas de pavimentos rodoviarios y la posibilidad de expansión del suelo cuando se expone a la humedad.<br>En resumen, el ensayo laboratorial de CBR y expansión es una herramienta esencial para evaluar la capacidad de soporte y la expansión de suelos utilizados en pavimentos rodoviarios y otras aplicaciones de ingeniería geotécnica. Esto auxilia en la selección y diseño de materiales adecuados para la construcción de carreteras y pavimentos.​</p>
      </div>
    </section>
