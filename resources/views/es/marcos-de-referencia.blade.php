...
@section('lang', 'es')
@section('title', 'Marcos de Referência')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Marcos-de-Referência.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MARCO DE REFERENCIA - MR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">Un “marco de referencia” es un punto fijo o una estructura establecida en el terreno o en una superficie para servir como base o referencia en la marcación de agujeros, mediciones o otras actividades de campo. Él es utilizado para garantizar que las mediciones y marcaciones sean consistentes y precisas, ya que proporciona un punto de partida confiable e inmutable a partir del cual todas las demás mediciones son hechas.<br>En proyectos de ingeniería, construcción, geotecnia y otras áreas técnicas, el uso de marcos de referencia es fundamental para garantizar la precisión y la consistencia de las actividades de campo. Aquí está una descripción más detallada de cómo los marcos de referencia son utilizados:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Proporcionar un punto fijo o una estructura estable en el terreno o superficie que sirva como base confiable para la marcación de agujeros, mediciones o otras actividades de campo.<br><br><span style="font-weight: 700;">Tipos de Marcos de Referencia:</span><br><span style="font-weight: 700;">1. Estacas:</span>&nbsp;Estacas clavadas en el suelo, generalmente de madera, metal o concreto, pueden ser utilizadas como marcos de referencia. Ellas pueden ser marcadas con coordenadas o identificadores para facilitar la localización.<br><span style="font-weight: 700;">2. Pregos:</span>&nbsp;Pregos fijados en una superficie, como una pared o estructura, pueden servir como marcos de referencia para mediciones y marcaciones.<br><span style="font-weight: 700;">3. Bases de Concreto:</span>&nbsp;Bases sólidas de concreto pueden ser instaladas en el suelo o en una estructura para proporcionar puntos fijos de referencia.<br><span style="font-weight: 700;">4. Monumentos Geodésicos:</span>&nbsp;En levantamientos geodésicos, monumentos geodésicos son puntos fijos que son medidos y registrados con precisión para servir como referencia en levantamientos futuros.<br><span style="font-weight: 700;">5. Marcas en Rocas o Estructuras Naturales:</span>&nbsp;En áreas donde las rocas o estructuras naturales son permanentes y prominentes, ellas pueden ser utilizadas como marcos de referencia.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;Los marcos de referencia son esenciales para garantizar que las mediciones y marcaciones en proyectos de ingeniería sean consistentes y precisas. Ellos proporcionan un punto fijo e inmutable a partir del cual todas las demás mediciones pueden ser hechas, reduciendo errores e incertidumbres.<br><br>Procedimiento:<br><span style="font-weight: 700;">1. Selección del Lugar:</span>&nbsp;Elegir un lugar apropiado para el marco de referencia, considerando su estabilidad y visibilidad.<br><span style="font-weight: 700;">2. Instalación:</span>&nbsp;Instalar el marco de referencia de acuerdo con las prácticas aceptadas, garantizando que esté nivelado y fijo.<br><span style="font-weight: 700;">3. Marcación</span><span style="font-weight: 700;">:</span>&nbsp;Marcar el marco de referencia con información relevante, como coordenadas, identificadores únicos o otra información necesaria para identificación futura.<br><span style="font-weight: 700;">4. Interpretación:</span>&nbsp;Los marcos de referencia no necesitan ser interpretados, sino identificados y mantenidos para uso futuro. Ellos sirven como puntos fijos de base para todas las actividades de campo.<br><br><span style="font-weight: 700;">Importancia:</span>&nbsp;La utilización de marcos de referencia es fundamental para garantizar que las mediciones, marcaciones y levantamientos sean consistentes y precisos. Ellos proporcionan una base confiable para todas las actividades de campo y ayudan a evitar errores y discrepancias.<br>En resumen, los marcos de referencia son puntos fijos o estructuras establecidas en el terreno o superficie que sirven como base confiable para mediciones, marcaciones y actividades de campo. Ellos son esenciales para garantizar la precisión y consistencia en proyectos de ingeniería y levantamientos.</p>
      </div>
    </section>
