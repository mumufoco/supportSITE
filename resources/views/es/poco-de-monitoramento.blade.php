...
@section('lang', 'es')
@section('title', 'Poço de Monitoramento')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Poço-de-Monitoramento.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POZO DE MONITOREO - PM</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo con pozo de monitoreo es necesaria para recopilar muestras de agua subterránea y realizar mediciones del nivel del agua en un punto determinado. Esta prueba es fundamental para comprender las características del acuífero, monitorear la calidad del agua subterránea y evaluar las variaciones del nivel freático a lo largo del tiempo.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo con pozo de monitoreo es obtener información sobre el nivel del agua subterránea y, cuando sea aplicable, recopilar muestras para análisis de calidad del agua. Esto permite comprender las variaciones estacionales, las tendencias de recarga y descarga, la interacción entre las aguas superficiales y subterráneas, así como la calidad del agua en el acuífero.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo con pozo de monitoreo están relacionadas con procedimientos de monitoreo de agua subterránea y calidad del agua. Algunas normas que pueden ser relevantes incluyen:<br>ABNT NBR 15495-1:2018 – Pozos de monitoreo de agua subterránea – Parte 1: Método de prueba para instalación.<br>ABNT NBR 15495-2:2018 – Pozos de monitoreo de agua subterránea – Parte 2: Método de prueba para desarrollo.<br>ABNT NBR 15495-3:2018 – Pozos de monitoreo de agua subterránea – Parte 3: Método de prueba para purga y muestreo.<br>ABNT NBR 15495-4:2018 – Pozos de monitoreo de agua subterránea – Parte 4: Método de prueba para muestreo de agua subterránea.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;El público objetivo de la prueba de campo con pozo de monitoreo incluye ingenieros geotécnicos, hidrogeólogos, ingenieros civiles, geólogos, técnicos en geotecnia y profesionales involucrados en proyectos de gestión de agua subterránea y calidad del agua. Empresas de consultoría en hidrogeología, órganos gubernamentales, instituciones de investigación y empresas involucradas con recursos hídricos pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo con pozo de monitoreo implica las siguientes etapas:Instalación del Pozo:&nbsp;Un pozo de monitoreo se perfora en el suelo hasta alcanzar el acuífero de interés. El pozo se reviste para evitar derrumbes y garantizar la calidad del muestreo.<br><span style="font-weight: 700;">1. Instalación de Tubos y Filtros:</span>&nbsp;Tubos perforados o ranurados se insertan en el pozo, permitiendo que el agua del acuífero fluya hacia el pozo. Filtros se instalan para evitar la entrada de partículas sólidas en el pozo.<br><span style="font-weight: 700;">2. Mediciones y Recopilación de Muestras:</span>&nbsp;Las mediciones del nivel del agua se realizan periódicamente utilizando instrumentos específicos, como piezómetros. Muestras de agua subterránea pueden recopilarse para análisis laboratoriales.<br><span style="font-weight: 700;">3. Purga y Muestreo:</span>&nbsp;El proceso de purga implica la retirada de una cierta cantidad de agua del pozo antes de recopilar las muestras para garantizar que el agua sea representativa del acuífero.<br><span style="font-weight: 700;">4. Registro de Datos:</span>&nbsp;Todos los datos recopilados se registran, incluyendo profundidades, niveles de agua, parámetros de calidad del agua y otros aspectos relevantes.<br><span style="font-weight: 700;">5. Resultados y Aplicaciones:</span>&nbsp;Los resultados de la prueba de campo con pozo de monitoreo proporcionan información sobre el comportamiento del agua subterránea, la variación del nivel freático y la calidad del agua en el acuífero. Esta información es crucial para la gestión sostenible de los recursos hídricos subterráneos, la evaluación de impactos ambientales y la toma de decisiones en relación con proyectos que involucren agua subterránea.<br><br>En resumen, la prueba de campo con pozo de monitoreo es una técnica esencial en hidrogeología para recopilar información sobre agua subterránea y calidad del agua, así como monitorear las variaciones del nivel freático a lo largo del tiempo. Se utiliza por una variedad de profesionales y organizaciones involucradas en proyectos de gestión de agua subterránea y recursos hídricos, siguiendo las normas y procedimientos establecidos.​</p>
      </div>
    </section>
