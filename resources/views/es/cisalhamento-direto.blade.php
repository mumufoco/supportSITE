...
@section('lang', 'es')
@section('title', 'Cisalhamento Direto')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Cisalhamento-Direto.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">CISALHAMENTO DIRECTO - CD</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial de cisalhamento directo es un procedimiento utilizado para determinar las propiedades de resistencia al cisalhamento de suelos y otros materiales geotécnicos. Este ensayo es fundamental en la geotecnia y la ingeniería civil para comprender el comportamiento de materiales cuando se someten a fuerzas de cisalhamento, como las que ocurren en laderas, fundaciones y estructuras de contención.<br><br>Aquí está una descripción general del ensayo de cisalhamento directo:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Evaluar la resistencia al cisalhamento de un material, determinando su resistencia al deslizamiento bajo la acción de fuerzas de cisalhamento.<br><br><span style="font-weight: 700;">Equipos y Materiales:<br>1. Dispositivo de cisalhamento directo (generalmente compuesto por dos mitades de cajas que pueden moverse una en relación con la otra);<br>2. Muestra del material;<br>3. Dispositivo de aplicación de carga (mecánico, hidráulico o electrónico);<br>4. Balanzas de precisión;<br>5. Regla de medición;<br>6. Instrumentos de medición de deformación (extensómetros);<br>7. Muestra de saturación o agua;</span><br><br><span style="font-weight: 700;">Procedimiento:<br>1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo se recoge y se prepara de acuerdo con las dimensiones adecuadas para el dispositivo de cisalhamento directo.<br><span style="font-weight: 700;">2. Montaje de la Muestra:</span>&nbsp;La muestra se coloca entre las mitades del dispositivo de cisalhamento directo. A veces, se utiliza un material de saturación o agua en las interfaces para garantizar el confinamiento lateral.<br><span style="font-weight: 700;">3. Aplicación de Carga:</span>&nbsp;Se aplica una carga normal a las mitades de la muestra, simulando las condiciones de tensión vertical que ocurren en la práctica.<br><span style="font-weight: 700;">4. Aplicación de Carga de Cisalhamento:</span>&nbsp;Se aplica una fuerza de cisalhamento al sistema, moviendo una mitad de la muestra en relación con la otra. La fuerza de cisalhamento se aumenta gradualmente hasta que ocurre la falla.<br><span style="font-weight: 700;">5. Registro de Datos:</span>&nbsp;Durante el ensayo, se registran las cargas normales, las cargas de cisalhamento, los desplazamientos y la deformación.<br><span style="font-weight: 700;">6. Análisis de los Resultados:</span>&nbsp;A partir de los datos recogidos, es posible determinar la resistencia al cisalhamento del material, incluyendo el ángulo de fricción interno (ángulo de resistencia) y la cohesión, si es aplicable.<br><span style="font-weight: 700;">7. Interpretación:</span>&nbsp;Los resultados del ensayo de cisalhamento directo se presentan generalmente en un gráfico conocido como Envelope de Cisalhamento, que muestra la relación entre las tensiones normales y las tensiones de cisalhamento en el material.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El ensayo de cisalhamento directo es crucial para determinar las propiedades de resistencia al cisalhamento de los materiales geotécnicos. Esto es especialmente importante en proyectos de estructuras de contención, laderas, presas, fundaciones y otros casos donde las fuerzas de cisalhamento son relevantes.<br>En resumen, el ensayo laboratorial de cisalhamento directo es una herramienta esencial para evaluar la resistencia al cisalhamento de suelos y materiales geotécnicos, proporcionando información crucial para el diseño y análisis de estructuras y obras geotécnicas.​</p>
      </div>
    </section>
