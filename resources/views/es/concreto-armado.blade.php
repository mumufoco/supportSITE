...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Concreto-Armado.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTOS EN CONCRETO ARMADO</h2>
      </div>
    </section>
    <section class="u-clearfix u-res-move-started u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">LA ELABORACIÓN DE PROYECTOS EN CONCRETO ARMADO ES UN PROCESO FUNDAMENTAL PARA PROYECTAR Y CONSTRUIR ESTRUCTURAS DE CONCRETO REFORZADO CON ACERO, COMO EDIFICIOS, PUENTES, PRESAS Y OTRAS INFRAESTRUCTURAS. EL CONCRETO ARMADO ES UN MATERIAL AMPLIAMENTE UTILIZADO EN LA CONSTRUCCIÓN CIVIL DEBIDO A SU CAPACIDAD DE COMBINAR LA RESISTENCIA A LA COMPRESIÓN DEL CONCRETO CON LA RESISTENCIA A LA TRACCIÓN DEL ACERO. LA NECESIDAD DE ELABORAR PROYECTOS EN CONCRETO ARMADO ES EVIDENTE POR VARIOS MOTIVOS:<br><br><span style="font-weight: 700;">1. COMPORTAMIENTO MIXTO DE MATERIALES:</span> EL CONCRETO ARMADO COMBINA LAS CUALIDADES DEL CONCRETO Y DEL ACERO, APROVECHANDO LA ALTA RESISTENCIA A LA COMPRESIÓN DEL CONCRETO Y LA ALTA RESISTENCIA A LA TRACCIÓN DEL ACERO. EL PROYECTO DEFINE CÓMO ESOS DOS MATERIALES INTERACTÚAN PARA SOPORTAR LAS CARGAS Y PROPORCIONAR ESTABILIDAD.<br><span style="font-weight: 700;">2. EFICIA ESTRUCTURAL:</span> LA COMBINACIÓN DE CONCRETO Y ACERO PERMITE QUE LAS ESTRUCTURAS SEAN PROYECTADAS DE FORMA MÁS EFICAZ Y ECONÓMICA, MAXIMIZANDO LA UTILIZACIÓN DE CADA MATERIAL DONDE ELLO ES MÁS EFICAZ.<br><span style="font-weight: 700;">3. FLEXIBILIDAD DE DISEÑO:</span> EL CONCRETO ARMADO OFRECE UNA AMPLIA GAMA DE POSIBILIDADES DE DISEÑO, PERMITIENDO LA CREACIÓN DE FORMAS COMPLEJAS Y SOLUCIONES ARQUITECTÓNICAS VARIADAS.<br><span style="font-weight: 700;">4. RESISTENCIA A CARGAS Y ESFUERZOS:</span> LA ELABORACIÓN DE PROYECTOS EN CONCRETO ARMADO DEFINE CÓMO LA ESTRUCTURA SOPORTARÁ LAS CARGAS VERTICALES, COMO EL PESO DE LOS ELEMENTOS DE LA ESTRUCTURA Y LAS CARGAS IMPOSTAS, ASÍ COMO LOS ESFUERZOS HORIZONTALES, COMO EL VIENTO Y LOS SISMOS.<br><span style="font-weight: 700;">5. SEGURIDAD Y DURABILIDAD:</span> PROYECTOS EN CONCRETO ARMADO GARANTIZAN QUE LA ESTRUCTURA SEA SEGURA Y DURADERA, CONSIDERANDO FACTORES COMO FATIGA, CORROSIÓN Y DEGRADACIÓN A LO LARGO DEL TIEMPO.<br><span style="font-weight: 700;">6. DETALLE DE ARMADURAS:</span> EL PROYECTO EN CONCRETO ARMADO INCLUYE EL DETALLE PRECISO DE LAS BARRAS DE ACERO QUE SERÁN INCORPORADAS AL CONCRETO PARA PROPORCIONAR LA RESISTENCIA NECESARIA A LA TRACCIÓN.<br><span style="font-weight: 700;">7. NORMAS Y REGULAMENTACIONES:</span> LA ELABORACIÓN DE PROYECTOS EN CONCRETO ARMADO DEBE SEGUIR NORMAS Y REGULAMENTACIONES ESPECÍFICAS PARA GARANTIZAR LA CONFORMIDAD CON LOS PADRONES DE SEGURIDAD Y CALIDAD.<br><span style="font-weight: 700;">8. ANÁLISIS ESTRUCTURALES:</span> EL PROYECTO INCLUYE ANÁLISIS DETALLADOS DE LAS CARGAS APLICADAS, DISTRIBUCIÓN DE ESFUERZOS Y DEFORMACIONES ESPERADAS, GARANTIZANDO QUE LA ESTRUCTURA SEA CAPAZ DE RESISTIR A ESAS CONDICIONES.<br><span style="font-weight: 700;">9. DIMENSIONAMIENTO ADECUADO:</span> EL DIMENSIONAMIENTO DE LAS SECCIONES DE CONCRETO Y ACERO ES UNA PARTE CRUCIAL DEL PROYECTO PARA GARANTIZAR QUE LA ESTRUCTURA ATENDE A LOS REQUISITOS DE CAPACIDAD DE CARGA Y RESISTENCIA.<br><span style="font-weight: 700;">10. INTEGRACIÓN CON OTROS SISTEMAS:</span> LOS PROYECTOS EN CONCRETO ARMADO NECESITAN SER INTEGRADOS CON OTROS SISTEMAS DE LA ESTRUCTURA, COMO FUNDACIONES, LAJES, PAREDES Y ELEMENTOS DE SOPORTE.<br><span style="font-weight: 700;">11. CONSTRUCTIBILIDAD:</span> LA ELABORACIÓN DEL PROYECTO DEBE CONSIDERAR ASPECTOS CONSTRUCTIVOS PARA GARANTIZAR QUE LA ESTRUCTURA PUEDE SER CONSTRUIDA DE MANERA EFICAZ Y SEGURA EN EL CANTEIRO DE OBRAS.<br><br>EN RESUMEN, LA NECESIDAD DE ELABORAR PROYECTOS EN CONCRETO ARMADO ES FUNDAMENTAL PARA GARANTIZAR LA SEGURIDAD, LA EFICIA Y LA DURABILIDAD DE LAS ESTRUCTURAS DE CONCRETO REFORZADO. ESTO ENVUELVE ANÁLISIS DETALLADOS, DIMENSIONAMIENTO ADECUADO Y ESPECIFICACIONES PRECISAS PARA ASEGURAR QUE LA ESTRUCTURA SEA CAPAZ DE SOPORTAR LAS CARGAS Y LOS ESFUERZOS ESPERADOS A LO LARGO DE SU VIDA ÚTIL.</p>
      </div>
    </section>
