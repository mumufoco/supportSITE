...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Dosagem.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.dosagem') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Dosagem.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Dosagem.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ESTUDIO DE DOSIFICACIÓN - DOSIFICACIÓN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">EL ENSAYO LABORATORIAL DE ESTUDIO DE DOSIFICACIÓN ES UN PROCEDIMIENTO UTILIZADO PARA DETERMINAR LA PROPORCIÓN IDEAL DE MATERIALES QUE COMPONEN UNA MEZCLA, COMO HORMIGÓN, MORTERO, ASFALTO O SUELOS ESTABILIZADOS. ESTE ENSAYO ES FUNDAMENTAL EN LA INGENIERÍA CIVIL PARA DESARROLLAR MEZCLAS CON PROPIEDADES ESPECÍFICAS QUE ATiENDAN A LOS REQUISITOS DE RESISTENCIA, DURABILIDAD, TRABAJABILIDAD Y OTRAS CARACTERÍSTICAS DESEADAS.<br><br>AKÍ SE PRESENTA UNA DESCRIPCIÓN GENERAL DEL ENSAYO DE ESTUDIO DE DOSIFICACIÓN:<br><br><span style="FONT-WEIGHT: 700;">OBJETIVO:</span>&amp;NBSP;DETERMINAR LA PROPORCIÓN ADECUADA DE MATERIALES PARA CREAR UNA MEZCLA CON LAS PROPIEDADES DESEADAS, COMO RESISTENCIA, DURABILIDAD, TRABAJABILIDAD, ENTRE OTROS.<br><br><span style="FONT-WEIGHT: 700;">EQUIPOS Y MATERIALES:<br>1. MATERIALES CONSTITUYENTES DE LA MEZCLA (CEMENTO, ÁRIDOS, AGUA, ADITIVOS, ETC.);<br>2. EQUIPOS DE MEDICIÓN DE MASA (BALANZAS);<br>3. EQUIPOS DE MEDICIÓN DE VOLUMEN (CUBOS, PROBetaS);<br>4. MEZCLADOR;<br>5. MOLDES O EQUIPOS PARA MOLDEAR (DEPENDIENDO DE LA APLICACIÓN);<br>6. EQUIPOS PARA ENSAYOS DE RESISTENCIA, TRABAJABILIDAD, ENTRE OTROS (DEPENDIENDO DE LA APLICACIÓN);</span><br><br><span style="FONT-WEIGHT: 700;">PROCEDIMIENTO:<br>1. DEFINICIÓN DE LOS REQUISITOS:</span>&amp;NBSP;CON BASE EN LAS CARACTERÍSTICAS DESEADAS DE LA MEZCLA (COMO RESISTENCIA, DURABILIDAD, TRABAJABILIDAD), SE DEFINEN LOS REQUISITOS Y CRITERIOS A SER ATENDIDOS.<br><span style="FONT-WEIGHT: 700;">2. SELECCIÓN DE MATERIALES:</span>&amp;NBSP;SE SELECCIONAN LOS MATERIALES QUE COMPONDRÁN LA MEZCLA, COMO CEMENTO, ÁRIDOS (ARENA, BRITA), AGUA Y POSIBLES ADITIVOS.<br><span style="FONT-WEIGHT: 700;">3. DOSIFICACIÓN INICIAL:</span>&amp;NBSP;SE REALIZAN ENSAYOS PRELIMINARES CON DIFERENTES PROPORCIONES DE MATERIALES PARA DETERMINAR UNA DOSIFICACIÓN INICIAL.<br><span style="FONT-WEIGHT: 700;">4. PREPARACIÓN DE LAS MUESTRAS:</span>&amp;NBSP;LA DOSIFICACIÓN INICIAL SE MEZCLA DE ACUERDO CON UN PROCEDIMIENTO PATRONIZADO. EN EL CASO DEL HORMIGÓN O MORTERO, POR EJEMPLO, LOS MATERIALES SE MEZCLAN EN UN MEZCLADOR HASTA QUE SE OBTIENE UNA HOMOGENEIDAD.<br><span style="FONT-WEIGHT: 700;">5. ENSAYOS:</span>&amp;NBSP;LAS MUESTRAS PREPARADAS SE SOMETEN A ENSAYOS ESPECÍFICOS PARA EVALUAR SUS PROPIEDADES, COMO RESISTENCIA A LA COMPRESIÓN, RESISTENCIA A LA FLEXIÓN, TRABAJABILIDAD, ENTRE OTROS, DE ACUERDO CON LOS REQUISITOS DEFINIDOS.<br><span style="FONT-WEIGHT: 700;">6. AJUSTES EN LA DOSIFICACIÓN:</span>&amp;NBSP;CON BASE EN LOS RESULTADOS DE LOS ENSAYOS, LA DOSIFICACIÓN SE AJUSTA, AUMENTANDO O REDUCIENDO LA CANTIDAD DE CIERTOS MATERIALES, COMO CEMENTO, AGUA O ADITIVOS, PARA ATENDER A LOS REQUISITOS DESEADOS.<br><span style="FONT-WEIGHT: 700;">7. CONFIRMACIÓN DE LA DOSIFICACIÓN:</span>&amp;NBSP;EL PROCESO DE AJUSTE Y ENSAYO SE REPITE HASTA QUE LA MEZCLA ATINJA LAS PROPIEDADES DESEADAS Y ATiENDA A LOS REQUISITOS.<br><span style="FONT-WEIGHT: 700;">8. INTERPRETACIÓN:</span>&amp;NBSP;LA INTERPRETACIÓN DE LOS RESULTADOS IMPLICA ANALIZAR LAS PROPIEDADES DE LA MEZCLA EN RELACIÓN CON LOS REQUISITOS ESTABLECIDOS. POR EJEMPLO, EN EL CASO DEL HORMIGÓN, SE VERIFICA SI LA RESISTENCIA A LA COMPRESIÓN, TRABAJABILIDAD Y OTRAS CARACTERÍSTICAS ESTÁN DENTRO DE LAS ESPECIFICACIONES.<br><br><span style="FONT-WEIGHT: 700;">UTILIDAD:</span>&amp;NBSP;EL ENSAYO DE ESTUDIO DE DOSIFICACIÓN ES FUNDAMENTAL PARA LA CREACIÓN DE MEZCLAS CON PROPIEDADES ESPECÍFICAS QUE ATiENDAN A LAS NECESIDADES DE LOS PROYECTOS DE INGENIERÍA. ESTO SE APLICA EN DIFERENTES ÁREAS, COMO HORMIGÓN ESTRUCTURAL, MORTEROS, ASFALTO Y SUELOS ESTABILIZADOS.<br>EN RESUMEN, EL ENSAYO LABORATORIAL DE ESTUDIO DE DOSIFICACIÓN ES UNA HERRAMIENTA ESSENCIAL EN LA INGENIERÍA CIVIL PARA DESARROLLAR MEZCLAS CON CARACTERÍSTICAS ESPECÍFICAS. ESTO PERMITE ATENDER A LOS REQUISITOS DE PROYECTOS DE CONSTRUCCIÓN Y INFRAESTRUCTURA, GARANTIZANDO LA CALIDAD Y EL DESEMPEÑO DESEADOS DE LAS MEZCLAS UTILIZADAS.</p>
      </div>
    </section>
