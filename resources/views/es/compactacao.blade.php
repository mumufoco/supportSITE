...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Compactação.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Compactação.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Compactação.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Compactação.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ENSAYO DE COMPACTACIÓN - COMP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial de compactación es un procedimiento fundamental en la geotecnia y la ingeniería civil para evaluar las características de compactación de suelos, especialmente aquellos que serán utilizados en obras de ingeniería, como bases de carreteras, rellenos y cimentaciones. El ensayo de compactación busca determinar la relación entre el contenido de humedad de un suelo y su densidad después de someterse a un proceso de compactación controlado.<br><br>Aquí está una descripción general del ensayo de compactación:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Evaluar las características de compactación de un suelo y determinar la relación entre el contenido de humedad y la densidad seca de un suelo compactado.<br><br><span style="font-weight: 700;">Equipos y Materiales:</span><br><span style="font-weight: 700;">1. Moldes de compactación (cilíndricos o cúbicos);<br>2. Compactador de muestra (martillo o prensa);<br>3. Muestra de suelo;<br>4. Balanza de precisión;<br>5. Estufa;<br>6. Cronómetro;</span><br><br><span style="font-weight: 700;">Procedimiento:<br>1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo se recoge y se seca al aire para eliminar el exceso de humedad. La muestra se tritura y se pasa por una criba de abertura 4,75 mm para eliminar partículas más grandes.<br><span style="font-weight: 700;">2. Determinación del Contenido de Humedad Inicial:</span>&nbsp;Una porción de la muestra se pesa y se coloca en una estufa a una temperatura específica (generalmente alrededor de 110°C) hasta alcanzar un peso constante, determinando así el contenido de humedad inicial.<br><span style="font-weight: 700;">3. Preparación de las Muestras:</span>&nbsp;Diferentes porciones de la muestra se mezclan con diferentes contenidos de humedad (generalmente 2 a 4% por encima y por debajo del contenido de humedad óptimo) para crear muestras húmedas.<br><span style="font-weight: 700;">4. Compactación de las Muestras:</span>&nbsp;Las muestras húmedas se colocan en los moldes de compactación, en capas uniformes, y se compactan utilizando un compactador de muestra, que puede ser un martillo con peso o una prensa mecánica. Cada capa se compacta con un número específico de golpes.<br><span style="font-weight: 700;">5. Desmoldado y Pesado:</span>&nbsp;Las muestras compactadas se desmoldan y se pesan.<br><span style="font-weight: 700;">6. Determinación del Contenido de Humedad Final:</span>&nbsp;Una porción de la muestra compactada se pesa y se coloca en una estufa para determinar su contenido de humedad final.<br><span style="font-weight: 700;">7. Cálculos:</span>&nbsp;Con base en las masas y los contenidos de humedad, es posible calcular la densidad seca de las muestras compactadas.<br><span style="font-weight: 700;">8. Interpretación:</span>&nbsp;Los resultados del ensayo se presentan generalmente en un gráfico llamado Curva de Compactación, que muestra la relación entre el contenido de humedad y la densidad seca del suelo compactado. A partir de esta curva, es posible identificar el contenido de humedad óptimo para alcanzar la máxima densidad seca.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El ensayo de compactación es fundamental para la optimización del contenido de humedad en suelos para fines de construcción. Ayuda a determinar la máxima densidad que un suelo puede alcanzar bajo ciertas condiciones de compactación, auxiliando en la elección del contenido de humedad ideal para la construcción de estructuras geotécnicas.<br>En resumen, el ensayo laboratorial de compactación es una herramienta crucial para evaluar las características de compactación de suelos, proporcionando información esencial para proyectos de ingeniería geotécnica y construcción.​</p>
      </div>
    </section>
