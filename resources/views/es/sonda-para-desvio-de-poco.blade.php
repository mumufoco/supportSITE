...
@section('lang', 'es')
@section('title', 'Sonda para Desvio de Poço')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sonda-para-Desvio-de-Poço.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​SONDA PARA DESVIO DE POÇO</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​Usado para determinar o caminho de perfuração exato de um poço.&nbsp;<br><br>A perfuração perto de infraestrutura, como cabos ou túneis, pode ser inspecionada antes de atingir um ponto crítico.&nbsp;Outra aplicação desse método é no controle de qualidade de poços de água, garantindo que os critérios de desvio e curvatura do poço sejam atendidos para que problemas com o rebaixamento de bombas e outros equipamentos possam ser evitados.<br><br>O software de processamento permite que as coordenadas xyz exatas de qualquer ponto dentro do poço sejam determinadas.&nbsp;A trajetória calculada pode ser representada graficamente na forma de seções verticais, vistas de cima, tridimensionalmente ou qualquer combinação delas.</p>
      </div>
    </section>
