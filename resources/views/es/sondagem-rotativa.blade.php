...
@section('lang', 'es')
@section('title', 'Sondagem Rotativa')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-Rotativa.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​SONDAGEM ROTATIVA - SR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">Necessidade:</span>&nbsp;O ensaio de campo de sondagem rotativa é necessário para obter informações detalhadas sobre as características do solo e das rochas em profundidades subsuperficiais. Essas informações são fundamentais para projetos de engenharia geotécnica, como a avaliação da estabilidade de encostas, projetos de fundações profundas, identificação de camadas geológicas e outras aplicações que requerem conhecimento preciso do subsolo.<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;O principal objetivo do ensaio de campo de sondagem rotativa é obter amostras contínuas de solo e rocha para análise geotécnica e geológica. Esse ensaio fornece informações detalhadas sobre a estrutura geológica, características físicas, propriedades mecânicas e outras propriedades relevantes que são cruciais para o projeto e a construção de estruturas geotécnicas.<br><br><span style="font-weight: 700;">Normas Brasileiras:</span>&nbsp;As normas brasileiras que tratam do ensaio de campo de sondagem rotativa são:<br>ABNT NBR 11682:2018 – Investigação Geotécnica – Sondagens de Simples Reconhecimento com SPT (Standard Penetration Test) – Procedimento.<br>ABNT NBR 11683:2018 – Investigação Geotécnica – Sondagens de Simples Reconhecimento com SPT (Standard Penetration Test) – Diretrizes.<br>ABNT NBR 9603:1986 – Projeto e Execução de Sondagens de Simples Reconhecimento dos Solos para Fundações de Edifícios.<br>ABNT NBR 8044:1983 – Sondagens de Simples Reconhecimento dos Solos – Coleta de Amostras Indeformadas – Método de Ensaio.<br><br><span style="font-weight: 700;">Público-Alvo:</span>&nbsp;O público-alvo do ensaio de campo de sondagem rotativa inclui engenheiros geotécnicos, engenheiros de minas, geólogos, geofísicos e outros profissionais envolvidos em projetos que necessitam de informações precisas sobre o subsolo e as rochas. Empresas de engenharia, empresas de mineração, consultorias geotécnicas e outros segmentos relacionados podem utilizar os resultados desses ensaios.<br><br><span style="font-weight: 700;">Técnica:</span>&nbsp;A técnica do ensaio de campo de sondagem rotativa envolve as seguintes etapas:<br><span style="font-weight: 700;">1. Instalação da Sonda:</span>&nbsp;Uma sonda rotativa é instalada no local de sondagem. A sonda é equipada com uma broca rotativa que penetra no solo ou na rocha.<br><span style="font-weight: 700;">2. Perfuração Rotativa:</span>&nbsp;A broca rotativa gira enquanto penetra no solo ou na rocha. À medida que a perfuração avança, as amostras são coletadas e extraídas do furo.<br><span style="font-weight: 700;">3. Coleta de Amostras:</span>&nbsp;As amostras retiradas da perfuração são coletadas em barris especiais para preservar sua integridade. Essas amostras podem ser analisadas em laboratório para determinar características físicas, composição mineralógica e outras propriedades.<br><span style="font-weight: 700;">4. Registro de Dados:</span>&nbsp;Durante a perfuração, os dados são registrados, incluindo a profundidade da perfuração, as características das amostras, a resistência do solo/rocha e outras informações relevantes.<br><span style="font-weight: 700;">5. Testes In Situ:</span>&nbsp;Além da coleta de amostras, ensaios in situ podem ser realizados, como ensaios de permeabilidade, ensaios de pressão de água, entre outros.<br><br><span style="font-weight: 700;">Interpretação:</span>&nbsp;As amostras coletadas e os dados registrados durante o ensaio de campo de sondagem rotativa fornecem informações detalhadas sobre a estrutura geológica, a resistência, as propriedades físicas e mecânicas do solo e da rocha. Esses dados são essenciais para a elaboração de projetos geotécnicos e de engenharia.<br>Em resumo, o ensaio de campo de sondagem rotativa é uma técnica avançada na engenharia geotécnica que fornece informações detalhadas sobre o subsolo e as rochas em profundidades substanciais. Ele é utilizado por uma variedade de profissionais e organizações envolvidos em projetos geotécnicos e de engenharia, seguindo as normas estabelecidas.​</p>
      </div>
    </section>
