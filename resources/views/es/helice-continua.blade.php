...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Hélice-Continua.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">EJECUCIÓN DE PERFORACIÓN HÉLICE CONTINUA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">La estaca hélice continua es un método de fundación profunda que presenta características y ventajas distintas en comparación con otros métodos de fundación, como estacas clavadas, estacas tipo Strauss, estacas moldeadas "in loco" y estacas pre moldeadas. Aquí están los servicios y ventajas de la estaca hélice continua en relación con otros métodos:<br><br><span style="font-weight: 700;">Descripción de los servicios de estaca hélice continua:</span><br><br><span style="font-weight: 700;">1. Perforación e Inyección:</span> La estaca hélice continua es formada por medio de perforación del suelo utilizando un taladro helicoidal. Concomitantemente con la perforación, concreto o mortero es inyectado a través del eje del taladro. Esto crea una estaca continua con formato helicoidal.<br><span style="font-weight: 700;">2. Control de Calda:</span> La presión y la cantidad de concreto inyectado son controladas durante todo el proceso para garantizar la calidad de la estaca.<br><span style="font-weight: 700;">3. Diámetro Variable:</span> El diámetro de la estaca puede ser ajustado según las especificaciones del proyecto y las características del suelo.<br><span style="font-weight: 700;">4. Armadura Opcional:</span> Puede agregarse armadura de acero para aumentar la capacidad de carga de la estaca, cuando sea necesario.<br><br><span style="font-weight: 700;">Ventajas de la estaca hélice continua sobre otros métodos de fundación:</span><br><br><span style="font-weight: 700;">1. Menos Impacto Ambiental:</span> La estaca hélice continua genera menos vibraciones y ruidos en comparación con estacas clavadas, lo que es ventajoso en áreas urbanas sensibles.<br><span style="font-weight: 700;">2. Versatilidad en Suelos:</span> Este método es adecuado para una variedad de tipos de suelo, incluyendo arena, arcilla y roca blanda, a diferencia de otros métodos que pueden ser limitados por ciertas condiciones de suelo.<br><span style="font-weight: 700;">3. Velocidad de Ejecución:</span> La estaca hélice continua es generalmente más rápida de instalar que estacas moldeadas "in loco", ahorrando tiempo y recursos.<br><span style="font-weight: 700;">4. Menos Generación de Residuos:</span> Comparado con estacas pre moldeadas, la estaca hélice continua produce menos residuos debido al proceso continuo de perforación e inyección.<br><span style="font-weight: 700;">5. Adaptación a Espacios Limitados:</span> La estaca hélice continua puede ser utilizada en lugares con acceso limitado, mientras que otros métodos pueden exigir más espacio.<br><span style="font-weight: 700;">6. Estabilidad durante la Perforación:</span> La hélice actúa como escora durante la perforación, aumentando la estabilidad del agujero y reduciendo el riesgo de colapso del suelo.<br><span style="font-weight: 700;">7. Capacidad de Carga Controlada:</span> El diámetro de la hélice y la tasa de inyección de concreto pueden ser ajustados para controlar la capacidad de carga de la estaca.<br><span style="font-weight: 700;">8. No Requiere Rebaixamento de Agua:</span> A diferencia de estacas clavadas, por ejemplo, la estaca hélice continua generalmente no requiere rebaixamento del lençol freático.<br><span style="font-weight: 700;">9. Sostenibilidad:</span> El método consume menos energía en comparación con otros métodos, siendo más sostenible.<br><span style="font-weight: 700;">10. Bajo Riesgo de Daños a Estructuras Próximas:</span> Debido a la baja generación de vibraciones, la estaca hélice continua presenta menor riesgo de causar daños a estructuras adyacentes.<br><br>En resumen, la estaca hélice continua ofrece varias ventajas en relación con otros métodos de fundación, como la versatilidad en suelos variados, el menor impacto ambiental, la velocidad de ejecución y la menor generación de residuos. La elección del método de fundación dependerá de las características del proyecto, las condiciones del suelo y los objetivos específicos de construcción.</p>
      </div>
    </section>
