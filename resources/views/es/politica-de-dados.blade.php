...
@section('lang', 'es')
@section('title', 'Política de Dados')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-de-Dados.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Política-de-Dados.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Política-de-Dados.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Política-de-Dados.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POLÍTICA DE PRIVACIDAD DE DATOS</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">POLÍTICA DE PRIVACIDAD DE DATOS</span> describe cómo Support Solo Sondagens recopila, utiliza, protege y divulga la información personal recopilada a través de su sitio web. Al utilizar este sitio web, usted acepta las prácticas descritas en esta política.<br><br><span style="font-weight: 700;">1. Recopilación de información:</span><br>Información personal: Podemos recopilar información personal, como nombre, dirección de correo electrónico, número de teléfono, cuando usted llena formularios de contacto o suscripción de boletín en nuestro sitio web.<br><br><span style="font-weight: 700;">2. Información de navegación:</span><br>Podemos recopilar información no personal, como dirección IP, tipo de navegador, sistema operativo y páginas visitadas, para análisis de tendencias y mejoras en el sitio web.<br><br><span style="font-weight: 700;">3. Uso de la información:</span><br><span style="font-weight: 700;">3.1. Comunicaciones:</span> Utilizamos la información proporcionada para responder a consultas, proporcionar información sobre nuestros servicios, enviar boletines (si se ha dado consentimiento) y mantener la comunicación con los visitantes del sitio web.<br><span style="font-weight: 700;">3.2. Mejora del sitio web:</span> La información recopilada nos ayuda a mejorar la experiencia del usuario en el sitio web, ajustándolo a las preferencias y necesidades de los visitantes.<br><br><span style="font-weight: 700;">4. Protección de datos:</span><br><span style="font-weight: 700;">4.1. Seguridad:</span> Implementamos medidas de seguridad para proteger su información personal contra acceso no autorizado, uso indebido o divulgación.<br><br><span style="font-weight: 700;">5. Almacenamiento:</span><br>La información recopilada se almacena en servidores seguros y solo es accesible para personas autorizadas con necesidad de acceso.<br><br><span style="font-weight: 700;">6. Divulgación de información:</span><br><span style="font-weight: 700;">6.1. Terceros:</span> No compartimos información personal con terceros, excepto cuando sea necesario para cumplir solicitudes de servicios (por ejemplo, envío de boletines).<br><span style="font-weight: 700;">6.2. Requisitos legales:</span> Podemos divulgar información personal en respuesta a solicitudes legales o cumplimiento de leyes aplicables.<br><br><span style="font-weight: 700;">7. Cookies:</span><br>Cookies: El sitio web utiliza cookies para mejorar la experiencia del usuario y recopilar información no personal. Los visitantes pueden ajustar sus configuraciones de navegador para gestionar el uso de cookies.<br><br><span style="font-weight: 700;">8. Derechos del titular de los datos:</span><br>Los visitantes tienen derecho a acceder, corregir, actualizar y eliminar sus información personal. Para ejercer estos derechos o retirar consentimientos, póngase en contacto con nosotros a través de la información proporcionada a continuación.<br><br><span style="font-weight: 700;">9. Cambios en la política:</span><br>Reservamos el derecho de actualizar esta Política de Privacidad periódicamente para reflejar las prácticas y exigencias actuales. Recomendamos que los visitantes revisen esta política regularmente para mantenerse informados.<br><br><span style="font-weight: 700;">10. Contacto:</span><br>Si usted tiene alguna duda o preocupación sobre esta Política de Privacidad, o sobre nuestras prácticas de privacidad, póngase en contacto con nosotros:<br>Empresa Support Solo Sondagens<br>Dirección: Av. T-4, 619 – St. Bueno, Goiânia – GO, 74230-035<br>Correo electrónico: contacto@supportsondagens.com.br Teléfono: 62 9 91906100<br><br>Esta Política de Privacidad de Datos es efectiva a partir de la fecha 01 de enero de 2026 y se aplica al uso continuo del sitio web de Support Solo Sondagens.</p>
      </div>
    </section>
