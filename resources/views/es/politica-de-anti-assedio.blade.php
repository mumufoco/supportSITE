...
@section('lang', 'es')
@section('title', 'Política de Anti-Assedio')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-de-Anti-Assedio.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.politica-de-anti-assedio') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Política-de-Anti-Assedio.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Política-de-Anti-Assedio.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POLÍTICA DE ANTI-ACOSO Y DISCRIMINACIÓN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">​​</span><span style="font-weight: 700;">INTRODUCCIÓN:</span><br>La Support Solo Sondeos está comprometida en mantener un ambiente de trabajo seguro, respetuoso e inclusivo para todos sus colaboradores. Esta política tiene como objetivo prevenir y eliminar todas las formas de acoso y discriminación, promoviendo una cultura organizacional que valore la diversidad y la igualdad de oportunidades.<br><br><span style="font-weight: 700;">DEFINICIONES:</span><br><span style="font-weight: 700;">1. ACOSO: </span>​​Cualquier comportamiento, gesto, expresión verbal o física, repetitiva o sistemática, que tenga por objetivo o produzca el efecto de constreñir, amenazar, intimidar o perjudicar la dignidad de un colaborador.<br><span style="font-weight: 700;">2. DISCRIMINACIÓN: </span>​​Tratar a un colaborador de forma desigual o injusta con base en características como género, raza, orientación sexual, religión, edad, discapacidad, nacionalidad, entre otros.<br><br><span style="font-weight: 700;">COMPROMISO DE LA EMPRESA:</span><br>La Support Solo Sondeos: No tolerará cualquier forma de acoso o discriminación en sus instalaciones o en lugares de trabajo relacionados.<br>Investigará inmediatamente cualquier alegación de acoso o discriminación, y tomará medidas correctivas apropiadas conforme sea necesario.<br>Garantizará que ningún colaborador sufra represalias por presentar una queja legítima de acoso o discriminación.<br><br><span style="font-weight: 700;">RESPONSABILIDADES DE LOS COLABORADORES:</span><br>Todos los colaboradores de la Support Solo Sondeos tienen la responsabilidad de: Respetar a los colegas de trabajo, clientes y socios, evitando cualquier forma de comportamiento inadecuado o discriminación.<br>Informar inmediatamente cualquier incidente de acoso o discriminación a un supervisor, gerente o al departamento de Recursos Humanos.<br>Colaborar durante las investigaciones internas, proporcionando información precisa y honesta, para garantizar que se tomen las medidas apropiadas.<br><br><span style="font-weight: 700;">PROCEDIMIENTO DE QUEJA:</span><br>Todas las quejas de acoso o discriminación serán tratadas de forma confidencial y imparcial.<br>La Support Solo Sondeos se compromete a realizar investigaciones minuciosas y a tomar medidas correctivas, que pueden incluir advertencias, suspensiones o rescisión del contrato de trabajo, conforme a la gravedad de la situación.<br><br><span style="font-weight: 700;">CONSECUENCIAS DEL INCUMPLIMIENTO:</span><br>El incumplimiento de esta política puede resultar en medidas disciplinarias, incluyendo advertencias, suspensiones o rescisión del contrato de trabajo.<br>Esta política es parte integrante de la cultura organizacional de la Support Solo Sondeos. Todos los colaboradores son animados a familiarizarse con sus términos y a contribuir a la promoción de un ambiente de trabajo saludable y respetuoso.</p>
      </div>
    </section>
