...
@section('lang', 'es')
@section('title', 'Poço de Inspeção de Pavimento')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Poço-de-Inspeção-de-Pavimento.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POZO DE INSPECCIÓN DE PAVIMENTO - PI</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo pozo de inspección de pavimento es necesaria para evaluar la condición de las capas del pavimento y del sublecho en carreteras, autopistas y pistas de tráfico. Esta evaluación es fundamental para determinar la integridad estructural del pavimento, identificar defectos, realizar mantenimiento adecuado y planificar intervenciones de rehabilitación.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo pozo de inspección de pavimento es obtener información visual, estructural y geotécnica sobre las capas del pavimento y del sublecho. Esto permite evaluar la capacidad de soporte del pavimento, la presencia de grietas, deformaciones y otros defectos, así como identificar la necesidad de reparos o refuerzos.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo pozo de inspección de pavimento están relacionadas con pruebas de pavimento, investigación de defectos y calidad de pavimentos. Algunos ejemplos de normas que pueden ser relevantes incluyen:<br>DNIT 005/2003 – Método de Ensayo – Sondeo de Simples Reconocimiento del Pavimento (Pozo de Inspección).<br>DNIT 013/2004 – Procedimiento para Levantamiento de Datos de Pavimento.<br>DNIT 014/2004 – Manual de Inspección Visual de Pavimentos Asfálticos.<br><br><span style="font-weight: 700;">PÚBLICO-OBJETIVO:</span>&nbsp;El público-objetivo de la prueba de campo pozo de inspección de pavimento incluye ingenieros de pavimentación, ingenieros civiles, técnicos en infraestructura, gestores de carreteras y autopistas, órganos de tráfico y transporte, así como contratistas involucrados en la construcción y mantenimiento de pavimentos.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo pozo de inspección de pavimento implica las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span>&nbsp;El lugar de inspección se elige según criterios preestablecidos, teniendo en cuenta la extensión de la carretera, el tipo de pavimento y otros factores relevantes.<br><span style="font-weight: 700;">2. APERTURA DEL POZO:</span>&nbsp;Un pozo se abre en el pavimento mediante corte o remoción de parte de la capa asfáltica. El tamaño y la profundidad del pozo dependen de las necesidades de evaluación.<br><span style="font-weight: 700;">3. INSPECCIÓN VISUAL:</span>&nbsp;La inspección visual se realiza para observar las capas del pavimento y del sublecho. Se registran defectos como grietas, desplazamientos, deformaciones y otros signos de deterioro.<br><span style="font-weight: 700;">4. COLECCIÓN DE MUESTRAS:</span>&nbsp;Muestras de las capas del pavimento pueden ser colectadas para análisis en laboratorio, incluyendo análisis de granulometría, teoría de humedad y otras características.<br><span style="font-weight: 700;">5. EVALUACIÓN GEOTÉCNICA:</span>&nbsp;Dependiendo de las necesidades, pueden ser realizados ensayos geotécnicos en el sublecho para evaluar su capacidad de soporte.<br><span style="font-weight: 700;">6. REGISTRO DE DATOS:</span>&nbsp;Todos los datos obtenidos durante la inspección se registran, incluyendo fotografías, dibujos esquemáticos, notas y observaciones relevantes.<br><span style="font-weight: 700;">7. INTERPRETACIÓN:</span>&nbsp;El análisis de los datos obtenidos en la prueba de campo pozo de inspección de pavimento permite determinar la condición del pavimento, identificar defectos y evaluar la necesidad de intervenciones. Esta información es esencial para la planificación de obras de mantenimiento, rehabilitación o reconstrucción de pavimentos.<br><br>En resumen, la prueba de campo pozo de inspección de pavimento es una técnica importante en la ingeniería de pavimentos para evaluar la condición de las capas del pavimento y del sublecho en carreteras y autopistas. Se utiliza por una variedad de profesionales y organizaciones involucradas en la construcción y mantenimiento de pavimentos, siguiendo las normas establecidas.​</p>
      </div>
    </section>
