...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-Mista.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​SONDAGEM MISTA - SM</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">Necessidade:</span>&nbsp;O ensaio de campo de sondagem mista é necessário para obter informações detalhadas sobre as características do solo e das rochas em profundidades substanciais. Esse tipo de sondagem combina os métodos de sondagem rotativa e de percussão, permitindo coletar amostras de diferentes materiais geológicos e obter informações abrangentes para projetos de engenharia geotécnica e de construção.<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;O principal objetivo do ensaio de campo de sondagem mista é obter dados precisos sobre as características físicas, geotécnicas e geológicas do subsolo e das rochas. Esse ensaio permite avaliar a estrutura geológica, a resistência, a composição e outras propriedades importantes para projetos de fundações, estabilidade de encostas, construção de estruturas e outras aplicações relacionadas.<br><br><span style="font-weight: 700;">Normas Brasileiras:</span>&nbsp;As normas brasileiras que tratam do ensaio de campo de sondagem mista geralmente estão relacionadas às normas de sondagem rotativa e de percussão, uma vez que a sondagem mista combina essas duas técnicas. Alguns exemplos de normas que podem ser relevantes incluem:<br>ABNT NBR 11682:2018 – Investigação Geotécnica – Sondagens de Simples Reconhecimento com SPT (Standard Penetration Test) – Procedimento.<br>ABNT NBR 11683:2018 – Investigação Geotécnica – Sondagens de Simples Reconhecimento com SPT (Standard Penetration Test) – Diretrizes.<br>ABNT NBR 9603:1986 – Projeto e Execução de Sondagens de Simples Reconhecimento dos Solos para Fundações de Edifícios.<br>ABNT NBR 8044:1983 – Sondagens de Simples Reconhecimento dos Solos – Coleta de Amostras Indeformadas – Método de Ensaio.<br><br><span style="font-weight: 700;">Público-Alvo:</span>&nbsp;O público-alvo do ensaio de campo de sondagem mista inclui engenheiros geotécnicos, engenheiros de minas, geólogos, geofísicos e outros profissionais envolvidos em projetos que requerem informações abrangentes sobre o subsolo e as rochas. Empresas de engenharia, empresas de mineração, consultorias geotécnicas e outros segmentos relacionados podem utilizar os resultados desses ensaios.<br><br><span style="font-weight: 700;">Técnica:</span>&nbsp;A técnica do ensaio de campo de sondagem mista envolve a combinação das seguintes etapas das sondagens rotativa e de percussão:<br><span style="font-weight: 700;">1. Instalação da Sonda:</span>&nbsp;Uma sonda mista, que combina elementos de sondagem rotativa e de percussão, é instalada no local de sondagem.<br><span style="font-weight: 700;">2. Perfuração Rotativa:</span>&nbsp;A broca rotativa é utilizada para penetrar em rochas e solo, permitindo coletar amostras de diferentes camadas geológicas.<br><span style="font-weight: 700;">3. Martelamento:</span>&nbsp;Após a perfuração rotativa, a técnica de percussão é empregada para continuar a perfuração em solo menos consolidado ou para romper materiais mais resistentes.<br><span style="font-weight: 700;">4. Coleta de Amostras:</span>&nbsp;Durante a perfuração, amostras contínuas de solo e rocha são coletadas, proporcionando uma representação detalhada das diferentes camadas geológicas.<br><span style="font-weight: 700;">5. Registro de Dados:</span>&nbsp;Durante a perfuração, são registrados dados como a profundidade, as características das amostras e outras informações relevantes.<br><br><span style="font-weight: 700;">Interpretação:</span>&nbsp;As amostras coletadas e os dados registrados durante o ensaio de campo de sondagem mista fornecem informações detalhadas sobre a estrutura geológica, a resistência, as propriedades físicas e mecânicas do solo e das rochas. Esses dados são cruciais para a elaboração de projetos geotécnicos e de engenharia.<br>Em resumo, o ensaio de campo de sondagem mista é uma técnica avançada na engenharia geotécnica que combina elementos das sondagens rotativa e de percussão para obter informações abrangentes sobre o subsolo e as rochas em profundidades substanciais. Ele é utilizado por uma variedade de profissionais e organizações envolvidos em projetos geotécnicos e de engenharia, seguindo as normas estabelecidas.​</p>
      </div>
    </section>
