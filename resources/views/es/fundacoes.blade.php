...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Fundações.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Fundações.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Fundações.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Fundações.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1438">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
    <section class="u-clearfix u-valign-middle-xl u-section-2" id="block-11">
      <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-1"></div>
    </section>
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTOS DE FUNDACIÓN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">La elaboración de proyectos de fundación, ya sean superficiales o profundas, es fundamental para garantizar la estabilidad, seguridad y durabilidad de las estructuras construidas. Las fundaciones son responsables de transmitir las cargas de la edificación al suelo de manera eficiente y segura, teniendo en cuenta las características del suelo, las cargas aplicadas y otros factores relevantes. La necesidad de elaborar proyectos de fundación, ya sean superficiales o profundas, es evidenciada por diversos motivos:<br><br><span style="font-weight: 700;">Fundaciones Superficiales:</span><br><br><span style="font-weight: 700;">1. Distribución de Cargas:</span> Las fundaciones superficiales, como zapatas y bloques, distribuyen las cargas de la estructura sobre una área mayor del suelo. La elaboración del proyecto considera la carga, el tamaño y la forma de la fundación para evitar la sobrecarga del suelo.<br><span style="font-weight: 700;">2. Características del Suelo:</span> El proyecto debe tener en cuenta la capacidad de carga del suelo, su cohesión, densidad y otras propiedades. El análisis geotécnico es crucial para determinar la fundación más adecuada para las condiciones del lugar.<br><span style="font-weight: 700;">3. Estabilidad y Hundimiento:</span> Un proyecto bien elaborado considera la posibilidad de hundimiento diferencial del suelo y la estabilidad global de la fundación, garantizando que la estructura permanezca nivelada y estable.<br><span style="font-weight: 700;">4. Protección contra Erosión e Infiltración:</span> Las fundaciones superficiales también pueden incluir medidas para proteger contra la erosión causada por el agua y la infiltración, evitando que el suelo debajo de la fundación se deteriore.<br><br><span style="font-weight: 700;">Fundaciones Profundas:</span>&nbsp;<br><br><span style="font-weight: 700;">1. Carga de Cargas Pesadas:</span> Las fundaciones profundas, como estacas y tubulones, se utilizan cuando las cargas aplicadas son significativamente altas o cuando las características del suelo superficial son inadecuadas para sostener la estructura.<br><span style="font-weight: 700;">2. Profundidad y Capacidad de Carga:</span> La elaboración del proyecto de fundaciones profundas tiene en cuenta la profundidad adecuada para alcanzar un estrato de suelo con capacidad de carga suficiente.<br><span style="font-weight: 700;">3. Distribución de Carga Vertical y Lateral:</span> El proyecto debe considerar tanto la capacidad de carga vertical como la lateral de las fundaciones profundas, para garantizar que la estructura sea adecuadamente soportada en ambas direcciones.<br><span style="font-weight: 700;">4. Compatibilidad con Condiciones Subterráneas:</span> En áreas donde pueden existir lençóis freáticos elevados o rocas duras, las fundaciones profundas necesitan ser proyectadas para lidar con estas condiciones desafiantes.<br><span style="font-weight: 700;">5. Estabilidad Lateral:</span> En lugares sometidos a cargas laterales, como el viento o las fuerzas sísmicas, el proyecto de fundaciones profundas considera la estabilidad lateral de la estructura.<br><br><span style="font-weight: 700;">Necesidad General:</span>&nbsp;<br><br><span style="font-weight: 700;">1. Seguridad Estructural:</span> La principal necesidad de proyectos de fundación es garantizar la seguridad y la estabilidad de la estructura construida. Las fundaciones inadecuadas pueden resultar en grietas, desplazamientos o incluso colapsos.<br><span style="font-weight: 700;">2. Cumplimiento de Normas:</span> Los proyectos de fundación deben seguir las normas de ingeniería y regulaciones locales que garantizan que las estructuras se construyan de manera segura y duradera.<br><span style="font-weight: 700;">3. Condiciones Específicas del Lugar:</span> Cada lugar de construcción presenta desafíos únicos en términos de suelo, topografía, clima y otros factores. Los proyectos de fundación consideran estas condiciones para proporcionar soluciones adaptadas.<br><span style="font-weight: 700;">4. Longevidad de la Estructura:</span> Las fundaciones bien proyectadas contribuyen a la longevidad de la estructura, evitando problemas futuros que pueden surgir debido a problemas de asentamiento o inestabilidad.<br><span style="font-weight: 700;">5. Eficiencia de Costos:</span> La elaboración de proyectos de fundación ayuda a evitar desperdicios de materiales y recursos, garantizando que la fundación sea dimensionada adecuadamente para las cargas aplicadas.<br><br>En resumen, la elaboración de proyectos de fundación, ya sean superficiales o profundas, es necesaria para garantizar que las estructuras se construyan de manera segura, estable y duradera, considerando las características del suelo, las cargas aplicadas y las condiciones específicas del lugar. Esto ayuda a prevenir riesgos, problemas estructurales y costos innecesarios a largo plazo.​</p>
      </div>
    </section>
    <section class="u-clearfix u-valign-middle-xl u-section-5" id="sec-0f61">
      <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-1"></div>
    </section>
