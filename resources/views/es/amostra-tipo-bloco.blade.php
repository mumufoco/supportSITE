...
@section('lang', 'es')
@section('title', 'Amostra Tipo Bloco')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Amostra-Tipo-Bloco.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MUESTRA INDEFORMADA TIPO BLOQUE - BL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span> La prueba de campo con muestra indeformada tipo bloque es necesaria para recopilar muestras de suelo no perturbadas en suelos cohesionados y arcillosos, lo que permite analizar las características geotécnicas del suelo en su estado inalterado. Estas muestras son fundamentales para evaluar la resistencia, la compresibilidad y la permeabilidad del suelo, lo que ayuda en el proyecto y la ejecución de obras geotécnicas.<br><br><span style="font-weight: 700;">OBJETIVO:</span> El objetivo principal de la prueba de campo con muestra indeformada tipo bloque es recopilar muestras de suelo que preserven su estructura original, sin ser afectadas por el proceso de muestreo. Esto permite realizar pruebas de laboratorio que proporcionarán información precisa sobre las propiedades mecánicas e hidráulicas del suelo.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span> Las normas brasileñas que tratan de la prueba de campo con muestra indeformada tipo bloque están relacionadas con pruebas de muestreo e investigación geotécnica. Algunas normas que pueden ser relevantes incluyen:<br>ABNT NBR 6484:2001 – Ejecución de sondeos de simple reconocimiento con SPT – Método de prueba.<br>ABNT NBR 8036:1983 – Suelo – Prueba de compactación – Método de prueba.<br>ABNT NBR 7250:1986 – Suelo – Prueba de penetración de cono – Método de prueba.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span> El público objetivo de la prueba de campo con muestra indeformada tipo bloque incluye ingenieros geotécnicos, ingenieros civiles, geólogos, técnicos en geotecnia y profesionales involucrados en proyectos que requieren una evaluación precisa de las propiedades mecánicas e hidráulicas del suelo. Empresas de ingeniería geotécnica, consultorías geotécnicas, organismos gubernamentales e instituciones de investigación pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span> La técnica de la prueba de campo con muestra indeformada tipo bloque implica las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span> El lugar de la prueba se elige con base en criterios geotécnicos relevantes, considerando las características del suelo y los objetivos de la prueba.<br><span style="font-weight: 700;">2. INSTALACIÓN DEL EQUIPO:</span> Se utiliza un equipo de muestreo para crear un agujero en el suelo, formando un bloque que preserva la estructura original del suelo. Este equipo es específico para la recopilación de muestras indeformadas.<br><span style="font-weight: 700;">3. RECOLECCIÓN DE LA MUESTRA:</span> El equipo crea un bloque de suelo que se retira cuidadosamente y se preserva en su forma original.<br><span style="font-weight: 700;">4. ACONDICIONAMIENTO DE LA MUESTRA:</span> La muestra recopilada se acondiciona de manera adecuada para evitar perturbaciones durante el transporte hasta el laboratorio.<br><span style="font-weight: 700;">5. REGISTRO DE DATOS:</span> Se registran todos los datos obtenidos durante la prueba, incluyendo la profundidad de la prueba, características del suelo, condiciones del lugar y otros aspectos relevantes.<br><span style="font-weight: 700;">6. INTERPRETACIÓN:</span> Las muestras indeformadas recopiladas en la prueba de campo con muestra indeformada tipo bloque se envían para pruebas de laboratorio, donde se realizan análisis detallados de las propiedades mecánicas e hidráulicas del suelo. Los resultados de estas pruebas permiten comprender el comportamiento del suelo en diversas condiciones de carga y fundamentar proyectos geotécnicos.<br><br>En resumen, la prueba de campo con muestra indeformada tipo bloque es una técnica esencial en la ingeniería geotécnica para recopilar muestras de suelo que preserven su estructura original en suelos cohesionados y arcillosos. Se utiliza por diversos profesionales y organizaciones involucrados en proyectos geotécnicos, siguiendo las normas y procedimientos establecidos.</p>
      </div>
    </section>
