...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Estaca-Escavada.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">EJECUCIÓN DE PERFORACIÓN ESTACA ESCAVADA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">La estaca escavada es un método de fundación profunda ampliamente utilizado en la construcción civil para soportar estructuras, como edificios, puentes y otras obras de ingeniería. Consiste en excavar el suelo para crear un hueco en el cual el concreto es posteriormente insertado para formar la estaca. Este método presenta características y ventajas distintas en comparación con otros métodos de fundación, como estacas clavadas, estacas hélice continua, estacas pre-moldeadas y estacas tipo Strauss. Aquí están los servicios y ventajas de la estaca escavada en relación con otros métodos:<br><br><span style="font-weight: 700;">Descripción de los servicios de estaca escavada:</span><br><br><span style="font-weight: 700;">1. Excavación:</span>&nbsp;Un hueco es excavado en el suelo hasta alcanzar la capa de suelo resistente o la profundidad especificada por el proyecto. Esto es generalmente hecho con el uso de equipos de excavación, como excavadoras o sondas.<br><span style="font-weight: 700;">2. Revestimiento:</span>&nbsp;En suelos inestables o sujetos a derrumbes, puede ser necesario el uso de revestimientos temporales para mantener las paredes del hueco estables durante la excavación.<br><span style="font-weight: 700;">3. Inyección de concreto:</span>&nbsp;Después de la excavación, el hueco es llenado con concreto, que puede ser inyectado por medio de tubos para garantizar el llenado y compactación completo del hueco.<br><span style="font-weight: 700;">4. Armadura de acero:</span>&nbsp;En algunos casos, armaduras de acero pueden ser añadidas al hueco para reforzar la estaca y aumentar su capacidad de carga.<br><br><span style="font-weight: 700;">Ventajas de la estaca escavada sobre otros métodos de fundación:</span><br><br><span style="font-weight: 700;">1. Adaptación a suelos diversos:</span>&nbsp;Las estacas escavadas son adecuadas para una amplia variedad de tipos de suelo, desde arcilla hasta arena y roca, lo que las hace versátiles en diferentes condiciones geotécnicas.<br><span style="font-weight: 700;">2. Alta capacidad de carga:</span>&nbsp;Las estacas escavadas son capaces de soportar cargas pesadas, lo que las hace adecuadas para estructuras de gran porte.<br><span style="font-weight: 700;">3. Precisión geométrica:</span>&nbsp;La estaca escavada es ejecutada con alta precisión en relación con su localización y dimensiones, lo que la hace ventajosa para proyectos que requieren tolerancias apretadas.<br><span style="font-weight: 700;">4. Bajo riesgo de vibraciones:</span>&nbsp;En comparación con estacas clavadas, por ejemplo, la estaca escavada genera menos vibraciones, lo que la hace más adecuada para áreas urbanas sensibles.<br><span style="font-weight: 700;">5. Posibilidad de control de nivel de agua:</span>&nbsp;En casos de lençol freático elevado, es posible utilizar técnicas para controlar el nivel de agua en el hueco durante la ejecución.<br><span style="font-weight: 700;">6. Calidad y durabilidad:</span>&nbsp;La ejecución controlada de la estaca escavada contribuye a la alta calidad y durabilidad de la fundación.<br><span style="font-weight: 700;">7. Reducción de impacto ambiental:</span>&nbsp;La estaca escavada genera menos ruido y vibración, lo que causa menos impacto ambiental en comparación con estacas clavadas.<br><span style="font-weight: 700;">8. Mínima generación de residuos:</span>&nbsp;Comparada con estacas pre-moldeadas, por ejemplo, la estaca escavada genera menos residuos durante la ejecución.<br><span style="font-weight: 700;">9. Adaptación a proyectos complejos:</span>&nbsp;La estaca escavada puede ser fácilmente adaptada a proyectos que involucran restricciones de espacio, geometría irregular y fundaciones próximas.<br><span style="font-weight: 700;">10. Flexibilidad de profundidad:</span>&nbsp;La profundidad de la estaca escavada puede ser ajustada según las necesidades del proyecto.<br><span style="font-weight: 700;">11. Control de calidad:</span>&nbsp;La ejecución de la estaca escavada permite un control riguroso de la calidad, ya que cada estaca es visualmente inspeccionada.<br><br>En resumen, la estaca escavada presenta varias ventajas en relación con otros métodos de fundación, como la adaptación a diferentes tipos de suelo, alta capacidad de carga, precisión geométrica y bajo impacto ambiental. La elección del método de fundación dependerá de las características específicas del proyecto, de las condiciones del suelo y de los objetivos de construcción.</p>
      </div>
    </section>
