...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Triaxial.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Triaxial.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Triaxial.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Triaxial.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1324">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​ENSAYOS TRIAXIALES - TRI</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​Los ensayos triaxiales son un conjunto de ensayos laboratorios utilizados en la geotecnia para evaluar las propiedades mecánicas y de resistencia de los suelos bajo diferentes condiciones de tensión y deformación. Estos ensayos son cruciales para comprender el comportamiento de los suelos bajo cargas complejas y proporcionan información valiosa para proyectos de ingeniería geotécnica. Existen diferentes tipos de ensayos triaxiales, incluyendo el ensayo triaxial no consolidado no drenado (UU), el ensayo triaxial consolidado drenado (CD), y el ensayo triaxial no consolidado drenado (CU), cada uno con sus propias características y aplicaciones. <br><br> Aquí está una descripción general de los ensayos triaxiales: <br><br> <span style="font-weight: 700;">Objetivo:</span> Evaluar las propiedades mecánicas, de resistencia y de deformación de los suelos bajo diferentes condiciones de tensión y deformación. <br><br> <span style="font-weight: 700;">Equipos y Materiales:</span> <br> 1. Máquina de ensayo triaxial; <br> 2. Célula triaxial (cilindro de confinamiento y cámara de drenaje); <br> 3. Muestra del suelo; <br> 4. Instrumentos de medición de deformación (extensómetros); <br> 5. Balanzas de precisión; <br> 6. Dispositivos de saturación de muestras; <br><br> <span style="font-weight: 700;">Procedimiento:</span> <br> 1. Preparación de la Muestra: Una muestra representativa del suelo es colectada y preparada de acuerdo con las dimensiones adecuadas para la máquina de ensayo triaxial. <br> <span style="font-weight: 700;">2. Montaje de la Muestra:</span> La muestra es colocada en la célula triaxial y saturada, garantizando que el agua sea removida del sistema. En algunos casos, una presión de confinamiento puede ser aplicada para simular condiciones de tensión vertical. <br> <span style="font-weight: 700;">3. Aplicación de las Tensiones:</span> Las tensiones de confinamiento y de corte son aplicadas a la muestra por medio de la máquina de ensayo triaxial. En el ensayo UU, la muestra es cargada rápidamente hasta la falla, manteniendo el mismo nivel de presión de confinamiento durante todo el teste. En el ensayo CD, la muestra es consolidada bajo presión de confinamiento y después cargada hasta la falla. En el ensayo CU, la muestra es cargada rápidamente, permitiendo el escurrimiento del agua. <br> <span style="font-weight: 700;">4. Registro de Datos:</span> Durante el ensayo, las cargas, las deformaciones y las presiones de poro son registradas para diferentes niveles de tensión. <br> <span style="font-weight: 700;">5. Análisis de los Resultados:</span> A partir de los datos colectados, es posible determinar propiedades mecánicas, como la resistencia al corte, la cohesión, el ángulo de fricción interno y el módulo de deformación. <br> <span style="font-weight: 700;">6. Interpretación:</span> Los resultados de los ensayos triaxiales son frecuentemente presentados en gráficos conocidos como Diagramas de Mohr-Coulomb, que muestran la relación entre las tensiones normales y las tensiones de corte para diferentes estados de tensión. <br><br> <span style="font-weight: 700;">Utilidad:</span> Los ensayos triaxiales son utilizados para comprender el comportamiento de los suelos en condiciones de tensión complejas, como las que ocurren en fundaciones, presas, laderas y otros proyectos geotécnicos. Son esenciales para evaluar la estabilidad y la capacidad de carga de estructuras en suelos. <br> En resumen, los ensayos triaxiales son una herramienta crucial en la geotecnia, permitiendo la evaluación de las propiedades mecánicas y de resistencia de los suelos bajo diferentes condiciones de tensión y deformación. Esto auxilia en la comprensión del comportamiento de los suelos en proyectos de ingeniería geotécnica y en la toma de decisiones informadas durante el diseño y construcción de estructuras.</p>
      </div>
    </section>
