...
@section('lang', 'es')
@section('title', 'Missão Valores e Objetivos')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Missão-Valores-e-Objetivos.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.missao-valores-e-objetivos') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Missão-Valores-e-Objetivos.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Missão-Valores-e-Objetivos.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MISIÓN, VALORES Y OBJETIVOS</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">MISIÓN:</span><br>Nuestra misión es proporcionar servicios de sondeo geotécnico de alta calidad, confiables y precisos, contribuyendo al éxito y seguridad de proyectos de ingeniería y construcción. Buscamos ser socios confiables para nuestros clientes, ofreciendo soluciones técnicas innovadoras y manteniendo los más altos estándares de ética y profesionalismo.<br><br><span style="font-weight: 700;">VALORES:</span><br>Integridad: Actuamos con honestidad y transparencia en todas nuestras interacciones, manteniendo los más altos estándares éticos.Calidad: Nos comprometemos con la excelencia, buscando continuamente mejorar nuestros conocimientos y procesos para entregar resultados de sondeo precisos y confiables.Innovación: Buscamos constantemente soluciones técnicas innovadoras para atender a las demandas de nuestros clientes de forma eficaz y eficiente.Respeto: Tratamos a todas las personas con respeto, dignidad y consideración, promoviendo un ambiente inclusivo y colaborativo.Responsabilidad: Cumplimos nuestras responsabilidades para con nuestros clientes, colaboradores, comunidad y medio ambiente, garantizando seguridad, sostenibilidad y compromiso social.Profesionalismo: Mantenemos un alto nivel de profesionalismo en todas nuestras actividades, desde la comunicación hasta la ejecución de los proyectos.<br><br><span style="font-weight: 700;">OBJETIVOS:</span><br>Excelencia Técnica: Mantenernos actualizados con las últimas tecnologías y técnicas de sondeo, buscando mejorar constantemente nuestro conocimiento técnico para proporcionar resultados de alta calidad.Satisfacción del Cliente: Garantizar la satisfacción total de los clientes, atendiendo a sus necesidades y superando sus expectativas en términos de precisión, plazos y servicio.Innovación y Desarrollo: Invertir en investigación y desarrollo para ofrecer soluciones de sondeo innovadoras que atiendan a los desafíos del mercado.Crecimiento Sostenible: Expandir nuestra presencia de manera sostenible, buscando oportunidades de crecimiento que estén alineadas con nuestra misión y valores.Responsabilidad Social y Ambiental: Cumplir rigurosamente las regulaciones de salud, seguridad y medio ambiente, minimizando nuestro impacto ambiental y contribuyendo positivamente a la comunidad.Colaborador Comprometido: Fomentar un ambiente de trabajo positivo, ofreciendo oportunidades de desarrollo y reconociendo el esfuerzo y la contribución de nuestros colaboradores.Asociaciones Estratégicas: Establecer asociaciones sólidas y duraderas con clientes, proveedores y partes interesadas, basadas en la confianza y la colaboración.<br><br><span style="font-weight: 700;">Al seguir nuestra misión, valores y objetivos, Support Solo Sondeos busca destacarse como una empresa líder en la industria de sondeo geotécnico, contribuyendo de forma significativa a proyectos de éxito y al desarrollo de la sociedad en su conjunto.</span></p>
      </div>
    </section>
