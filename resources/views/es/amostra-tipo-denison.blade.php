...
@section('lang', 'es')
@section('title', 'Amostra Tipo Denison')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Amostra-Tipo-Denison.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MUESTRA INDEFORMADA TIPO DENISON - DN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo con muestra indeformada tipo Denison es necesaria para recopilar muestras de suelo no perturbadas en suelos cohesivos y arcillosos. Estas muestras son esenciales para la evaluación precisa de las características geotécnicas, como la resistencia, la compresibilidad y la permeabilidad del suelo, garantizando una comprensión detallada del comportamiento del suelo en proyectos geotécnicos.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo con muestra indeformada tipo Denison es recopilar muestras de suelo que mantengan su estructura original y no hayan sido perturbadas durante el proceso de muestreo. Esto permite realizar pruebas de laboratorio que proporcionan información detallada sobre las propiedades mecánicas e hidráulicas del suelo en su estado inalterado.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo con muestra indeformada tipo Denison están relacionadas con pruebas de muestreo e investigación geotécnica. Algunos ejemplos de normas que pueden ser relevantes incluyen:<br>ABNT NBR 6484:2001 – Ejecución de Sondeos de Simples Reconocimiento con SPT – Método de Prueba.<br>ABNT NBR 7250:1986 – Suelo – Prueba de Penetración de Cono – Método de Prueba.<br>ABNT NBR 8036:1983 – Suelo – Prueba de Compactación – Método de Prueba.<br><br><span style="font-weight: 700;">PÚBLICO-OBJETIVO:</span>&nbsp;El público-objetivo de la prueba de campo con muestra indeformada tipo Denison incluye ingenieros geotécnicos, ingenieros civiles, geólogos, técnicos en geotecnia y profesionales involucrados en proyectos que requieren la evaluación precisa de las propiedades mecánicas e hidráulicas del suelo. Empresas de ingeniería geotécnica, consultorías geotécnicas, órganos gubernamentales y instituciones de investigación pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo con muestra indeformada tipo Denison involucra las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span>&nbsp;El lugar de prueba es elegido con base en criterios geotécnicos relevantes, considerando las características del suelo y los objetivos de la prueba.<br><span style="font-weight: 700;">2. INSTALACIÓN DEL EQUIPO:</span>&nbsp;Un equipo de muestreo es insertado en el suelo utilizando equipos de sondeo. Este equipo es específico para la recopilación de muestras indeformadas en suelos cohesivos.<br><span style="font-weight: 700;">3. RECOLECCIÓN DE LA MUESTRA:</span>&nbsp;El equipo es insertado en el suelo hasta la profundidad deseada, de acuerdo con los objetivos de la prueba. La muestra es entonces retirada del suelo y preservada en un tubo de recolección.<br><span style="font-weight: 700;">4. PRESERVACIÓN DE LA MUESTRA:</span>&nbsp;La muestra recopilada es preservada en su estado no perturbado y acondicionada adecuadamente para evitar deformaciones durante el transporte.<br><span style="font-weight: 700;">5. REGISTRO DE DATOS:</span>&nbsp;Todos los datos obtenidos durante la prueba son registrados, incluyendo la profundidad de la prueba, características del suelo, condiciones del lugar y otros aspectos relevantes.<br><span style="font-weight: 700;">6. INTERPRETACIÓN:</span>&nbsp;Las muestras indeformadas recopiladas en la prueba de campo con muestra indeformada tipo Denison son enviadas para pruebas de laboratorio, donde se realizan análisis detallados de las propiedades mecánicas e hidráulicas del suelo. Los resultados de estas pruebas permiten comprender el comportamiento del suelo en diversas situaciones de carga y orientar proyectos geotécnicos.<br><br>En resumen, la prueba de campo con muestra indeformada tipo Denison es una técnica importante en la ingeniería geotécnica para recopilar muestras de suelo no perturbadas en suelos cohesivos y arcillosos. Ella es utilizada por una variedad de profesionales y organizaciones involucradas en proyectos geotécnicos, siguiendo las normas y procedimientos establecidos.</p>
      </div>
    </section>
