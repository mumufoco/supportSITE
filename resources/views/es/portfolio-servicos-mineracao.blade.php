...
@section('lang', 'es')
@section('title', 'Portfólio Serviços Mineração')
@section('body-class', 'u-body u-clearfix u-xl-mode')

@push('meta')
    <meta name="keywords" content="​SOPORTE SOLO SONDAGENS, ​LABORATORIO:, ​GEOLOGÍA E INGENIERÍA:, ​ELABORACIÓN DE PROYECTOS:">
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Portfólio-Serviços-Mineração.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
          ...
          <div class="u-layout-row">
            <div class="skrollable u-align-center u-container-align-center u-container-style u-layout-cell u-parallax u-shape-rectangle u-size-30 u-layout-cell-1" data-image-width="2000" data-image-height="1333">
              <div class="u-container-layout u-container-layout-1">
                ...
                <h5 class="u-text u-text-palette-1-base u-text-3">https://www.soportesonsondagens.com</h5>
              </div>
            </div>
    ...
    <section class="u-clearfix u-container-align-center u-image u-section-3" id="block-6" data-image-width="1920" data-image-height="1441">
      ...
      <div class="data-layout-selected u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
        <div class="u-layout" style="">
          <div class="u-layout-row" style="">
            <div class="u-container-align-center u-container-style u-image u-layout-cell u-size-12 u-image-1" data-image-width="1920" data-image-height="1080">
            ...
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <p class="u-text u-text-1"><span style="font-weight: 700;">NORMAS REGULADORAS (NR):</span><br>Las Normas Reguladoras (NR) son un conjunto de reglas establecidas por el Ministerio de Trabajo y Empleo (MTE) con el objetivo de establecer requisitos mínimos de seguridad y salud en el trabajo. Ellas son aplicables a todos los empleadores y trabajadores en régimen de Contrato Laboral (CLT) y tienen como objetivo garantizar ambientes de trabajo seguros y saludables.<br><span style="font-weight: 700;">NR-12: SEGURIDAD EN EL TRABAJO CON MÁQUINAS Y EQUIPOS:</span><br>La NR-12 es una de las normas más importantes cuando se trata de seguridad en el trabajo, ya que se refiere específicamente a la seguridad en máquinas y equipos utilizados en diversos sectores de la industria.<br><span style="font-weight: 700;">CÓMO LA EMPRESA SOPORTE DE SONDEO DE SUELO CUMPLE CON LA NR-12:</span><br>La empresa Soporte de Sondeo de Suelo, al operar con equipos de sondeo, está sujeta a la NR-12 debido al uso de máquinas y equipos. La empresa adopta diversas prácticas para garantizar el cumplimiento de esta norma:<br><span style="font-weight: 700;">TECNOLOGÍA HIDRÁULICA Y INNOVACIONES TECNOLÓGICAS:</span><br>La empresa utiliza tecnología hidráulica en sus equipos de sondeo, lo que proporciona un control preciso y seguro durante las operaciones.<br>La actualización constante de la tecnología de los equipos garantiza que estén en conformidad con las exigencias de la NR-12, incluyendo sistemas de seguridad y dispositivos de parada de emergencia.<br><span style="font-weight: 700;">ENTRENAMIENTO Y CAPACITACIÓN:</span><br>Todos los operadores y técnicos reciben entrenamiento específico sobre la operación segura de los equipos, incluyendo instrucciones sobre los riesgos asociados con el manejo.<br><span style="font-weight: 700;">MANTENIMIENTO PREVENTIVO:</span><br>La empresa implementa programas de mantenimiento preventivo para garantizar el buen funcionamiento de los equipos, evitando fallos que puedan poner en riesgo la seguridad de los trabajadores.<br>PROTECCIONES Y DISPOSITIVOS DE SEGURIDAD:<br>Todos los equipos están equipados con protecciones y dispositivos de seguridad, como guardas, sensores y sistemas de parada de emergencia, según lo estipulado por la NR-12.<br><span style="font-weight: 700;">EVALUACIÓN DE RIESGOS:</span><br>Antes de iniciar cualquier operación, la empresa realiza una evaluación de riesgos para identificar y mitigar posibles peligros asociados con el uso de los equipos.<br><span style="font-weight: 700;">DOCUMENTACIÓN Y REGISTROS:</span><br>La empresa Soporte de Sondeo de Suelo mantiene registros detallados de las inspecciones, mantenimientos y entrenamientos realizados, demostrando su compromiso con el cumplimiento.<br>Al adoptar estas prácticas, la empresa Soporte de Sondeo de Suelo demuestra un compromiso sólido con la seguridad de los trabajadores y el cumplimiento de las normas reguladoras, en especial la NR-12. La integración de tecnología hidráulica y la búsqueda continua de innovaciones tecnológicas garantizan que la empresa opere con eficiencia y seguridad en sus actividades de sondeo geotécnico y geológico.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="u-clearfix u-container-align-center u-image u-section-6" id="sec-6168" data-image-width="1920" data-image-height="1441">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
    <section class="u-clearfix u-valign-top-xl u-section-7" id="block-7">
      <div class="data-layout-selected u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
        <div class="u-layout" style="">
          <div class="u-layout-row" style="">
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-1">
              <div class="u-container-layout u-container-layout-1">
                <p class="u-text u-text-1"><span style="font-weight: 700;">LOGÍSTICA COMO PARTE DEL NEGOCIO:</span><br>La empresa Soporte de Sondeo de Suelo tiene una estructura logística robusta y eficiente para atender a las empresas del sector de la minería. La logística es una parte crucial de sus operaciones, garantizando que los servicios se presten de forma eficaz y dentro de los plazos establecidos. A continuación, se describe la estructura logística de la empresa Soporte de Sondeo de Suelo para atender a las mineras:<br><span style="font-weight: 700;">FLOTA DE VEHÍCULOS ESPECIALIZADOS:</span><br>La empresa mantiene una flota de vehículos especializados, incluyendo camiones equipados con los recursos necesarios para transportar los equipos de sondeo y todo el equipo técnico hasta los lugares de operación en las minas. Estos vehículos están adaptados para garantizar la seguridad de los equipos durante el transporte.<br><span style="font-weight: 700;">ROTEO Y PLANIFICACIÓN:</span><br>La empresa cuenta con un departamento dedicado a la planificación y roteo de las operaciones. Este sector evalúa las condiciones de las carreteras, la distancia hasta el lugar de operación y otros factores logísticos para determinar la mejor ruta y el tiempo estimado de llegada.<br><span style="font-weight: 700;">EQUIPO DE LOGÍSTICA Y COORDINACIÓN:</span><br>El equipo de logística es responsable de la coordinación de todos los detalles relacionados con el transporte. Esto incluye la programación, el seguimiento en tiempo real de los vehículos, la comunicación con los conductores y la resolución de problemas que puedan surgir durante el viaje.<br><span style="font-weight: 700;">MANTENIMIENTO PREVENTIVO:</span><br>La flota de vehículos está sometida a un programa de mantenimiento preventivo regular para garantizar que todos los vehículos estén en perfectas condiciones de funcionamiento. Esto minimiza el riesgo de fallos mecánicos durante el transporte.<br><span style="font-weight: 700;">ENTRENAMIENTO DE CONDUCTORES:</span><br>Los conductores pasan por entrenamientos específicos para manejar los equipos de sondeo y garantizar la seguridad tanto de los equipos como de los ocupantes del vehículo. Ellos son instruidos sobre buenas prácticas de conducción defensiva y seguridad en el transporte de carga.<br><span style="font-weight: 700;">CUMPLIMIENTO DE LAS REGULACIONES DE TRANSPORTE:</span><br>La empresa Soporte de Sondeo de Suelo asegura que todos sus vehículos y operaciones estén en total cumplimiento con las regulaciones de transporte, incluyendo las normas de seguridad de carga, tiempos de conducción y descanso, y otros requisitos legales.<br><span style="font-weight: 700;">SEGUIMIENTO EN TIEMPO REAL:</span><br>La empresa utiliza sistemas de seguimiento en tiempo real para monitorear la ubicación y el estado de los vehículos durante todo el recorrido. Esto permite una respuesta rápida a posibles emergencias y optimiza la planificación de rutas.<br>Esta estructura logística bien organizada y eficiente permite que la empresa Soporte de Sondeo de Suelo atienda a las demandas de las empresas mineras de forma confiable, asegurando la entrega de sus servicios geotécnicos de alta calidad de manera puntual y segura.</p>
              </div>
            </div>
    ...
    <section class="u-clearfix u-valign-middle-xl u-section-8" id="sec-0d96">
      <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-1"></div>
    </section>
    <section class="u-clearfix u-valign-middle-xl u-section-9" id="block-8">
      <div class="data-layout-selected u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
        <div class="u-layout">
          <div class="u-layout-row">
            ...
            <div class="u-container-style u-layout-cell u-size-48 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <p class="u-text u-text-1"><span style="font-weight: 700;">PLAZA DE SONDEO MÓVIL Y VERSÁTIL:</span><br>La plaza de sondeo con contenedor desarrollada por la empresa Soporte de Sondeo de Suelo es una solución innovadora y altamente funcional para la ejecución de trabajos de sondeo geotécnico y geológico. Ella combina la movilidad de un contenedor con los equipos especializados necesarios para conducir las operaciones de sondeo con precisión y seguridad.<br><br><span style="font-weight: 700;">CARACTERÍSTICAS DE LA PLAZA DE SONDEO CON CONTENEDOR:</span><br><br><span style="font-weight: 700;">MOVILIDAD Y ADAPTABILIDAD:</span><br>La plaza de sondeo está construida dentro de un contenedor modificado, lo que significa que puede ser transportada fácilmente a diferentes lugares de trabajo, adaptándose a una variedad de condiciones geográficas y ambientales.<br><span style="font-weight: 700;">AMBIENTE CONTROLADO Y SEGURO:</span>El contenedor está equipado con sistemas de control de temperatura, ventilación e iluminación, proporcionando un ambiente de trabajo cómodo y seguro para los técnicos de sondeo.<br><span style="font-weight: 700;">EQUIPOS ESPECIALIZADOS INTEGRADOS:</span>Dentro del contenedor, se instalan todos los equipos necesarios para la ejecución de las sondeos, incluyendo sondeos, trados, equipos de perforación y otros instrumentos geotécnicos.<br><span style="font-weight: 700;">PROTECCIÓN CONTRA LAS INTUPERIES:</span>La estructura del contenedor ofrece protección contra condiciones climáticas adversas, garantizando que las operaciones de sondeo puedan continuar sin interrupciones, independientemente del clima.<br><span style="font-weight: 700;">GESTIÓN DE RESIDUOS Y MUESTREO:</span>La plaza de sondeo incluye un sistema eficaz para la gestión de residuos generados durante las operaciones, así como instalaciones para la recolección y almacenamiento adecuado de muestras de suelo y roca.<br><span style="font-weight: 700;">SISTEMA DE ENERGÍA Y ABASTECIMIENTO:</span>El contenedor está equipado con sistemas de energía, garantizando la alimentación de todos los equipos necesarios para las operaciones de sondeo. Además, puede incluir sistemas de abastecimiento de agua y otros recursos esenciales.<br><span style="font-weight: 700;">MANTENIMIENTO DE LA CALIDAD DE LAS MUESTRAS:</span>El ambiente controlado minimiza la interferencia de factores externos, garantizando la integridad y la calidad de las muestras de suelo y roca colectadas durante las operaciones de sondeo.<br><span style="font-weight: 700;">SEGURIDAD Y CUMPLIMIENTO:</span>La plaza de sondeo está diseñada y construida en conformidad con las regulaciones de seguridad y los estándares de la industria, garantizando la seguridad de los técnicos y el cumplimiento con las normas de trabajo.<br><br>Esta plaza de sondeo innovadora representa un avance significativo en las operaciones de sondeo geotécnico y geológico. Al combinar la movilidad de un contenedor con los equipos especializados necesarios para la ejecución de sondeos, la empresa Soporte de Sondeo de Suelo está posicionada para ofrecer servicios de alta calidad en una variedad de ambientes y condiciones. Además, la integración de sistemas de control ambiental y de seguridad garantiza que las operaciones se conduzcan de manera eficiente y segura.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="u-clearfix u-container-align-center u-image u-section-10" id="sec-696b" data-image-width="1920" data-image-height="1441">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
