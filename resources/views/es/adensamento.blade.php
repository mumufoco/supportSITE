...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Adensamento.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Adensamento.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Adensamento.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Adensamento.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​COMPACTACIÓN - COMPACT</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​El ensayo laboratorial de compactación es un procedimiento utilizado para evaluar la deformación y la consolidación de suelos cuando se someten a cargas verticales. Este ensayo es esencial para comprender cómo los suelos responden a las cargas a lo largo del tiempo y es fundamental en la geotecnia para proyectos de fundaciones, rellenos y estructuras que interactúan con el suelo.<br><br>Aquí está una descripción general del ensayo de compactación:<br><br><span style="font-weight: 700;">Objetivo:</span> Evaluar la consolidación y la deformación del suelo cuando se somete a cargas verticales, simulando condiciones de campo.<br><br><span style="font-weight: 700;">Equipos y Materiales:<span style="font-weight: 400;">​</span><br>1. Celda de compactación;<br>2. Muestra de suelo;<br>3. Placa porosa;<br>4. Agua o fluido saturante;<br>5. Instrumentos de medición de deformación (extensómetros);<br>6. Balanzas de precisión;<br>7. Dispositivos de saturación de muestras;</span><br><br><span style="font-weight: 700;">Procedimiento:<br>1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo se colecta y se prepara de acuerdo con las dimensiones adecuadas para la celda de compactación.<br><span style="font-weight: 700;">2. Saturación de la Muestra:</span>&nbsp;La muestra se satura con agua o un fluido saturante apropiado, garantizando que el suelo esté completamente saturado.<br><span style="font-weight: 700;">3. Montaje de la Muestra:</span>&nbsp;La muestra se coloca dentro de la celda de compactación, entre la placa porosa y el soporte superior, que aplica la carga. La placa porosa permite que el fluido saturante sea drenado, mientras que el soporte superior aplica la carga.<br><span style="font-weight: 700;">4. Carga:</span>&nbsp;La carga se aplica gradualmente al soporte superior, simulando las condiciones de carga vertical que ocurren en la práctica. El tiempo de aplicación de la carga puede ser controlado.<br><span style="font-weight: 700;">5. Registro de Datos:</span>&nbsp;Durante el ensayo, las cargas y las deformaciones se registran a lo largo del tiempo, permitiendo observar cómo el suelo se deforma y se consolida.<br><span style="font-weight: 700;">6. Desaplicación de la Carga:</span>&nbsp;Después de la aplicación de la carga, la carga se remueve gradualmente y las deformaciones continúan siendo monitoreadas, permitiendo observar la recuperación del suelo.<br><span style="font-weight: 700;">7. Interpretación:</span> Los resultados del ensayo de compactación se presentan frecuentemente en gráficos conocidos como Curvas de Compactación, que muestran la relación entre el tiempo y las deformaciones del suelo bajo carga.<br><br><span style="font-weight: 700;">Utilidad:</span> El ensayo de compactación es crucial para comprender cómo los suelos se comportan bajo cargas verticales y cómo ocurre el proceso de consolidación. Esta información se utiliza para prever la deformación futura del suelo, la tasa de asentamiento, y ayuda a diseñar fundaciones y estructuras de forma adecuada.<br>En resumen, el ensayo laboratorial de compactación es una herramienta esencial en la geotecnia, permitiendo la evaluación de la consolidación y deformación de suelos bajo cargas verticales. Esto es fundamental para proyectos de ingeniería geotécnica, especialmente en relación con fundaciones y estructuras que interactúan con el suelo.</p>
      </div>
    </section>
