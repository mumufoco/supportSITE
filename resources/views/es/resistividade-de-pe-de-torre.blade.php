...
@section('lang', 'es')
@section('title', 'Resistividade de Pé de Torre')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Resistividade-de-Pé-de-Torre.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">RESISTIVIDAD EN PIÉ DE TORRE</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;Las torres de transmisión conviven diariamente con un enemigo invisible: descargas atmosféricas y corrientes de fuga que buscan el camino de menor resistencia para disiparse en el suelo. Si el aterramiento de una torre no está funcionando como debería, la estructura puede experimentar sobretensión peligrosa, daños en los equipos y incluso riesgos para la seguridad de los equipos y de la población.<br>La medición de la resistencia de pié de torre es, por lo tanto, una etapa indispensable para evaluar la eficiencia del sistema de aterramiento instalado, verificar la conformidad con las normas y garantizar el rendimiento electromecánico de la línea de transmisión. Sin esta prueba, el funcionamiento de una red eléctrica depende de suposiciones — y la electricidad no suele perdonar suposiciones optimistas.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;La actividad tiene como objetivo determinar la&nbsp;resistencia eléctrica de aterramiento de cada torre, verificando si el valor está dentro de los parámetros exigidos para la protección adecuada contra descargas atmosféricas y corrientes de falla.<br>La prueba proporciona datos esenciales para la inspección, el mantenimiento preventivo y la corrección de sistemas que puedan estar deteriorados, rotos o con contacto deficiente con el suelo.<br><br><span style="font-weight: 700;">NORMAS QUE REGULAN Y NORTEAN:</span>&nbsp;La medición de resistencia de pié de torre está regida por normas técnicas ampliamente reconocidas, que aseguran la estandarización de los procedimientos y la confiabilidad de los resultados:<br>NBR 15751 – Sistemas de Aterramiento – Requisitos<br>NBR 5419 – Protección Contra Descargas Atmosféricas<br>IEEE Std 81 – Guía para la Medición de la Resistividad de la Tierra, la Impedancia de la Tierra y los Potenciales de la Superficie de la Tierra<br>IEEE Std 80 – Guía para la Seguridad en la Tierra de Subestaciones de CA&nbsp;(referenciada para parámetros y comportamiento de corrientes de falla)<br>Manuales y directrices de las concesionarias de transmisión&nbsp;(ONS, EPE, o normas internas específicas)<br>Estas normas definen métodos de medición, distancias de electrodos auxiliares y precauciones para evitar interferencias de la propia malla de aterramiento o de torres adyacentes.<br><br><span style="font-weight: 700;">PÚBLICO-OBJETIVO:</span>&nbsp;La prueba está destinada principalmente a: Empresas de transmisión y distribución de energía;&nbsp;Ingenieros electricistas y equipos de mantenimiento de líneas de transmisión;&nbsp;Empresas de ingeniería consultiva;&nbsp;Diseñadores de sistemas de aterramiento de alta tensión;&nbsp;Concesionarias y contratistas de obras lineales;&nbsp;Sector de inspección, comisionamiento y diagnóstico de infraestructura eléctrica.<br><br><span style="font-weight: 700;">DESCRIPCIÓN TÉCNICA DE LA ACTIVIDAD:</span>&nbsp;La medición de resistencia de pié de torre consiste en la evaluación de la resistencia eléctrica que la estructura ofrece al escoamiento de la corriente hacia el suelo.<br>El procedimiento clásico se realiza con un&nbsp;terrómetro, utilizando el&nbsp;Método de la Caída de Potencial (Fall of Potential – 62%), adaptado a las particularidades de las torres de transmisión.<br><span style="font-weight: 700;">EL PROCESO IMPLICA:</span><br><span style="font-weight: 700;">1. AISLAMIENTO DEL ATERRAMIENTO DE LA TORRE (cuando sea aplicable).</span><br>Instalación de un electrodo de corriente a una distancia adecuada, normalmente entre 100 m y 300 m, dependiendo de las características del suelo y del largo de la malla de la torre.<br><span style="font-weight: 700;">2. INSTALACIÓN DE UN ELECTRODO DE POTENCIAL ENTRE LA TORRE Y EL ELECTRODO DE CORRIENTE.</span><br><span style="font-weight: 700;">3. APLICACIÓN DE CORRIENTE:</span> por el terrómetro y lectura de la diferencia de potencial para el cálculo de la resistencia.<br>Repetición de las lecturas para garantizar la estabilidad y la confiabilidad.<br>En torres cercanas entre sí, puede ser necesario realizar compensaciones o utilizar métodos especiales para evitar la influencia mutua entre mallas.<br><br>El resultado final indica si el aterramiento de la torre disipa la corriente de manera efectiva, atendiendo a los límites establecidos y contribuyendo a la seguridad de la red.<br>RESUMEN DE LA ACTIVIDAD:&nbsp;La medición de resistencia de pié de torre es un procedimiento fundamental de seguridad y confiabilidad en sistemas de transmisión. Con el uso de terrómetro y metodología estandarizada, se evalúa si cada torre posee un camino efectivo de disipación de corrientes hacia el suelo. La prueba sigue normas técnicas y buenas prácticas internacionales y ayuda a prevenir fallos, caídas de rendimiento y riesgos asociados a descargas atmosféricas.<br>Es una actividad que garantiza que la red eléctrica esté protegida del imprevisible — y que cada torre esté debidamente conectada a la vasta y silenciosa malla conductora que es el suelo.​</p>
      </div>
    </section>
