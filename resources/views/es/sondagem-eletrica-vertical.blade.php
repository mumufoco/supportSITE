...
@section('lang', 'es')
@section('title', 'Sondagem Elétrica Vertical')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-Elétrica-Vertical.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SONDEO ELÉCTRICO VERTICAL (SEV)</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-top-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La investigación de la resistividad eléctrica del suelo es fundamental para proyectos de ingeniería que dependen del comportamiento electromagnético de las capas subterráneas. Estructuras como sistemas de puesta a tierra, fundaciones profundas, tuberías enterradas, líneas de transmisión, centrales solares y sistemas de protección catódica requieren un conocimiento preciso de la variación de resistividad para garantizar la seguridad, el rendimiento y la longevidad. Sin esta prueba, el diseñador trabaja, metafóricamente, a ciegas en el subsuelo — un lugar donde los imprevistos suelen ser costosos.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;La prueba de sondeo eléctrico tiene como objetivo determinar la resistividad aparente de las diferentes capas del subsuelo, lo que permite identificar espesores, profundidades y contrastes estratigráficos. A partir de estos datos, es posible modelar el perfil geofísico del terreno, lo que subsidia proyectos de ingeniería y análisis ambientales. En términos simples, revela cómo el suelo conduce la electricidad y, a partir de eso, cómo se comportan sus capas internas.<br><br><span style="font-weight: 700;">NORMAS QUE REGULAN Y ORIENTAN:</span>&nbsp;En Brasil, este tipo de prueba está orientado por un conjunto de normas técnicas que garantizan la estandarización y la confiabilidad:<br>NBR 7117 – Determinación de la resistividad del suelo<br>NBR 15751 – Sistema de puesta a tierra – Requisitos<br>NBR 5419 – Protección contra descargas atmosféricas&nbsp;(para aplicaciones relacionadas con pararrayos y mallas de puesta a tierra)<br>IEEE Std 81 – Guía para medir la resistividad de la tierra, la impedancia de la tierra y los potenciales de la superficie de la tierra<br>ABNT/CE 003:064.001 – Pruebas geofísicas&nbsp;(con recomendaciones generales)<br>Estos documentos orientan desde el procedimiento de campo hasta la interpretación de los datos.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;Esta prueba está destinada a: ingenieros civiles y geotécnicos; diseñadores de sistemas de puesta a tierra; empresas de transmisión de energía; diseñadores de centrales solares y eólicas; empresas de geofísica aplicada; sector ambiental y de investigación de contaminación e industrias que requieren una alta confiabilidad eléctrica.<br><br><span style="font-weight: 700;">DESCRIPCIÓN TÉCNICA DE LA ACTIVIDAD:</span>&nbsp;La sondeadora eléctrica – también llamada Sondeadora Eléctrica Vertical (SEV) – consiste en la aplicación de corriente eléctrica en el suelo y la medición del potencial resultante para calcular la resistividad aparente de las capas. El método tradicional utiliza arreglos de electrodos como:<br>Wenner; Schlumberger y Dipolo-Dipolo (más utilizado en mapeos horizontales)<br>El equipo inyecta corriente entre dos electrodos y mide la diferencia de potencial entre otros dos. A partir de estos valores, se calcula la resistividad aparente. Variando progresivamente el espaciamiento entre electrodos, se obtienen información en profundidades mayores, lo que permite modelar el subsuelo.<br>El resultado se interpreta mediante curvas de resistividad e inversiones geofísicas, lo que revela capas, interfaces, humedad y posibles materiales (arcillas, arenas, rocas, circulación de agua, etc.).<br><br><span style="font-weight: 700;">DIFERENCIA TÉCNICA ENTRE RESISTIVÍMETRO Y TERRÓMETRO:</span>&nbsp;Aquí está la distinción que todo ingeniero debería tener en mente:<br><span style="font-weight: 700;">RESISTIVÍMETRO:</span> Instrumento específico para sondeos eléctricos geofísicos. Mide la resistividad aparente de las capas del suelo.<br>Opera con mayor amplitud de corriente, más sensibilidad y capacidad para arreglos largos (decenas a centenas de metros).<br>Permite la adquisición continua para interpretación estratigráfica. Utilizado para modelar el subsuelo y investigaciones profundas. Es, digamos, el equipo "arqueólogo eléctrico".<br><span style="font-weight: 700;">TERRÓMETRO:</span> Instrumento utilizado para medir la resistencia de puesta a tierra. Mide la resistencia eléctrica de un punto o sistema de puesta a tierra, no la resistividad estratigráfica. Proyectado para baja profundidad y menor amplitud de corriente. Utiliza métodos simplificados como el método del triángulo o estaca auxiliar. No es adecuado para sondeos geofísicos.<br>Es el "clínico general de la puesta a tierra": óptimo en lo que hace, pero no para investigar el subsuelo.<br><br><span style="font-weight: 700;">EN RESUMEN:</span><br>El resistivímetro investiga el subsuelo;<br>El terrómetro evalúa la puesta a tierra instalada.<br><br><span style="font-weight: 700;">RESUMEN DE LA ACTIVIDAD:</span> La sondeadora eléctrica para determinar la resistividad del suelo es un método geofísico esencial para conocer el comportamiento eléctrico y geotécnico de las capas subterráneas. Ella utiliza un resistivímetro para aplicar corriente eléctrica en el suelo y medir la respuesta en profundidad, generando modelos confiables para proyectos de ingeniería. La actividad sigue normas nacionales e internacionales y proporciona datos decisivos para el dimensionamiento seguro y eficiente de sistemas de puesta a tierra, fundaciones y estudios ambientales.​</p>
      </div>
    </section>
