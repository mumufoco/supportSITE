...
@section('lang', 'es')
@section('title', 'Sonda Elétrica Focada')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sonda-Elétrica-Focada.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SONDA ELÉCTRICA FOCADA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">Esta sonda mide la resistividad con excelente resolución vertical y de profundidad. Incluye un electrodo de corriente central colocado entre dos electrodos de protección, mantenidos a la misma potencia. La corriente del electrodo central es limitada a un disco fino por la presencia de los dos electrodos de protección.<br><br>1. Indicación de zonas permeables y porosidad;<br>2. Indicación de fracturas y áreas patentes;<br>3. Límites de capas y mediciones de espesor;<br>4. Resolución de resistividad: 0,125 ohm.m (rango de medición de fondo de escala de 8kohm.m);<br>5. 0,5 ohm.m (rango de medición de escala 32kohm.m);<br>6. Resolución de conductividad: 0,03125 mmho/m (rango de medición de 2 kmmho/m);<br>7. Resolución de capacitancia: 1nF/m (rango de medición de 65μF/m).</p>
      </div>
    </section>
