...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Acessibilidade.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTO DE ACCESIBILIDAD</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">LA ELABORACIÓN DE PROYECTOS DE ACCESIBILIDAD ES ESENCIAL PARA CREAR AMBIENTES INCLUSIVOS, QUE PUEDAN SER UTILIZADOS POR TODAS LAS PERSONAS, INDEPENDIENTEMENTE DE SUS HABILIDADES FÍSICAS, SENSORIALES O COGNITIVAS. ESTOS PROYECTOS ENGLOBAN EL PLANEO Y DISEÑO DE ESPACIOS, EDIFICIOS Y INFRAESTRUCTURAS DE FORMA A GARANTIZAR EL ACCESO, LA MOVILIDAD Y LA PARTICIPACIÓN PLENA DE TODOS. LA NECESIDAD DE ELABORAR PROYECTOS DE ACCESIBILIDAD ES EVIDENTE POR DIVERSOS MOTIVOS:<br><br><span style="font-weight: 700;">1. DERECHOS HUMANOS:</span> LA ACCESIBILIDAD ES UN DERECHO HUMANO FUNDAMENTAL. LA ELABORACIÓN DE PROYECTOS DE ACCESIBILIDAD BUSCA ELIMINAR BARRERAS QUE IMPIDEN O LIMITAN LA PARTICIPACIÓN DE PERSONAS CON DEFICIENCIA EN TODAS LAS ÁREAS DE LA VIDA.<br><span style="font-weight: 700;">2. INCLUSIÓN SOCIAL:</span> PROYECTOS DE ACCESIBILIDAD PROMUEVEN LA INCLUSIÓN DE PERSONAS CON DEFICIENCIA EN LA SOCIEDAD, PERMITIENDO QUE ELLOS TENGAN IGUALDAD DE OPORTUNIDADES Y INTERAJEN CON OTRAS PERSONAS EN AMBIENTES VARIADOS.<br><span style="font-weight: 700;">3. ACCESO A SERVICIOS:</span> LA ELABORACIÓN DE PROYECTOS DE ACCESIBILIDAD ES NECESARIA PARA GARANTIZAR QUE TODAS LAS PERSONAS PUEDAN ACCEDER A SERVICIOS PÚBLICOS, COMERCIOS, EDIFICIOS Y INSTALACIONES.<br><span style="font-weight: 700;">4. MOVILIDAD:</span> PROYECTOS DE ACCESIBILIDAD VISAN FACILITAR LA MOVILIDAD DE PERSONAS CON DEFICIENCIA, FORNECIENDO RAMPAS, ELEVADORES, CORRIMÄOS Y OTROS ELEMENTOS QUE PERMITAN EL DESLOZAMIENTO.<br><span style="font-weight: 700;">5. AUTONOMÍA:</span> LA ACCESIBILIDAD PERMITE QUE LAS PERSONAS CON DEFICIENCIA TENGAN MAYOR AUTONOMÍA, REDUCIENDO LA NECESIDAD DE ASISTENCIA CONSTANTE PARA SE LOCOMOVER O REALIZAR TAREAS.<br><span style="font-weight: 700;">6. CUMPLIMIENTO DE LEYES Y NORMAS:</span> MUCHOS PAÍSES POSEEN LEYES Y REGULAMENTACIONES QUE EXIGEN LA INCLUSIÓN DE RECURSOS DE ACCESIBILIDAD EN EDIFICIOS Y ESPACIOS PÚBLICOS.<br><span style="font-weight: 700;">7. ENVEJECIMIENTO DE LA POBLACIÓN:</span> PROYECTOS DE ACCESIBILIDAD TAMBIÉN BENEFICIAN A LOS ANCIANOS, CUYAS HABILIDADES FÍSICAS Y COGNITIVAS PUEDEN DETERIORARSE CON LA EDAD.<br><span style="font-weight: 700;">8. DISEÑO UNIVERSAL:</span> LA ELABORACIÓN DE PROYECTOS DE ACCESIBILIDAD INCORPORA PRINCIPIOS DE DISEÑO UNIVERSAL, QUE BUSCAN CREAR AMBIENTES QUE PUEDAN SER USADOS POR TODAS LAS PERSONAS, INDEPENDIENTEMENTE DE SUS CARACTERÍSTICAS.<br><span style="font-weight: 700;">9. INDEPENDENCIA:</span> LA ACCESIBILIDAD PERMITE QUE LAS PERSONAS CON DEFICIENCIA REALICEN TAREAS COTIDIANAS CON INDEPENDENCIA Y DIGNIDAD.<br><span style="font-weight: 700;">10. SENSIBILIZACIÓN Y CONCIENTIZACIÓN:</span> LA INCLUSIÓN DE RECURSOS DE ACCESIBILIDAD EN LOS PROYECTOS AYUDA A SENSIBILIZAR A LAS PERSONAS SOBRE LA IMPORTANCIA DE LA DIVERSIDAD Y LA IGUALDAD.<br><span style="font-weight: 700;">11. TURISMO ACCESIBLE:</span> PROYECTOS DE ACCESIBILIDAD SON CRUCIALES PARA PROMOVER EL TURISMO ACCESIBLE, PERMITIENDO QUE PERSONAS CON DEFICIENCIA PUEDAN DISFRUTAR DE LUGARES TURÍSTICOS.<br><span style="font-weight: 700;">12. SEGURIDAD:</span> LA ACCESIBILIDAD TAMBIÉN INCLUYE MEDIDAS DE SEGURIDAD, COMO SALIDAS DE EMERGENCIA ACCESIBLES Y RUTAS DE EVACUACIÓN PARA PERSONAS CON MOVILIDAD REDUCIDA.<br><br>EN RESUMEN, LA ELABORACIÓN DE PROYECTOS DE ACCESIBILIDAD ES NECESARIA PARA CREAR AMBIENTES QUE SEAN ACCESIBLES, INCLUSIVOS Y IGUALITARIOS PARA TODAS LAS PERSONAS. ESTOS PROYECTOS GARANTIZAN QUE PERSONAS CON DEFICIENCIA PUEDAN PARTICIPAR PLENAMENTE DE LA SOCIEDAD, PROMOVIENDO LA DIGNIDAD, LA INDEPENDENCIA Y LA IGUALDAD DE OPORTUNIDADES.</p>
      </div>
    </section>
