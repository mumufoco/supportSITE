...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Drenagem.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Drenagem.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Drenagem.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Drenagem.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1651">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PROYECTO DE DRENADO</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">La elaboración de proyectos de drenado es fundamental para planificar e implementar sistemas efectivos de gestión de aguas pluviales y escurrimiento de agua en áreas urbanas y rurales. Estos proyectos involucran la planificación y el diseño de sistemas que garanticen el control adecuado del agua de la lluvia, evitando inundaciones, erosiones y otros problemas relacionados con el agua. La necesidad de elaborar proyectos de drenado es evidente por diversos motivos:<br><br><span style="font-weight: 700;">1. Prevención de Inundaciones:</span> La principal función de los sistemas de drenado es prevenir inundaciones, especialmente en áreas urbanas densamente pobladas, donde el escurrimiento inadecuado del agua de la lluvia puede causar daños significativos.<br><span style="font-weight: 700;">2. Erosión del Suelo:</span> Proyectos de drenado previenen la erosión del suelo, que ocurre cuando el agua de la lluvia no es debidamente controlada, llevando a la pérdida de suelo fértil y a la degradación del ambiente.<br><span style="font-weight: 700;">3. Preservación de Estructuras:</span> Sistemas de drenado adecuados protegen estructuras, como edificios, carreteras y puentes, evitando daños causados por el exceso de agua.<br><span style="font-weight: 700;">4. Calidad del Agua:</span> La elaboración de proyectos de drenado considera la calidad del agua, evitando la contaminación de cuerpos de agua con contaminantes transportados por las aguas pluviales.<br><span style="font-weight: 700;">5. Sostenibilidad:</span> Proyectos de drenado sostenible pueden incluir técnicas como pavimentos permeables y biovaletas, que ayudan a recargar los acuíferos y minimizar el escurrimiento superficial.<br><span style="font-weight: 700;">6. Planificación Urbana:</span> El drenado es una consideración importante en la planificación urbana, asegurando que el crecimiento de las ciudades ocurra de forma sostenible.<br><span style="font-weight: 700;">7. Control de Sedimentos:</span> Proyectos de drenado pueden incluir bacias de retención para capturar sedimentos y contaminantes antes de que alcancen los cursos de agua.<br><span style="font-weight: 700;">8. Riesgos de Deslizamientos:</span> En áreas íngremes, el drenado es crucial para evitar deslizamientos de tierra causados por agua en exceso.<br><span style="font-weight: 700;">9. Conformidad con Normas:</span> Muchas jurisdicciones poseen regulaciones que exigen la implementación de sistemas de drenado adecuados para nuevos emprendimientos.<br><span style="font-weight: 700;">10. Control de Inundaciones:</span> Proyectos de drenado pueden incluir la construcción de reservorios de retención para controlar el flujo de agua y evitar inundaciones en áreas críticas.<br><span style="font-weight: 700;">11. Mantenimiento de Vías Públicas:</span> Sistemas de drenado evitan daños a las vías públicas causados por el acúmulo de agua.<br><span style="font-weight: 700;">12. Salud Pública:</span> La elaboración de proyectos de drenado protege la salud pública, minimizando la proliferación de enfermedades transmitidas por el agua.<br><br>En resumen, la elaboración de proyectos de drenado es necesaria para garantizar el manejo adecuado de las aguas pluviales, prevenir inundaciones, proteger estructuras y preservar el ambiente. Estos proyectos son esenciales para asegurar la seguridad y la calidad de vida de las comunidades, mientras promueven la sostenibilidad y la conservación de los recursos hídricos.</p>
      </div>
    </section>
