...
@section('lang', 'es')
@section('title', 'Política de Assédio Moral')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-de-Assédio-Moral.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.politica-de-assedio-moral') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Política-de-Assédio-Moral.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Política-de-Assédio-Moral.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POLÍTICA DE PREVENCIÓN AL ACOSO MORAL Y SEXUAL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">1. Introducción:</span><br>El Soporte Solo Sondajes está comprometido en proporcionar un ambiente de trabajo seguro, respetuoso y libre de cualquier forma de acoso. Esta política establece directrices claras para prevenir y combatir el acoso moral y sexual en todas nuestras operaciones.<br><br><span style="font-weight: 700;">2. Definiciones:</span><br>Acoso Moral: Comprende la práctica de conductas abusivas, de forma repetitiva y prolongada, que apuntan a desestabilizar emocionalmente, perjudicar la autoestima, y constreñir al individuo.<br>Acoso Sexual: Se refiere a cualquier conducta de naturaleza sexual no deseada, que tenga el propósito o el efecto de violar la dignidad de una persona, en especial cuando crea un ambiente intimidatorio, hostil, degradante, humillante o ofensivo.<br><br><span style="font-weight: 700;">3. Compromiso con el Respeto:</span><br>El Soporte Solo Sondajes promueve una cultura de respeto, dignidad e inclusión, donde todos los colaboradores son tratados con igualdad y consideración.<br><br><span style="font-weight: 700;">4. Prohibición Absoluta:</span> <br>Está estrictamente prohibido practicar o tolerar cualquier forma de acoso moral o sexual en las dependencias de la empresa o en actividades relacionadas con el trabajo.<br><br><span style="font-weight: 700;">5. Responsabilidad de Todos:</span> <br>Todos los colaboradores, independientemente de cargo o función, tienen la responsabilidad de prevenir y denunciar cualquier comportamiento de acoso que presencien o del cual sean víctimas.<br><br><span style="font-weight: 700;">6. Canales de Denuncia:</span><br>En línea: <a href="https://sitio.soportesondajes.com.br/formulario_denuncia/" class="u-active-none u-border-none u-btn u-button-style u-hover-none u-none u-text-palette-1-base u-btn-1 u-block-control" style="background-image: none; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0" data-block="3901">https://sitio.soportesondajes.com.br/formulario_denuncia/</a><br>Físico: Casilla de sugerencias localizada Avenida T-4, 619, Sector Bueno, Goiânia – Goiás.<br><br><span style="font-weight: 700;">7. Sigilo y Protección al Denunciante:</span><br>Todas las denuncias serán tratadas de forma sigilosa y confidencial. El Soporte Solo Sondajes asegura que ningún denunciante será sujeto a represalias.<br><br><span style="font-weight: 700;">8. Proceso de Investigación:</span> <br>Todas las denuncias serán investigadas de forma imparcial y objetiva. En caso de que la acusación sea confirmada, se tomarán las medidas disciplinarias adecuadas.<br><br><span style="font-weight: 700;">9. Consecuencias del Acoso:</span><br>El acoso moral o sexual es pasible de medidas disciplinarias, que pueden incluir advertencia, suspensión, despido por justa causa, además de acciones legales conforme la gravedad del caso.<br><br><span style="font-weight: 700;">10. Sensibilización y Capacitación:</span> <br>El Soporte Solo Sondajes promoverá regularmente capacitaciones y campañas de concienciación sobre prevención del acoso.<br><br><span style="font-weight: 700;">11. Actualización y Revisión:</span><br>Esta política será revisada periódicamente para garantizar su eficacia y conformidad con las leyes vigentes.<br><br>El Soporte Solo Sondajes refuerza el compromiso con un ambiente de trabajo seguro, respetuoso e inclusivo, donde todos los colaboradores puedan desempeñar sus funciones con dignidad y tranquilidad.</p>
      </div>
    </section>
