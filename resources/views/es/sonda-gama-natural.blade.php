...
@section('lang', 'es')
@section('title', 'Sonda Gama Natural')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sonda-Gama-Natural.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SONDA GAMA NATURAL Y DE TEMPERATURA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">Esta sonda proporciona una solución para casos en que solo se necesita un registro de gama natural de conteos totales básicos y también proporciona una medición de temperatura de fluido de pozo, útil para corregir otros registros.<br><br>Basado en un detector de cristal de centelo NaI (Tl) de ø 25 x 50 mm acoplado a un tubo fotomultiplicador de alto rendimiento, la sonda tiene una sensibilidad excelente (± 1,2 cps / unidad API) y proporciona un resultado de alta calidad.<br><br>Además de su función principal como indicador de litología o arcilla, una medición de gama natural se utiliza frecuentemente como base para establecer correlaciones entre sondeos y para garantizar una correspondencia precisa de profundidad entre diferentes corridas de perfilaje realizadas en el mismo sondeo.</p>
      </div>
    </section>
