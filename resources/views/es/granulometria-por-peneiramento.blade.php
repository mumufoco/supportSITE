...
@section('lang', 'es')
@section('title', 'Granulometria por Peneiramento')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Granulometria-por-Peneiramento.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​GRANULOMETRÍA POR PENETRACIÓN - PEN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">El ensayo laboratorial de granulometría por penetración es un procedimiento utilizado para determinar la distribución de las diferentes fracciones granulométricas presentes en una muestra de suelo o agregado. Este ensayo es crucial en la geotecnia y la ingeniería civil para evaluar la composición granulométrica de materiales utilizados en construcción, como arena, cascajo y suelos. La distribución granulométrica influye en las propiedades y el comportamiento de los materiales en obras de ingeniería.<br><br>Aquí está una descripción general del ensayo de granulometría por penetración:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar la distribución de las diferentes fracciones granulométricas presentes en una muestra de suelo o agregado.<br><br><span style="font-weight: 700;">Equipos y Materiales:</span><br><span style="font-weight: 700;">1. Conjunto de peneiras de diferentes aberturas (mallados);<br>2. Agitador mecánico o manual;<br>3. Balanzas de precisión;<br>4. Recipiente para la muestra;<br>5. Escoba para limpieza de las peneiras;<br>6. Pala de excavación;<br>7. Paños de limpieza;</span><br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo o agregado es colectada y seca al aire para eliminar el exceso de humedad. La muestra es luego triturada y pasada por la peneira de abertura 4,75 mm para remover partículas más grandes.<br><span style="font-weight: 700;">2. Selección de las Peneiras:</span>&nbsp;Un conjunto de peneiras con aberturas de diferentes tamaños es seleccionado. Las peneiras son numeradas y sus aberturas son determinadas.<br><span style="font-weight: 700;">3. Penetración:</span>&nbsp;La muestra es colocada en la peneira superior y el conjunto de peneiras es colocado en un agitador mecánico o agitado manualmente para separar las partículas según el tamaño. El ensayo es conducido por un período específico para garantizar que todas las partículas pasibles de ser retenidas tengan la oportunidad de pasar por las peneiras.<br><span style="font-weight: 700;">4. Pesaje:</span>&nbsp;Después de la penetración, cada peneira es pesada con las partículas retenidas. Las partículas retenidas en cada peneira son pesadas individualmente.<br><span style="font-weight: 700;">5. Cálculos:</span>&nbsp;Con base en las masas de las partículas retenidas en cada peneira, se calcula el porcentaje de masa que pasa por cada abertura, creando así la curva granulométrica.<br><span style="font-weight: 700;">6. Interpretación:</span>&nbsp;La curva granulométrica resultante del ensayo de penetración muestra la distribución porcentual de masa de las diferentes fracciones granulométricas en la muestra. Esto ayuda a identificar la proporción de partículas finas, medianas y gruesas presentes en el material.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El análisis granulométrico es fundamental para evaluar la adecuación de un suelo o agregado para uso en construcción. Influye en la compactación, permeabilidad, capacidad de drenaje, comportamiento en términos de deformación y resistencia de los materiales. Además, la granulometría se utiliza para clasificar suelos según sistemas de clasificación como el Sistema Unificado de Clasificación de Suelos (SUCS). En resumen, el ensayo laboratorial de granulometría por penetración es una herramienta esencial para evaluar la composición granulométrica de suelos y agregados, proporcionando información crucial para proyectos de ingeniería geotécnica y construcción.​</p>
      </div>
    </section>
    <section class="u-clearfix u-section-5" id="sec-0f61">
      <div class="u-border-3 u-border-grey-dark-1 u-expanded-width u-line u-line-horizontal u-line-1"></div>
    </section>
