...
@section('lang', 'es')
@section('title', 'Sondagem a Percussão')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sondagem-a-Percussão.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">SONDAJE A PERCUSIÓN - SP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span> La prueba de campo de sondeo a percusión, o SPT (Prueba de Penetración Estándar), es necesaria para obtener información sobre las propiedades del suelo en profundidades subsuperficiales. Esta información es esencial para proyectos de ingeniería geotécnica, como la evaluación de la capacidad de carga del suelo, dimensionamiento de fundaciones, proyectos de contención, entre otros. El SPT se utiliza para comprender cómo se comporta el suelo bajo carga y para tomar decisiones informadas sobre el proyecto y la construcción de estructuras.<br><br><span style="font-weight: 700;">OBJETIVO:</span> El objetivo principal de la prueba SPT es evaluar la resistencia del suelo y sus características geotécnicas en profundidad. Esto ayuda a los ingenieros a determinar la capacidad de carga del suelo, la resistencia al corte, la cohesión y el ángulo de fricción interno, información crucial para el proyecto de fundaciones, estructuras de soporte y otras obras geotécnicas.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span> Las normas brasileñas que tratan de la prueba SPT son:<br>NBR 6484:2010 - Suelo - Sondeos de reconocimiento simple con SPT - Método de prueba.<br>NBR 8036:1993 - Programación de sondeos de reconocimiento simple de suelos para fundaciones de edificios.<br>NBR 9603:1986 - Proyecto y ejecución de sondeos de reconocimiento simple de suelos para fundaciones de edificios.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span> El público objetivo de la prueba SPT incluye ingenieros geotécnicos, ingenieros civiles, geólogos y otros profesionales involucrados en proyectos de ingeniería geotécnica. Empresas de construcción, consultorías de ingeniería, organismos gubernamentales de planificación y regulación, así como profesionales académicos y de investigación, también se benefician de la información obtenida a través de la prueba SPT.<br><br><span style="font-weight: 700;">TÉCNICA:</span> La técnica de la prueba SPT implica las siguientes etapas:<br><span style="font-weight: 700;">1. INSTALACIÓN DE LA SONDA:</span> Se instala una sonda de percusión en el lugar de sondeo, generalmente utilizando varillas de extensión para alcanzar las profundidades deseadas.<br><span style="font-weight: 700;">2. MARTELEO:</span> Un martillo de caída libre se eleva y suelta, haciéndolo caer sobre la sonda. La sonda penetra en el suelo con cada golpe del martillo.<br><span style="font-weight: 700;">3. PENETRACIÓN Y MUESTREO:</span> La sonda penetra en el suelo a través de golpes sucesivos. La prueba puede ser interrumpida en intervalos para recopilar muestras de suelo utilizando un barrilete o muestreador.<br><span style="font-weight: 700;">4. CONTEO DE GOLPES:</span> Se registra la penetración de la sonda después de cada golpe. El número de golpes necesarios para que la sonda penetre una determinada distancia se conoce como número de golpes SPT (N).<br><span style="font-weight: 700;">5. PROFUNDIDAD:</span> Se mide la profundidad de penetración a medida que la sonda avanza.<br><br>La información obtenida durante la prueba SPT se utiliza para evaluar las características del suelo, estimar su resistencia, cohesión, ángulo de fricción interno y otras propiedades. Estos datos son cruciales para el proyecto de fundaciones seguras, selección de estructuras adecuadas y toma de decisiones de ingeniería informadas.<br>En resumen, la prueba de campo de sondeo a percusión (SPT) es una técnica fundamental en la ingeniería geotécnica para obtener información sobre las características del suelo en profundidades subsuperficiales. Se utiliza por una variedad de profesionales y organizaciones involucradas en proyectos de ingeniería y construcción en Brasil, siguiendo las normas establecidas.</p>
      </div>
    </section>
