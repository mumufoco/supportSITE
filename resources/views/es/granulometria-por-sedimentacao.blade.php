...
@section('lang', 'es')
@section('title', 'Granulometria por Sedimentação')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Granulometria-por-Sedimentação.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">GRANULOMETRÍA POR SEDIMENTACIÓN - SED</h2>
        <p class="u-align-justify u-text u-text-2">​El ensayo laboratorial de granulometría por sedimentación es un procedimiento utilizado para determinar la distribución de las diferentes fracciones granulométricas presentes en una muestra de suelo o agregado, con base en la velocidad de sedimentación de las partículas en un líquido. Este ensayo es crucial en la geotecnia y la ingeniería civil para evaluar la composición granulométrica de materiales utilizados en construcción, como arena, cascalho y suelos. La distribución granulométrica influye en las propiedades y el comportamiento de los materiales en obras de ingeniería.<br><br>Aquí está una descripción general del ensayo de granulometría por sedimentación:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar la distribución de las diferentes fracciones granulométricas presentes en una muestra de suelo o agregado con base en la velocidad de sedimentación de las partículas en un líquido.<br><br><span style="font-weight: 700;">Equipos y Materiales:<br>1. Cilindro de sedimentación (pipeta o cilindro de Imhoff);<br>2. Muestra de suelo;<br>3. Agua destilada;<br>4. Balanza de precisión;<br>5. Cronómetro;<br>6. Tubo de dispersión (dispersante químico);<br>7. Agitador magnético (opcional);</span><br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo o agregado es colectada y seca al aire para eliminar el exceso de humedad. La muestra es entonces triturada y pasada por la peneira de abertura 4,75 mm para remover partículas más grandes.<br><span style="font-weight: 700;">2. Preparación de la Suspensión:</span>&nbsp;La muestra es colocada en agua destilada y un tubo de dispersión es utilizado para agitar y dispersar las partículas. El tubo de dispersión ayuda a evitar la aglomeración de las partículas y la formación de burbujas de aire.<br><span style="font-weight: 700;">3. Llenado del Cilindro:</span>&nbsp;El cilindro de sedimentación es llenado con la suspensión resultante de la muestra y agua destilada. La suspensión es bien mezclada para garantizar una distribución uniforme de las partículas.<br><span style="font-weight: 700;">4. Inicio de la Sedimentación:</span>&nbsp;El cronómetro es iniciado en el momento en que la suspensión es colocada en el cilindro de sedimentación. La sedimentación ocurre a lo largo del tiempo, con las partículas más grandes sedimentando más rápidamente que las más pequeñas.<br><span style="font-weight: 700;">5. Medición de las Alturas de Sedimentación:</span>&nbsp;Después de tiempos específicos (generalmente cada 30 minutos o 1 hora), la altura de la interfaz entre las partículas sedimentadas y el líquido es medida en el cilindro.<br><span style="font-weight: 700;">6. Cálculos:</span>&nbsp;Con base en las alturas de sedimentación medidas a lo largo del tiempo, se construye una curva de sedimentación. A partir de esta curva, es posible determinar el porcentaje acumulado de partículas que sedimentaron en intervalos de tiempo específicos.<br><span style="font-weight: 700;">7. Interpretación:</span>&nbsp;La curva de sedimentación resultante del ensayo de granulometría por sedimentación muestra la distribución acumulada de las diferentes fracciones granulométricas en función del tiempo. Esto ayuda a identificar la tasa de sedimentación de las partículas en relación con su tamaño.<br><br>Utilidad:&nbsp;El análisis granulométrico por sedimentación es una alternativa al ensayo de granulometría por peneiramento y es utilizado cuando las partículas son muy finas para ser eficazmente peneiradas. Este ensayo proporciona información importante sobre la distribución granulométrica de suelos y agregados.<br>En resumen, el ensayo laboratorial de granulometría por sedimentación es una herramienta esencial para evaluar la composición granulométrica de suelos y agregados con partículas finas, proporcionando información crucial para proyectos de ingeniería geotécnica y construcción.</p>
      </div>
    </section>
