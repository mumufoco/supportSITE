...
@section('lang', 'es')
@section('title', 'Política Anticorrupção')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Política-Anticorrupção.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.politica-anticorrupcao') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Política-Anticorrupção.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Política-Anticorrupção.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">POLÍTICA DE ANTICORRUPCIÓN</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">1. Introducción:</span><br>El soporte Solo Sondajes está comprometido con los más altos estándares éticos y de integridad en todas sus operaciones. Esta política de anticorrupción establece directrices claras y compromisos para prevenir, detectar y combatir cualquier forma de corrupción en nuestras actividades.<br><br><span style="font-weight: 700;">2. Compromiso con la Integridad:</span><br>El soporte Solo Sondajes prohíbe y condena enérgicamente cualquier forma de corrupción, soborno o actividad ilegal en todas sus operaciones.<br><br><span style="font-weight: 700;">3. Definición de Corrupción:</span><br>Para los efectos de esta política, la corrupción se refiere a cualquier forma de soborno, propina, extorsión, facilitación de pagos o cualquier actividad ilegal destinada a obtener ventajas indebidas.<br><br><span style="font-weight: 700;">4. Canal de Denuncia Anónima:</span><br>El soporte Solo Sondajes dispone de un canal de denuncia anónima para que los colaboradores, clientes, proveedores y otras partes interesadas puedan informar cualquier sospecha de corrupción, sin temor a represalias.<br><br><span style="font-weight: 700;">5. Canales de Denuncia:</span><br>En línea: <a href="https://sitio.supportsondagens.com.br/formulario_denuncia/" target="_blank" rel="noopener noreferrer" class="u-active-none u-border-0 u-btn u-button-link u-button-style u-hover-feature u-hover-none u-text-active-negro u-text-hover-negro u-text-palette-1-base u-none u-block-control u-btn-1" style="background-image: none; padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 0" data-block="3752">https://sitio.supportsondagens.com.br/formulario_denuncia/</a><br>Físico: Casilla de sugerencias ubicada en Avenida T-4, 619, Sector Bueno, Goiânia – Goiás.<br><br><span style="font-weight: 700;">6. Proceso de Denuncia:</span><br>Todas las denuncias recibidas serán tratadas con la máxima confidencialidad y imparcialidad. El equipo designado para la investigación garantizará la protección del denunciante y la averiguación rigurosa de los hechos.<br><br><span style="font-weight: 700;">7. Protección al Denunciante:</span><br>El soporte Solo Sondajes no tolerará cualquier forma de represalia contra aquellos que hagan denuncias de buena fe. El anonimato del denunciante será rigurosamente protegido.<br><br><span style="font-weight: 700;">8. Tratamiento de las Denuncias:</span><br>Todas las denuncias serán tratadas de forma justa y imparcial, con la debida diligencia y en conformidad con las leyes aplicables.<br><br><span style="font-weight: 700;">9. Acciones Disciplinarias:</span><br>Si una denuncia de corrupción es confirmada, se tomarán las medidas disciplinarias apropiadas, que pueden incluir despido, suspensión o otras acciones legales, según la gravedad del caso.<br><br><span style="font-weight: 700;">10. Capacitación y Concientización:</span><br>El soporte Solo Sondajes proporcionará capacitación regular sobre anticorrupción para todos los colaboradores, con el fin de promover una cultura de integridad y cumplimiento.<br><br><span style="font-weight: 700;">11. Actualización y Revisión:</span><br>Esta política será revisada periódicamente para garantizar que continúe alineada con las leyes y regulaciones vigentes.<br><br>El soporte Solo Sondajes reafirma su compromiso con la integridad y la ética en los negocios y anima a todos los colaboradores y partes interesadas a unirse en este esfuerzo.</p>
      </div>
    </section>
