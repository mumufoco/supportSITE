...
@section('lang', 'es')
@section('title', 'Ensaio PH Laboratorial')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Ensaio-PH-Laboratorial.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">ENSAIO DE pH LABORATORIAL</h2>
        <p class="u-align-justify u-text u-text-2"><span style="font-weight: 700;">OBJETIVO:</span> El ensayo de pH en el suelo tiene como finalidad determinar el nivel de acidez o alcalinidad presente en el suelo, lo que es crucial para comprender las características químicas y la viabilidad de determinadas actividades de construcción.Procedimiento:<br>Recogida de la muestra:<br>Una muestra representativa del suelo se recoge en el lugar de sondeje, considerando la profundidad y localización adecuadas.<br><br><span style="font-weight: 700;">1. Preparación de la muestra:</span> La muestra se prepara para el ensayo, eliminando impurezas y materiales extraños que puedan interferir en los resultados.<br><br><span style="font-weight: 700;">2. Medición del pH:</span> Utilizando un medidor de pH calibrado, la muestra de suelo se mezcla con agua destilada en proporciones específicas para obtener una suspensión homogénea. El electrodo del medidor se inserta entonces en la suspensión y el pH se registra.<br><br><span style="font-weight: 700;">3. Anotación de los resultados</span>: El valor del pH obtenido se registra y se asocia con la profundidad y localización de la muestra.<br><br><span style="font-weight: 700;">4. Interpretación de los resultados:</span> pH &lt; 7 indica suelo ácido; pH = 7 indica suelo neutro; pH &gt; 7 indica suelo alcalino; Informe de ensayo de pH:<br><br><span style="font-weight: 700;">Observación:</span> Asegúrese de seguir las normas y buenas prácticas de ensayos geotécnicos al realizar este procedimiento. Los resultados deben ser interpretados por un profesional calificado.</p>
      </div>
    </section>
