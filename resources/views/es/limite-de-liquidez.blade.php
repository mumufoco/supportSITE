...
@section('lang', 'es')
@section('title', 'Limite de Liquidez')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Limite-de-Liquidez.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">LIMITE DE LIQUIDEZ - LL</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">El ensayo laboratorial de limite de liquidez es un procedimiento utilizado para determinar la humedad en la que un suelo arcilloso transita del estado liquido al estado plastico. Este ensayo es fundamental en la geotecnia y la ingenieria civil para evaluar las caracteristicas de plasticidad de los suelos y clasificarlos de acuerdo con su consistencia. El limite de liquidez es uno de los parametros utilizados en la clasificacion de los suelos de acuerdo con su plasticidad.<br><br>Aqui esta una descripcion general del ensayo de limite de liquidez:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar el contenido de humedad en el que un suelo arcilloso pasa del estado liquido al estado plastico, definiendo el limite entre estos dos estados de comportamiento.<br><br><span style="font-weight: 700;">Equipos y Materiales:</span><br><span style="font-weight: 700;">1. Capsulas de Casagrande;</span><br><span style="font-weight: 700;">2. Muestra de suelo;</span><br><span style="font-weight: 700;">3. Espatula;</span><br><span style="font-weight: 700;">4. Balanza de precision;</span><br><span style="font-weight: 700;">5. Estufa;</span><br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparacion de la Muestra:</span>&nbsp;Una muestra representativa del suelo es colectada y seca al aire para eliminar el exceso de humedad. Luego, la muestra es triturada y pasada por la peneira de abertura 0,425 mm para remover particulas mayores.<br><span style="font-weight: 700;">2. Preparacion de las Capsulas:</span>&nbsp;Las capsulas de Casagrande, que tienen una abertura padronizada, son limpiadas y secas, y su masa es medida.<br><span style="font-weight: 700;">3. Moldado de la Muestra:</span>&nbsp;La muestra de suelo es mezclada con agua hasta alcanzar una consistencia pastosa. La muestra es entonces colocada en una de las capsulas de Casagrande.<br><span style="font-weight: 700;">4. Determinacion del Limite de Liquidez:</span>&nbsp;La muestra es moldada en una forma de ranura en el interior de la capsula, y el dispositivo es ajustado para permitir que la ranura se cierre en una distancia especificada (normalmente 10 mm). El proceso de cierre de la ranura es realizado por medio de una serie de golpes en una base padronizada.<br><span style="font-weight: 700;">5. Secado en Estufa:</span>&nbsp;La capsula con la muestra moldada es colocada en una estufa a una temperatura especifica (generalmente 105°C a 110°C) hasta que alcance peso constante.<br><span style="font-weight: 700;">6. Calculos:</span>&nbsp;Con base en la masa inicial de la muestra y la masa despues del secado, la humedad inicial y la humedad despues del secado son determinadas. El limite de liquidez es calculado utilizando una formula especifica, relacionando la humedad con el numero de golpes necesarios para cerrar la ranura.<br><span style="font-weight: 700;">7. Interpretacion:</span>&nbsp;El resultado del ensayo es expresado en terminos de humedad (porcentaje de agua) en la que el suelo pasa del estado liquido al estado plastico. Este valor es conocido como “limite de liquidez”.&nbsp;<br><br>El ensayo de limite de liquidez es frecuentemente realizado junto con el ensayo de limite de plasticidad para determinar la plasticidad de un suelo y clasificarlo de acuerdo con la clasificacion del Sistema Unificado de Clasificacion de Suelos (SUCS). En resumen, el ensayo laboratorial de limite de liquidez es esencial para comprender las caracteristicas de plasticidad de suelos arcillosos y auxiliar en la clasificacion de los suelos y en el proyecto de obras de ingenieria geotecnica.​</p>
      </div>
    </section>
