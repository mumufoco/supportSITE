...
@section('lang', 'es')
@section('title', 'Serviços Fundação Profunda')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Serviços-Fundação-Profunda.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.servicos-fundacao-profunda') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Serviços-Fundação-Profunda.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Serviços-Fundação-Profunda.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-1">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-subtitle u-text u-text-default u-text-1">SERVICIOS DE PERFORACIÓN</h2>
        <img class="custom-expanded u-align-center u-border-1 u-border-palette-5-base u-hover-feature u-image u-image-default u-opacity u-opacity-70 u-image-1" src="{{ asset('images/59-Alta-scaled.jpg') }}" alt="" data-image-width="1920" data-image-height="1280" title="PERFURAÇÃO DE HÉLICE CONTINUA​" data-href="/es/Hélice-Continua.html" data-page-id="565716385">
        <h3 class="u-text u-text-default u-text-palette-5-light-2 u-text-2">PERFORACIÓN DE HÉLICE CONTINUA</h3>
      </div>
      
    </section>
    <section class="u-clearfix u-section-2" id="sec-f01c">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="custom-expanded u-align-center u-border-1 u-border-palette-5-base u-hover-feature u-image u-image-default u-opacity u-opacity-70 u-image-1" src="{{ asset('images/60-Alta-scaled.jpg') }}" alt="" data-image-width="1920" data-image-height="1256" title="PERFURAÇÃO DE ESTACA ESCAVADA" data-href="/es/Estaca-Escavada.html" data-page-id="329428586">
        <h3 class="u-text u-text-default u-text-palette-5-light-2 u-text-1">PERFORACIÓN DE PILA CAVADA</h3>
      </div>
