...
@section('lang', 'es')
@section('title', 'Plano de Segurança do Trabalho')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Plano-de-Segurança-do-Trabalho.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.plano-de-seguranca-do-trabalho') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Plano-de-Segurança-do-Trabalho.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Plano-de-Segurança-do-Trabalho.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PLAN DE SEGURIDAD EN EL TRABAJO</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1"><span style="font-weight: 700;">INTRODUCCIÓN:</span><br>El objetivo de este plan es establecer directrices y prácticas para garantizar la seguridad y el bienestar de todos los colaboradores que trabajan en la plaza de sondeos geotécnicos y en la oficina de ingeniería geotécnica de Support Solo Sondajes. Este plan está en conformidad con las regulaciones locales de seguridad en el trabajo.<br><br><span style="font-weight: 700;">EVALUACIÓN DE RIESGOS:</span><br>Se realizará una evaluación de riesgos en ambientes de trabajo, identificando peligros potenciales e implementando medidas de control adecuadas.<br>Equipo de Protección Individual (EPI): Todos los colaboradores serán proporcionados con EPI adecuado para sus funciones, y serán capacitados en su uso correcto.<br><br><span style="font-weight: 700;">CAPACITACIÓN Y ENTRENAMIENTO:</span><br>Todos los colaboradores serán sometidos a capacitaciones periódicas sobre seguridad en el trabajo, incluyendo procedimientos de emergencia, uso de extintores y prácticas seguras de trabajo.<br><br><span style="font-weight: 700;">SEÑALIZACIÓN Y COMUNICACIÓN:</span><br>Señalización adecuada se colocará en lugares estratégicos para indicar rutas de salida, equipos de seguridad y áreas de peligro.<br><br><span style="font-weight: 700;">PREVENCIÓN DE INCENDIOS:</span><br>Extintores de incendio serán mantenidos en lugares estratégicos y serán inspeccionados regularmente.<br><br><span style="font-weight: 700;">PROCEDIMIENTOS DE EMERGENCIA:</span><br>Se establecerá un plan de acción para emergencias, incluyendo evacuación de emergencia y prestación de primeros auxilios.<br><br><span style="font-weight: 700;">CONTROL DE MATERIALES PELIGROSOS:</span><br>Materiales peligrosos serán almacenados, identificados y manipulados de acuerdo con las regulaciones locales.<br><br><span style="font-weight: 700;">GESTIÓN DE RESIDUOS:</span><br>Se implementará un sistema para la recolección y disposición adecuada de residuos, siguiendo las normativas ambientales.<br><br><span style="font-weight: 700;">ERGONOMÍA Y POSTURA ADECUADA:</span><br>Se promoverá la conciencia sobre la importancia de la ergonomía y la postura adecuada en el ambiente de trabajo.<br><br><span style="font-weight: 700;">INSPECCIONES Y AUDITORÍAS DE SEGURIDAD:</span><br>Inspecciones regulares se conducirán para garantizar que todas las prácticas de seguridad estén siendo seguidas correctamente.<br><br><span style="font-weight: 700;">COMUNICACIÓN DE INCIDENTES Y ACCIDENTES:</span><br>Todos los incidentes y accidentes serán comunicados prontamente al equipo de gestión y de salud y seguridad.<br><br><span style="font-weight: 700;">PROGRAMA DE BIENESTAR:</span><br>Se implementará un programa de bienestar que incluya prácticas de salud y seguridad, incentivando el cuidado con la salud física y mental de los colaboradores.<br><br><span style="font-weight: 700;">REVISIÓN Y ACTUALIZACIÓN:</span><br>Este plan será revisado anualmente para garantizar que continúe atendiendo a los estándares de seguridad actuales.<br><br>Support Solo Sondajes se compromete a mantener un ambiente de trabajo seguro y saludable para todos los colaboradores. La responsabilidad por la implementación y cumplimiento de este plan es de todos los niveles de colaboradores y gestores. El incumplimiento de las políticas de seguridad puede resultar en medidas disciplinarias.</p>
      </div>
    </section>
