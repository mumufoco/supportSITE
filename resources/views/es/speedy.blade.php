...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Speedy.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.speedy') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Speedy.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Speedy.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MÉTODO SPEEDY</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial Método Speedy, también conocido como Ensayo Speedy, es un procedimiento utilizado para determinar la humedad en muestras de suelo. Este método es particularmente útil en situaciones donde es necesario obtener resultados rápidamente, como en campos de trabajo o en lugares remotos, donde la humedad del suelo es una información importante para decisiones de construcción e ingeniería.<br><br>Aquí está una descripción general del ensayo Método Speedy:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar rápidamente el contenido de humedad de una muestra de suelo.<br><br><span style="font-weight: 700;">Equipos y Materiales:<br>1. Aparato Speedy (también llamado medidor Speedy);<br>2. Cápsula de muestra (generalmente de aluminio);<br>3. Ampolla que contiene carburo de calcio;<br>4. Dispositivo para aplicar presión a la ampolla;<br>5. Balanza de precisión;<br>6. Instrumento de medición de presión (manómetro);<br>7. Agua destilada;</span><br><br><span style="font-weight: 700;">Procedimiento:<br>1. Preparación de la Muestra:</span>&nbsp;Una muestra de suelo se colecta y se pesa para determinar su masa inicial.<br><span style="font-weight: 700;">2. Cápsula de Muestra:</span>&nbsp;La muestra se coloca en la cápsula y la cápsula se cierra.<br><span style="font-weight: 700;">3. Adición de Carburo de Calcio:</span>&nbsp;La ampolla que contiene carburo de calcio se conecta a la cápsula y una cantidad precisa de agua destilada se adiciona a la ampolla.<br><span style="font-weight: 700;">4. Aplicación de Presión:</span>&nbsp;La ampolla se coloca en el aparato Speedy y se aplica presión a la ampolla, haciendo que el agua interactúe con el carburo de calcio y produzca gas acetileno.<br><span style="font-weight: 700;">5. Medición de la Presión:</span>&nbsp;El gas acetileno generado por la reacción se mide mediante un manómetro.<br><span style="font-weight: 700;">6. Cálculo de la Humedad:</span>&nbsp;Con base en la presión del gas acetileno generado y la masa inicial de la muestra, es posible calcular el contenido de humedad del suelo.<br><span style="font-weight: 700;">7. Interpretación:</span>&nbsp;La presión del gas acetileno generado se utiliza para calcular el contenido de humedad del suelo, con base en una relación preestablecida entre la presión y la humedad.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;El ensayo Método Speedy se utiliza cuando es necesario obtener rápidamente información sobre el contenido de humedad del suelo. Esto es particularmente útil en campos de trabajo, lugares remotos o situaciones donde la humedad del suelo afecta directamente las decisiones de construcción e ingeniería.<br>En resumen, el ensayo laboratorial Método Speedy es un procedimiento rápido y práctico para determinar el contenido de humedad de una muestra de suelo. Es una herramienta útil para obtener información inmediata sobre la humedad del suelo en situaciones en que la velocidad es crucial.</p>
      </div>
    </section>
