...
@section('lang', 'es')
@section('title', 'Amostra Tipo Shelby')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Amostra-Tipo-Shelby.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MUESTRA INDEFORMADA TIPO SHELBY - SH</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">​</span><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo con muestra indeformada tipo Shelby es necesaria para obtener muestras de suelo no perturbadas en profundidades significativas. Estas muestras son cruciales para la evaluación de las características geotécnicas, como la resistencia, compresibilidad y permeabilidad del suelo, garantizando una comprensión precisa del comportamiento del suelo en proyectos geotécnicos.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo con muestra indeformada tipo Shelby es colectar muestras de suelo no perturbadas, es decir, que mantengan su estructura original, para evaluar sus propiedades mecánicas e hidráulicas. Estas muestras son utilizadas para realizar pruebas de laboratorio que permitirán una análisis más precisa del comportamiento del suelo en diferentes condiciones de carga.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo con muestra indeformada tipo Shelby están relacionadas con pruebas de muestreo e investigación geotécnica. Algunos ejemplos de normas que pueden ser relevantes incluyen:<br>ABNT NBR 6484:2001 – Ejecución de Sondeos de Simples Reconocimiento con SPT – Método de Prueba.<br>ABNT NBR 6502:1995 – Rocas y suelos – Terminología.<br>ABNT NBR 9604:1986 – Proyecto y ejecución de sondeos de simples reconocimiento de los suelos para fundaciones de edificios – Procedimiento.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;El público objetivo de la prueba de campo con muestra indeformada tipo Shelby incluye ingenieros geotécnicos, ingenieros civiles, geólogos, técnicos en geotecnia y profesionales involucrados en proyectos que requieren la evaluación de las características mecánicas e hidráulicas del suelo. Empresas de ingeniería geotécnica, consultorías geotécnicas, órganos gubernamentales y instituciones de investigación pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo con muestra indeformada tipo Shelby implica las siguientes etapas:<br><span style="font-weight: 700;">1. PREPARACIÓN DEL LUGAR:</span>&nbsp;El lugar de prueba es elegido de acuerdo con criterios geotécnicos relevantes, teniendo en cuenta las características del suelo y los objetivos de la prueba.<br><span style="font-weight: 700;">2. INSTALACIÓN DEL TUBO DE MUESTREO:</span>&nbsp;Un tubo cilíndrico, conocido como tubo Shelby, es introducido en el suelo utilizando equipos de sondeo. El tubo es insertado en el suelo a una profundidad determinada.<br><span style="font-weight: 700;">3. EXTRACCIÓN DEL TUBO CON MUESTRA:</span>&nbsp;El tubo Shelby es cuidadosamente retirado del suelo, preservando la muestra contenida en su interior.<br><span style="font-weight: 700;">4. MANEJO DE LA MUESTRA:</span>&nbsp;La muestra obtenida es manejada con cuidado para preservar su estructura original y minimizar cualquier perturbación.<br><span style="font-weight: 700;">5. REGISTRO DE DATOS:</span>&nbsp;Todos los datos obtenidos durante la prueba son registrados, incluyendo la profundidad de la prueba, características del suelo, condiciones del lugar y otros aspectos relevantes.<br><span style="font-weight: 700;">6. INTERPRETACIÓN:</span>&nbsp;Las muestras indeformadas colectadas en la prueba de campo con muestra indeformada tipo Shelby son enviadas para pruebas de laboratorio, en las que se realizan análisis detallados de las propiedades mecánicas e hidráulicas del suelo. Los resultados de estas pruebas permiten comprender el comportamiento del suelo bajo diferentes condiciones de carga y orientar proyectos geotécnicos.<br><br>En resumen, la prueba de campo con muestra indeformada tipo Shelby es una técnica importante en la ingeniería geotécnica para colectar muestras de suelo no perturbadas en profundidades significativas. Ella es utilizada por una variedad de profesionales y organizaciones involucradas en proyectos geotécnicos, siguiendo las normas y procedimientos establecidos.</p>
      </div>
    </section>
