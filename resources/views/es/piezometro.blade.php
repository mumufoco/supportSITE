...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Piezômetro.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="/Piezômetro.html" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Piezômetro.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Piezômetro.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-container-align-center u-image u-section-1" id="block-10" data-image-width="2560" data-image-height="1527">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">PIEZÓMETRO - PZ</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;">NECESIDAD:</span>&nbsp;La prueba de campo con piezómetro es necesaria para monitorear la presión del agua en un suelo o en una formación geológica. Esta prueba es esencial para comprender el comportamiento del agua subterránea, la variación del nivel freático y las condiciones hidrogeológicas de un área específica. Proporciona información valiosa para el proyecto y la gestión de obras geotécnicas, fundaciones, sistemas de drenaje, entre otros.<br><br><span style="font-weight: 700;">OBJETIVO:</span>&nbsp;El objetivo principal de la prueba de campo con piezómetro es medir y monitorear las variaciones del nivel del agua subterránea o presión del agua en una formación geológica a lo largo del tiempo. Esto permite analizar las características hidrogeológicas del suelo y su interacción con las estructuras, ayudando en la prevención de problemas relacionados con inundaciones, erosión e inestabilidad del suelo.<br><br><span style="font-weight: 700;">NORMAS BRASILEÑAS:</span>&nbsp;Las normas brasileñas que tratan de la prueba de campo con piezómetro están relacionadas con pruebas geotécnicas e hidrogeológicas. Algunas normas que pueden ser relevantes incluyen:<br>ABNT NBR 9604:1986 – Proyecto y ejecución de sondeos de simple reconocimiento de suelos para fundaciones de edificios – Procedimiento.<br>ABNT NBR 12235:1992 – Agua subterránea – Métodos de prueba.<br>ABNT NBR 12069:1991 – Agua subterránea – Método de prueba de bombeo.<br><br><span style="font-weight: 700;">PÚBLICO OBJETIVO:</span>&nbsp;El público objetivo de la prueba de campo con piezómetro incluye ingenieros geotécnicos, ingenieros civiles, hidrogeólogos, técnicos en geotecnia y profesionales involucrados en proyectos que requieren el monitoreo del agua subterránea y la comprensión de las características hidrogeológicas de un área. Empresas de ingeniería geotécnica, consultorías hidrogeológicas, órganos gubernamentales y instituciones de investigación pueden utilizar los resultados de estas pruebas.<br><br><span style="font-weight: 700;">TÉCNICA:</span>&nbsp;La técnica de la prueba de campo con piezómetro implica las siguientes etapas:Instalación del piezómetro:&nbsp;Un piezómetro, que consiste en un tubo con aberturas en la parte inferior para permitir el contacto con el agua subterránea, se instala en el suelo o en la formación geológica a una profundidad específica.<br><span style="font-weight: 700;">1. MONITOREO DE LA PRESIÓN DEL AGUA:</span>&nbsp;Un dispositivo de medición se conecta al piezómetro para medir la presión del agua en la formación geológica. Esto puede hacerse manualmente o mediante instrumentos electrónicos.<br><span style="font-weight: 700;">2. REGISTRO DE DATOS:</span>&nbsp;La presión del agua se mide y registra en intervalos regulares, generalmente a lo largo del tiempo. Estos datos proporcionan información sobre las variaciones del nivel freático o presión del agua.<br><span style="font-weight: 700;">3. ANÁLISIS DE DATOS:</span>&nbsp;Los datos recopilados se analizan para entender las tendencias de variación del nivel freático y la respuesta del suelo o la formación geológica a los cambios en las condiciones hidrogeológicas.<br><span style="font-weight: 700;">4. INTERPRETACIÓN:</span>&nbsp;La interpretación de los datos permite comprender cómo el agua subterránea interactúa con el suelo, la formación geológica y las estructuras presentes en el área. Esto ayuda en la toma de decisiones en relación con el proyecto, drenaje, prevención de problemas geotécnicos y más.<br><span style="font-weight: 700;">5. RESULTADOS Y APLICACIONES:</span>&nbsp;Los resultados de la prueba de campo con piezómetro proporcionan información esencial para entender las características hidrogeológicas del suelo y la formación geológica, permitiendo la toma de decisiones informadas en relación con proyectos de ingeniería, sistemas de drenaje, gestión de aguas subterráneas y más.<br><br>En resumen, la prueba de campo con piezómetro es una técnica valiosa en la ingeniería geotécnica e hidrogeológica para monitorear las variaciones del nivel freático y la presión del agua subterránea. Se utiliza por una variedad de profesionales y organizaciones involucrados en proyectos geotécnicos e hidrogeológicos, siguiendo las normas y procedimientos establecidos.</p>
      </div>
    </section>
