...
@section('lang', 'es')
@section('title', 'Código de Ética e Conduta')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Código-de-Ética-e-Conduta.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <div class="u-language u-language-content-icon-text u-language-layout-icons u-spacing-10 u-language-1">
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Português" href="{{ route('es.codigo-de-etica-e-conduta') }}" data-language="pt" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-icon u-language-pt u-icon-1"><img src="{{ asset('images/icone18.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="English" href="/en/Código-de-Ética-e-Conduta.html" data-language="en" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-en u-language-icon u-icon-2"><img src="{{ asset('images/icone19.png') }}" alt=""></span>
          </a>
          <a class="u-language-top-url u-language-url u-text-black" data-lang-text="Español" href="/es/Código-de-Ética-e-Conduta.html" data-language="es" style="background-image: none; text-transform: uppercase; font-size: 0.75rem;"><span class="u-file-icon u-icon u-language-es u-language-icon u-icon-3"><img src="{{ asset('images/icone20.png') }}" alt=""></span>
          </a>
        </div>
      </div></header>
    <section class="u-clearfix u-section-1" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">CÓDIGO DE ÉTICA Y CONDUCTA</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1"><span style="font-weight: 700;"> </span><span style="font-weight: 700;">Introducción:</span><br>El Código de Ética y Conducta de Support Solo Sondajes refleja nuestros valores fundamentales y define los estándares de comportamiento esperados de todos los colaboradores y partes involucradas en nuestras operaciones. Este Código orienta nuestras acciones para garantizar la integridad, respeto, responsabilidad y excelencia en todo lo que hacemos.<br><br>1. Integridad y Honestidad:<br>1.1. Actuar de manera ética y honesta en todas las interacciones, tanto dentro como fuera de la empresa.<br>1.2. No comprometer la integridad de la empresa a través de acciones fraudulentas, engañosas o ilegales.<br><br>2. Respeto y Diversidad:<br>2.1. Tratar a todas las personas con respeto, dignidad y cortesía, independientemente de su origen, raza, religión, género, orientación sexual, edad o posición.<br>2.2. Crear un ambiente de trabajo inclusivo, donde todas las voces sean escuchadas y valoradas.<br><br>3. Responsabilidad Social y Ambiental:<br>3.1. Cumplir las leyes, regulaciones y normas relevantes en relación con la salud, seguridad y medio ambiente.<br>3.2. Minimizar el impacto ambiental de nuestras operaciones y promover prácticas sostenibles siempre que sea posible.<br><br>4. Calidad y Profesionalismo:<br>4.1. Buscar la excelencia en todos los aspectos del trabajo, garantizando la calidad en nuestros servicios y productos.<br>4.2. Actuar de manera profesional en todas las interacciones con clientes, colegas, socios y partes interesadas.<br><br>5. Confidencialidad:<br>5.1. Mantener la confidencialidad de la información de la empresa y de los clientes en secreto absoluto, evitando el intercambio no autorizado de información sensible.<br>5.2. Utilizar la información confidencial solo para fines relacionados con el trabajo y dentro de los límites de la autorización.<br><br>6. Conflictos de Interés:<br>6.1. Evitar situaciones en las que los intereses personales puedan entrar en conflicto con los intereses de la empresa.<br>6.2. Revelar cualquier conflicto de interés potencial o real a la supervisión o al área responsable.<br><br>7. Relaciones Comerciales Justas:<br>7.1. Tomar decisiones comerciales imparciales y justas, evitando prácticas antiéticas, soborno o corrupción.<br>7.2. Seleccionar socios, proveedores y clientes con base en criterios éticos y de calidad.<br><br>8. Uso de Recursos de la Empresa:<br>8.1. Utilizar los recursos de la empresa, incluyendo tecnología, materiales y tiempo, de manera responsable y solo para fines relacionados con el trabajo.<br>8.2. Evitar el uso indebido de recursos para beneficio personal.<br><br>9. Comunicación Clara y Verdadera:<br>9.1. Proporcionar información precisa, completa y transparente en todas las comunicaciones internas y externas.<br>9.2. Evitar difundir información falsa o engañosa que pueda perjudicar la reputación de la empresa.<br><br>Conclusión:<br>Al adherir al Código de Ética y Conducta de Support Solo Sondajes, cada uno de nosotros se compromete a actuar con responsabilidad, integridad y respeto, contribuyendo a la construcción de una cultura organizacional ética y profesional. Este Código es una guía para nuestras decisiones y acciones diarias, reflejando los principios que guían nuestra empresa y nuestra relación con el mundo que nos rodea.<br><br>Este Código de Ética y Conducta es efectivo a partir de la fecha indicada y se aplica a todos los colaboradores y partes interesadas de Support Solo Sondajes.</p>
      </div>
    </section>
