...
@section('lang', 'es')
@section('title', 'Sonda de Polarização')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Sonda-de-Polarização.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">​​SONDA DE POLARIZAÇÃO INDUZIDA / SPR / GR</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-1">​As formações ao redor do poço são submetidas a uma voltagem de onda quadrada alternada aplicada através dos eletrodos de injeção superior e inferior.<br><br>Após cada ciclo de injeção, a diferença de potencial resultante em uma seção das formações é analisada à medida que decai com o tempo.&nbsp;A forma desta curva de decaimento está relacionada com a “cargabilidade” das formações. Uma alta capacidade de carga indica que os potenciais eletroquímicos induzidos podem se desenvolver dentro das formações como resultado da transferência de íons entre os fluidos dos poros e os grãos minerais metálicos semicondutores presentes nas rochas.<br><br>Este método é particularmente adequado para exploração mineral no contexto de mineralização de sulfeto disseminado.&nbsp;No domínio hidrogeológico, também pode fornecer informações qualitativas sobre a permeabilidade de horizontes potenciais de aquíferos.</p>
      </div>
    </section>
