...
@section('lang', 'es')
@section('title', 'Massa Especifica dos Grãos')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Massa-Especifica-dos-Grãos.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">MASA ESPECÍFICA DE LOS GRANOS - MESP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-justify u-text u-text-1">El ensayo laboratorial de masa específica de los granos, también conocido como ensayo de masa específica aparente de los granos, es un procedimiento utilizado para determinar la densidad de los granos de un suelo o agregado. Este ensayo es importante en la geotecnia y la ingeniería civil para evaluar las características físicas de los materiales y entender su capacidad de compactación y comportamiento en obras de construcción.<br><br>Aquí está una descripción general del ensayo de masa específica de los granos:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar la densidad de los granos de un suelo o agregado, lo que ayuda a comprender sus características físicas y capacidad de compactación.<br><br><span style="font-weight: 700;">Equipos y materiales:</span><br>1. Frasco de picnómetro o balón volumétrico;<br>2. Báscula de precisión;<br>3. Agua destilada;<br>4. Estufa;<br>5. Peneira de abertura conocida (para agregados);<br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparación de la muestra:</span>&nbsp;Una muestra representativa del suelo o agregado se colecta y seca al aire para eliminar el exceso de humedad. La muestra se tritura y pasa por la peneira de abertura 4,75 mm (para suelos) para remover partículas más grandes.<br><span style="font-weight: 700;">2. Secado de la muestra:</span>&nbsp;La muestra se coloca en una estufa a una temperatura específica (generalmente alrededor de 105°C) hasta alcanzar un peso constante, eliminando cualquier humedad remanente.<br><span style="font-weight: 700;">3. Peneirado (solo para agregados):</span>&nbsp;Si el ensayo se realiza en agregados, la muestra se peneira a través de una peneira de abertura conocida para remover partículas finas que no corresponden a los granos.<br><span style="font-weight: 700;">4. Llenado del picnómetro:</span>&nbsp;El frasco de picnómetro o balón volumétrico se limpia y seca. Se pesa (peso “A”). Luego, se llena con agua destilada hasta un volumen determinado (conocido como volumen de llenado), y el frasco se pesa nuevamente (peso “B”).<br><span style="font-weight: 700;">5. Llenado del picnómetro con granos:</span>&nbsp;Se agrega una cantidad conocida de suelo seco al frasco de picnómetro, tomando cuidado para evitar burbujas de aire. El frasco se pesa nuevamente (peso “C”).<br><span style="font-weight: 700;">6. Cálculos:</span> Masa del suelo seco = Peso “C” – Peso “A”&nbsp;Masa del agua desplazada = Peso “B” – Peso “A”;&nbsp;Masa específica de los granos (Gama) = Masa del suelo seco / Masa del agua desplazada<br><span style="font-weight: 700;">7. Interpretación:</span>&nbsp;El resultado del ensayo es la masa específica de los granos del suelo o agregado. Este valor representa la densidad de los granos y es una medida de las características físicas del material.<br><br><span style="font-weight: 700;">Utilidad:</span>&nbsp;La masa específica de los granos se utiliza para calcular la porosidad, la densidad relativa y otros parámetros que ayudan a entender la capacidad de compactación, la estabilidad y el comportamiento de los materiales en obras de construcción.<br>En resumen, el ensayo laboratorial de masa específica de los granos es fundamental para evaluar la densidad de los granos de suelos y agregados, proporcionando información importante sobre sus características físicas y su comportamiento en obras de ingeniería geotécnica y construcción.</p>
      </div>
    </section>
