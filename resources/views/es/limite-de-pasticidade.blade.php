...
@section('lang', 'es')
@section('title', 'Limite de Pasticidade')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/Limite-de-Pasticidade.css') }}" media="screen">
...
<header class="u-clearfix u-header u-sticky u-sticky-53ac u-header" id="header"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="block-12">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <h2 class="u-align-center u-text u-text-default u-text-1">LÍMITE DE PLASTICIDAD - LP</h2>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="block-13">
      <div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
        <p class="u-align-justify u-text u-text-default u-text-1">El ensayo laboratorial de límite de plasticidad es un procedimiento utilizado para determinar la humedad límite entre el estado plástico y el estado semiplástico de un suelo. Este ensayo es frecuentemente realizado en laboratorios de geotecnia y ingeniería civil para evaluar las características de plasticidad de suelos arcillosos e identificar su capacidad de deformarse sin romperse. El límite de plasticidad es uno de los parámetros utilizados en la clasificación de los suelos de acuerdo con su plasticidad.<br><br>Aquí está una descripción general del ensayo de límite de plasticidad:<br><br><span style="font-weight: 700;">Objetivo:</span>&nbsp;Determinar el contenido de humedad en el que un suelo arcilloso transita del estado plástico al estado semiplástico, definiendo el límite entre estos dos estados de comportamiento.<br><br><span style="font-weight: 700;">Equipos y Materiales:</span><br>1. Cápsulas de porcelana o vidrio;<br>2. Espátula;<br>3. Rolo de acero;<br>4. Balanza de precisión;<br>5. Estufa;<br><br><span style="font-weight: 700;">Procedimiento:</span><br><span style="font-weight: 700;">1. Preparación de la Muestra:</span>&nbsp;Una muestra representativa del suelo es colectada y seca al aire para eliminar el exceso de humedad. Luego, la muestra es triturada y pasa por la peneira de abertura 0,425 mm para remover partículas más grandes.<br><span style="font-weight: 700;">2. Preparación de las Cápsulas:</span>&nbsp;Cápsulas de porcelana o vidrio limpias y secas son pesadas y numeradas.<br><span style="font-weight: 700;">3. Preparación de las Muestras para Ensayo:</span>&nbsp;Una pequeña porción de la muestra es retirada y mezclada con agua hasta alcanzar una consistencia pastosa.<br><span style="font-weight: 700;">4. Moldaje de las Muestras:</span>&nbsp;La muestra pastosa es moldeada en una forma de esfera o cilindro, dependiendo de la norma utilizada.<br><span style="font-weight: 700;">5. Determinación del Límite de Plasticidad:</span>&nbsp;La muestra moldeada es dividida en porciones más pequeñas y rollos de acero son utilizados para rodar estas porciones en una placa de vidrio hasta que el diámetro de las trilhas alcance un valor especificado por la norma.<br><span style="font-weight: 700;">6. Preparación de las Cápsulas con Muestras:</span>&nbsp;Pequeñas porciones de las muestras moldeadas son colocadas en las cápsulas preparadas y pesadas nuevamente.<br><span style="font-weight: 700;">7. Secado en Estufa:</span>&nbsp;Las cápsulas con las muestras son colocadas en una estufa a una temperatura específica (generalmente 105°C a 110°C) hasta que alcancen peso constante.<br><span style="font-weight: 700;">8. Cálculos:</span>&nbsp;Con base en los pesos antes y después del secado, la humedad inicial y la humedad después del secado son determinadas. El límite de plasticidad es calculado restando la humedad después del secado de la humedad inicial.<br><span style="font-weight: 700;">9. Interpretación:</span>&nbsp;El resultado del ensayo es expresado en términos de humedad (porcentaje de agua) en el que el suelo pasa del estado plástico al estado semiplástico. Este valor es conocido como “límite de plasticidad”.<br><br>El ensayo de límite de plasticidad es frecuentemente realizado junto con el ensayo de límite de liquidez para determinar la plasticidad de un suelo y clasificarlo de acuerdo con la clasificación del Sistema Unificado de Clasificación de Suelos (SUCS). En resumen, el ensayo laboratorial de límite de plasticidad es fundamental para entender las características de plasticidad de suelos arcillosos y auxiliar en la clasificación de los suelos y en el proyecto de obras de ingeniería geotécnica.</p>
      </div>
    </section>
